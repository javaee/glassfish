...
/**
 * This is a Default implementation of MessageExchangeTransport. It is used
 * for the JAX-RPC code path from MessageExchangeHelper.
 * @author Vikas Awasthi
 */
public class DefaultMessageExchangeTransport extends
        MessageExchangeTransportImpl {
    
    public DefaultMessageExchangeTransport(MessageExchange me) {
        super(me);
    }
