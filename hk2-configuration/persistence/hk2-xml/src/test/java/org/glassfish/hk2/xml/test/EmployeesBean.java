...
public class EmployeesBean implements Employees {
    ...
    /* (non-Javadoc)
     * @see org.glassfish.hk2.xml.test.Employees#setCompanyName(java.lang.String)
     */
    @Override @XmlElement(name="company-name")
    ...
    /* (non-Javadoc)
     * @see org.glassfish.hk2.xml.test.Employees#getEmployees()
     */
    @Override 
