...
*/
    ...
    */
        ...
        String user, String password) throws RepositoryException
    {
        try {       
            ...
            if (oldRoot != null) {
                GFSystem.setProperty(SystemPropertyConstants.INSTANCE_ROOT_PROPERTY, oldRoot);
            }
            if (oldConf != null) {
    ...
    */
    ...
    protected boolean domainUsesNSS(final RepositoryConfig rc) {
        try {
    ...
    */
     ...
     */
    /** Determines if the NSS support is available in this
