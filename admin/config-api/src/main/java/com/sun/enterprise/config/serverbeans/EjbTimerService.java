...
@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterface=com.sun.appserv.management.config.EJBTimerServiceConfig.class, singleton=true)
@Configured
public interface EjbTimerService extends ConfigBeanProxy, Injectable  {
