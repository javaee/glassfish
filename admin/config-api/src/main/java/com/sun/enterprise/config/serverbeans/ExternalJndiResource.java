...
//@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterface=com.sun.appserv.management.config.ExternalJNDIResourceConfig.class, nameHint="jndi-name")
@Configured
