...
public class ResourceUtilities {
    ...
    private final static Logger _logger = LogDomains.getLogger(ResourceUtilities.class, LogDomains.ADMIN_LOGGER);
   ...
   public static Set<Resource> getResourceConfigConflicts(final Set<Resource> resSet,
    ...
    private static String getIdToCompare(final Resource res) {
       ...
       else if(Resource.CONNECTOR_WORK_SECURITY_MAP.equals(type)){
