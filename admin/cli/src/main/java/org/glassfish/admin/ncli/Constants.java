...
/** A final class to hold the constants used in implementation.
 * @author &#2325;&#2375;&#2342;&#2366;&#2352 (km@dev.java.net)
 */
public final class Constants {
    public final static String UNSUPPORTED_CMD_FILE_NAME = "unsupported-legacy-command-names";
    public final static String SUPPORTED_CMD_FILE_NAME   = "supported-legacy-command-names";
