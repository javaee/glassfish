...
//        asadmin create-protocol-filter --protocol http-redirect --classname org.glassfish.grizzly.config.HttpRedirectFilter redirect-filter
            response = post (URL_PROTOCOL + "/" + redirectProtocolName + "/create-protocol-filter",
                new HashMap<String, String>() {{
                    ...
                    put ("classname", "org.glassfish.grizzly.config.HttpRedirectFilter");
                }});
            checkStatusForSuccess(response);

//        asadmin create-protocol-finder --protocol pu-protocol --targetprotocol http-listener-2 --classname org.glassfish.grizzly.config.HttpProtocolFinder http-finder
//        asadmin create-protocol-finder --protocol pu-protocol --targetprotocol http-redirect   --classname org.glassfish.grizzly.config.HttpProtocolFinder http-redirect
            response = post (URL_PROTOCOL + "/" + portUniProtocolName + "/create-protocol-finder",
                new HashMap<String, String>() {{
                    ...
                    put ("classname", "org.glassfish.grizzly.config.HttpProtocolFinder");
                }});
            checkStatusForSuccess(response);
            response = post (URL_PROTOCOL + "/" + portUniProtocolName + "/create-protocol-finder",
                new HashMap<String, String>() {{
