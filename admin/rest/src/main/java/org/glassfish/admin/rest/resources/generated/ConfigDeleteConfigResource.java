...
public class ConfigDeleteConfigResource extends org.glassfish.admin.rest.resources.TemplateCommandPostResource  {

   public ConfigDeleteConfigResource() {
       super(
          "ConfigDeleteConfigResource",
          "delete-config",
          "POST",
          "Delete Config",
          "delete-config",
