...
public class IiopServiceCreateSslResource extends org.glassfish.admin.rest.resources.TemplateCommandPostResource  {

   public IiopServiceCreateSslResource() {
       super(
          "IiopServiceCreateSslResource",
          "create-ssl",
          "POST",
          "Create",
          "create-ssl",
