...
ListLbConfig
    ...
    private static String configBeansToCommandResourcesMap[][] = {
        ...
        {"Cluster", "create-http-health-checker", "POST", "create-http-health-checker", "create-http-health-checker", "target=$parent"},
        ...
        {"Cluster", "delete-http-health-checker", "DELETE", "delete-http-health-checker", "delete-http-health-checker", "target=$parent"},
        ...
        {"Domain", "add-library", "POST", "add-library", "Install library"},
        ...
        {"Domain", "list-libraries", "GET", "list-libraries", "List libraries"},
        ...
        {"Domain", "remove-library", "DELETE", "remove-library", "Uninstall library"},
        ...
        {"Node",    "update-node-dcom", "POST",     "update-node-dcom", "Update DCOM Node", "id=$parent"},
        {"Node",    "delete-node-dcom", "DELETE",   "delete-node-dcom", "Delete DCOM Node", "id=$parent"},
        {"Nodes",   "create-node-dcom", "POST",     "create-node-dcom", "Create DCOM Node"},
        {"Nodes",   "list-nodes-dcom",  "GET",      "list-nodes-dcom",  "List DCOM Nodes"},
