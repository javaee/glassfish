...
/**
 * A Marker or tag exception for services caught by
 * a cancellation
 * 
 * @author jwells
 *
...
public class WasCancelledException extends Exception {
     ...
     * 
     * @param d The non-null descriptor that was cancelled
     */
    public WasCancelledException(Descriptor d) {
        super("A run-level service with name \"" +
          ((d.getName() == null) ? "" : d.getName()) +
          "\" and implementation " + d.getImplementation() +
          " was cancelled");
    }
