...
public class GenericContainer extends GenericElement {
    ...
    /**
     * element - ejb-container or we-container or mdb-container
     * parentSource - server - parent of ejb-container
     * parentResult - domain in case of as7x, config in case of as80
     */
    public java.util.List getNonTransferList(Element element){
