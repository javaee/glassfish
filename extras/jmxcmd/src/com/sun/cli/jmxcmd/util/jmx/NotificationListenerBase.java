    ...
    implements NotificationListener
{
	...
	/**
        ...
        <p>
        <b>NOTE: setupListening() must be called after construction in order to begin listening.</b>
	 */
		protected
		...
		throws InstanceNotFoundException, IOException
	{
        ...
        // setupListening() must be called by instantiating code
	}
    ...
    /**
        Setup listening.  Should only be called once.
     */
		...
		throws InstanceNotFoundException, IOException
	{
        ...
        if ( mPattern.isPattern() )
        {
            s	= getConn().queryNames( mPattern, null );
        }
        else
        {
