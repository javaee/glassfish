...
public class MBeanCmd extends JMXCmd
{
	...
	{
		public	MBeanCmdHelp()	{ super( getCmdInfos() ); }
	...
	"";
		...
		public String[]	getNames()		{	return( MBeanCmd.getCmdInfos().getNames() ); }
		public String	getSynopsis()	{	return( formSynopsis( SYNOPSIS ) ); }
		public String	getSyntax()		{	return( CREATE_SYNTAX ); }
		public String	getText()		{	return( CREATE_TEXT ); }
	}
		...
		throws Exception
	{
		...
		private final void
	timeMBeanInfo( final ObjectName[] targets )
		throws IOException
	{
