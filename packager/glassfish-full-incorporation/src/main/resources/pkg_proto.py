...
pkg = {
    ...
    "depends"       : { 
			...
			"pkg:/mq-server@4.5" : {"type" : "incorporate" },
			"pkg:/mq-bin-sh@4.5" : {"type" : "incorporate" },
			"pkg:/mq-bin-exe@4.5" : {"type" : "incorporate" },
                        "pkg:/mq-config-gf@4.5" : {"type" : "incorporate" },
			"pkg:/mq-locale@4.5" : {"type" : "incorporate" },
                      },
    "licenses"      : {
