...
pkg = {
    ...
    "attributes"    : {
                        ...
                        "pkg.description" : "This package is now obsolete. Application Server Management Extension package content has been moved to glassfish-common package."+conf.glassfish_description_long,
