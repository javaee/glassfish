...
/**
 * This interface simply provides a proxy for the load balancers to call back
 * the Servlet in response to a reqst.
 * 
...
public interface CallBackInterface {
	 ...
	 * @param msgContext
	 * @param redirectAddr
	 *            the redirect address to redirect to.
	 * @throws IOException
	 *             TODO
	 */
	...
	/**
	 * Accepts the join request and returns the manifest.
	 * 
	 * @param msgContext
	 * @throws IOException
	 */
