...
$(OBJDIR)/$(LIBPREFIX)$(AR1_TARGET).$(STATIC_LIB_SUFFIX): $(REAL_AR1_OBJS)
	$(RM) -f $@
	$(CC) -xar -ptr$(OBJDIR) -o $@ $(REAL_AR1_OBJS) $(AR1_NONPARSED_OBJS)
endif
...
$(OBJDIR)/$(LIBPREFIX)$(AR2_TARGET).$(STATIC_LIB_SUFFIX): $(REAL_AR2_OBJS)
	$(RM) -f $@
	$(CC) -xar -ptr$(OBJDIR) -o $@ $(REAL_AR2_OBJS) $(AR2_NONPARSED_OBJS)
endif
...
$(OBJDIR)/$(LIBPREFIX)$(AR3_TARGET).$(STATIC_LIB_SUFFIX): $(REAL_AR3_OBJS)
	$(RM) -f $@
	$(CC) -xar -ptr$(OBJDIR) -o $@ $(REAL_AR3_OBJS) $(AR3_NONPARSED_OBJS)
endif
...
$(OBJDIR)/%.$(MAPFILE_SUFFIX):%.$(VERSIONSFILE_SUFFIX) %.$(SPECFILE_SUFFIX)
	@$(MAKE_OBJDIR)
	$(SPEC2MAP) -l $(OBJDIR)/$*.$(DYNAMIC_LIB_SUFFIX) -a sparc -o $@ -v $^
