...
/*
 * $Header: /cvs/glassfish/appserv-api/src/java/com/sun/appserv/management/config/ServerRefConfigCR.java,v 1.1 2006/12/02 06:03:23 llc Exp $
 * $Revision: 1.1 $
...
*/
public interface ServerRefConfigCR extends ConfigRemover
{
	...
	/**
		...
		@param referencedServerName name of the server.
		@param optional Map of optional attributes. Valid keys are defined here.
		@return A proxy to the ServerRefConfig MBean.
	*/
	public ServerRefConfig createServerRefConfig(String referencedServerName,  Map<String,String> optional);
