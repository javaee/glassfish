...
public final class ProxyFactory implements NotificationListener
{
	...
	{
        final MBeanServerConnection mbsConn = conn.getExistingMBeanServerConnection();
        // MBeanServerConnection can be null if it hasn't been established yet
		return mbsConn == null ? null : INSTANCES.get(mbsConn);
	}
