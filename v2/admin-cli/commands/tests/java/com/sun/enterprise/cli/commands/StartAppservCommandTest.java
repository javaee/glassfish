...
public class StartAppservCommandTest extends TestCase {
    ...
    public void testrunCommandNoDomains() throws Exception{
        ...
        {
            //bug in code, missing localized string 'NoDomainsToStart' in LocalStrings.properties
            assertEquals(e.getMessage(), "Key not found (NoDomainsToStart)");
        }
    }

    public StartAppservCommandTest(String name){
        super(name);
    }

    StartAppservCommand testCommand = null;
    ...
    protected void setUp() throws Exception{
        ...
        testCommand = new StartAppservCommand();
