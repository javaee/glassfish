...
public class ListSubComponentsCommandTest extends TestCase {
    ...
    public ListSubComponentsCommandTest(String name){
        super(name);
    }

    ListSubComponentsCommand testCommand = null;
    ...
    protected void setUp() throws Exception{
        ...
        testCommand = new ListSubComponentsCommand();
    ...
    public static Test suite(){
        TestSuite suite = new TestSuite(ListSubComponentsCommandTest.class);
        return suite;
    }

    public static void main(String args[]) throws Exception {
        final TestRunner runner= new TestRunner();
        final TestResult result = runner.doRun(ListSubComponentsCommandTest.suite(), false);
