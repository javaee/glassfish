...
public class StopDomainCommandTest extends TestCase {
    ...
    public void testrunCommandNoDomains() throws Exception{
        ...
        {
            assertEquals(e.getMessage(), "CLI157 Could not stop the domain UndefinedDomain.");
        }
    }

    public StopDomainCommandTest(String name){
        super(name);
    }

    StopDomainCommand testCommand = null;
    ...
    protected void setUp() throws Exception{
        ...
        testCommand = new StopDomainCommand();
