...
public class DeployCommandTest extends TestCase {
    ...
    public void testValidateOptionsInvalidOptions() throws Exception{
        try{
    ...
    public void testValidateOptionsValidOptions() throws Exception{
    ...
    public void testCreateDeploymentProperties() throws Exception {
    ...
    DeployCommand testCommand = null;
