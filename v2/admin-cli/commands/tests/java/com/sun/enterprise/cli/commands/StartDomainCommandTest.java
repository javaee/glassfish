...
public class StartDomainCommandTest extends TestCase {
    ...
    public StartDomainCommandTest(String name){
        super(name);
    }

    StartDomainCommand testCommand = null;
    ...
    protected void setUp() throws Exception{
        ...
        testCommand = new StartDomainCommand();
    ...
    public static Test suite(){
        TestSuite suite = new TestSuite(StartDomainCommandTest.class);
        return suite;
    }
