...
public class GenerateJVMReportCommandTest extends TestCase {

    public void testvalidateOptionsValid() throws Exception{
        testCommand.setOption("type", "summary");
        assertEquals(testCommand.validateOptions(), true);
    }

    public void testvalidateOptionsInvalidType() throws Exception{
        testCommand.setOption("type", "invalidOperation");
        try{
    ...
    public void testgetOperationNameValid() throws Exception{
        testCommand.setOption("type", "thread");
        assertEquals(testCommand.validateOptions(), true);
        assertEquals(testCommand.getOperationName(), "getThreadDump");
    }

    public GenerateJVMReportCommandTest(String name){
        super(name);
    }

    GenerateJVMReportCommand testCommand = null;
    ...
    protected void setUp() throws Exception{
        ...
        testCommand = new GenerateJVMReportCommand();
    ...
    public static Test suite(){
        TestSuite suite = new TestSuite(GenerateJVMReportCommandTest.class);
        return suite;
    }
