...
public class JDBCPoolMonitorTask extends ConnectionPoolTask
{
    public JDBCPoolMonitorTask(final ServerRootMonitor srm, final String filter, final Timer timer,
    ...
    private void monitorConnectionPool(final String element,
                                       final Map<String,JDBCConnectionPoolMonitor> jdbcMap)
    {
