...
public class ListResourceAdapterConfigsCommand extends GenericCommand
{
    /**
     *  Execute the command
    ...
    public void runCommand()throws CommandException, CommandValidationException
	{
        ...
        try 
		{ 
			String rac = (String)mbsc.invoke(new ObjectName(objectName), 
					     		operationName, params, types);
             
			 CLILogger.getInstance().printMessage(rac);
