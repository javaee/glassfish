...
public final class StartDatabaseCommand extends DatabaseCommand
{
    ...
    private String getDatabaseHomeDir()
    {
        ...
        if (getOption(DB_HOME) !=null) return getOption(DB_HOME);
            ...
            //the default dbhome is <parent directory of domains>/databases
            final String domainPath = System.getProperty(SystemPropertyConstants.DOMAINS_ROOT_PROPERTY);
            final File installPath = (new File(domainPath)).getParentFile();
            if (installPath != null) {
