...
public class CreateManagementRuleCommand extends GenericCommand
{
     ...
     *  @throws CommandException
     */
    private String resolveTargetToConfig(MBeanServerConnection mbsc, 
                                String target) throws CommandException
    {
