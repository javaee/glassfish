...
public class StatelessSessionBeanMonitorTask extends BeanMonitorTask
{
    ...
    public StatelessSessionBeanMonitorTask(final ServerRootMonitor srm, final String filter, final Timer timer,
    ...
    private StatelessSessionBeanMonitor getStatelessSessionBeanMonitor(final Map<String,EJBModuleMonitor> ejbMap)
    {
    ...
    private void displayData(final StatelessSessionBeanStats stat)
    {
