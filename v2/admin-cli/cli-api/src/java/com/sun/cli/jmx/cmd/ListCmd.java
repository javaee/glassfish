...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/ListCmd.java,v 1.3 2005/12/25 03:45:38 tcfujii Exp $
 * $Revision: 1.3 $
...
import com.sun.cli.jmx.support.InvokeResultIteratorStringifier;
import com.sun.cli.util.stringifier.*;

/*
	Invokes the 'list' commmand on all specified targets
 */
public class ListCmd extends JMXCmd
{
		public
	ListCmd( final CmdEnv env )
	{
		super( env );
	}
	...
	{
		return( "no help" );
		//return( CmdStrings.LIST_HELP.toString() );
	}
		...
		throws Exception
	{
		...
		final InvokeResult []	results	= getProxy().mbeanInvoke( "list", "true", targets);
