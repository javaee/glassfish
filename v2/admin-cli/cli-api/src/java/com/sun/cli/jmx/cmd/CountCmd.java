...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/CountCmd.java,v 1.3 2005/12/25 03:45:33 tcfujii Exp $
 * $Revision: 1.3 $
...
public class CountCmd extends JMXCmd
{
	...
	getUsage()
	{
		return( CmdStrings.COUNT_HELP.toString() );
	}
		...
		throws Exception
	{
		...
		{
			establishProxy();
			final int numMBeans	= getProxy().mbeanCount();
			println( "" + numMBeans );
		}
		catch( Exception e )
		{	
