...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/CmdRunnerImpl.java,v 1.3 2005/12/25 03:45:31 tcfujii Exp $
 * $Revision: 1.3 $
...
class CmdRunnerImpl implements CmdRunner
{
	...
	final CmdFactory	mFactory;
		...
		public
	CmdRunnerImpl( CmdFactory	factory, final CmdEnv env)
	{
		mCmdEnv		= env;
		mFactory	= factory;
	}
	...
	execute( final String cmdName, final String [] tokens )
		throws Exception
	{
		mCmdEnv.put( CmdBase.ENV_TOKENS, tokens, false);
