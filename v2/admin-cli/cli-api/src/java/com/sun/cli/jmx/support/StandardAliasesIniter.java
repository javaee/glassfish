...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/support/StandardAliasesIniter.java,v 1.3 2005/12/25 03:45:50 tcfujii Exp $
 * $Revision: 1.3 $
...
public final class StandardAliasesIniter
{
	...
	StandardAliasesIniter()
	{
		...
		private static void
	initAlias( AliasMgrMBean aliasMgr, String name, String value )
		throws Exception
	{
