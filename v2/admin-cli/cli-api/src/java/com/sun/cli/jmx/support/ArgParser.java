...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/support/ArgParser.java,v 1.3 2005/12/25 03:45:44 tcfujii Exp $
 * $Revision: 1.3 $
...
public interface ArgParser
{
	...
	/*
		...
		@param argDelim	single-character delimiter
