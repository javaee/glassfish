...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/spi/JMXConnectorProviderInfo.java,v 1.3 2005/12/25 03:45:41 tcfujii Exp $
 * $Revision: 1.3 $
 * $Date: 2005/12/25 03:45:41 $
 */
...
public interface JMXConnectorProviderInfo
{
	public final class InfoGetter
	{
		...
		getInfo( Class theClass )
		{
			...
			try
			{
				java.lang.reflect.Method	m	= theClass.getDeclaredMethod( "getInfo", null );
			
				info	= (JMXConnectorProviderInfo)m.invoke( theClass, null );
			}
			catch( Exception e )
			{
			}
