...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/ListAliasesCmd.java,v 1.3 2005/12/25 03:45:38 tcfujii Exp $
 * $Revision: 1.3 $
...
public class ListAliasesCmd extends JMXCmd
{
		public
	ListAliasesCmd( final CmdEnv env )
	{
		super( env );
	}
	...
	getUsage()
	{
		return( CmdStrings.LIST_ALIASES_HELP.toString() );
	}
	
		public static String []
	getNames( )
	{
		return( new String [] { "list-aliases", "la" } );
	}
