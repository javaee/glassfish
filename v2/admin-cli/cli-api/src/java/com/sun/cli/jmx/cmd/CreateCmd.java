...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/CreateCmd.java,v 1.3 2005/12/25 03:45:34 tcfujii Exp $
 * $Revision: 1.3 $
...
public class CreateCmd extends JMXCmd
{
	...
	static private final String OPTIONS_INFO	="class,1 args,1";
	...
	final static String	NAME		= "create";
	final static String	NAME_ABBREV	= "cr";
