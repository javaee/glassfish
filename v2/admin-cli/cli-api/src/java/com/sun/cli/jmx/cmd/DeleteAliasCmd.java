...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/DeleteAliasCmd.java,v 1.3 2005/12/25 03:45:34 tcfujii Exp $
 * $Revision: 1.3 $
...
public class DeleteAliasCmd extends JMXCmd
{
		public
	DeleteAliasCmd( final CmdEnv env )
	{
		super( env );
	}
	...
	getUsage()
	{
		return( CmdStrings.DELETE_ALIAS_HELP.toString() );
	}
	
		public static String []
	getNames( )
	{
		return( new String [] { "delete-alias", "da" } );
	}
