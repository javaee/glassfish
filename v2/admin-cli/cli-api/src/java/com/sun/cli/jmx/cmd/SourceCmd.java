...
/*
 * $Header: /cvs/glassfish/admin-cli/cli-api/src/java/com/sun/cli/jmx/cmd/SourceCmd.java,v 1.3 2005/12/25 03:45:40 tcfujii Exp $
 * $Revision: 1.3 $
...
public class SourceCmd extends CmdBase
{
	...
	getUsage()
	{
		return( CmdStrings.SOURCE_HELP.toString() );
	}
