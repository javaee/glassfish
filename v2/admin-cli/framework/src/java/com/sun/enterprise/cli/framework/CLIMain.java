...
public class CLIMain 
{
     ...
     */
    private static void invokeHelpClass(String helpClassName, 
     ...
     *  @return usage text
     */
    private static String getUsageTextFromValidCommand(final ValidCommand validCommand)
    {
     ...
     */
    private static void checkValidCommand(ValidCommand validCommand, 
                                          String commandName) 
        throws CommandException
    {
     ...
     */
    private static void setCommandLocalizedProperty(Iterator<Properties> localizePropertiesIter)
