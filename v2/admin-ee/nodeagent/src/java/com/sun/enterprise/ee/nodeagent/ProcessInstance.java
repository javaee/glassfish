...
/**
 * Interface it allow existing objects to be able to be ProcessInstances
 * if the implementation calls for its use separate from the AbstractProcessInstance
 *
 * @author  basler
 */
