...
diff -w ..\..\..\tools\src\java\com\sun\enterprise\tools\cli\asadmin.bat.template asadmin.bat.template
diff -w ..\..\..\tools\src\java\com\sun\enterprise\tools\cli\asadmin.template asadmin.template
