...
/**
 * This synchronization driver implementation based on JMX.
 * 
 * @author Nazrul Islam
 * @since  JDK1.4
 */
class JmxSynchronizationDriver extends BaseSynchronizationDriver {
     ...
     */
    JmxSynchronizationDriver(String root, String xml, 
            DASPropertyReader dpr) {
    ...
    protected RequestMediator getRequestMediator(
        ...
        return new JmxRequestMediator(_dpr, req, tx); 
    }
}
