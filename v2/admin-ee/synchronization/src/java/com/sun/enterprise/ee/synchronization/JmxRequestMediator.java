...
/**
 * Collective behavior of a synchronization request operation in JMX.
 *
 * @author Nazrul Islam
 * @since  JDK1.4
 */
public class JmxRequestMediator extends BaseRequestMediator {
     ...
     */
    JmxRequestMediator(DASPropertyReader p, SynchronizationRequest req, 
            Transaction tx) {
    ...
    protected Command getResponseCommand() {
        return new ResponseProcessCommand(_request, _response);
    }
