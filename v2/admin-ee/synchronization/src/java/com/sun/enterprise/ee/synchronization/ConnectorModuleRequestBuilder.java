...
/**
 * Builds a synchronization request for a connector module.
 *
 * @author Nazrul Islam
 */
public class ConnectorModuleRequestBuilder extends RequestBuilderBase {
    
    public ConnectorModuleRequestBuilder(ConfigContext ctx, String serverName) {
        super(ctx,serverName);
    }

    String getApplicationName(ConfigBean cb) {
        return ((ConnectorModule)cb).getName();
    }

    public ApplicationSynchRequest build(ConnectorModule connectorModule) {
        ApplicationSynchRequest asr = super.build(connectorModule);
