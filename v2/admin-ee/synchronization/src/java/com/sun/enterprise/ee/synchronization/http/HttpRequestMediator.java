...
/**
 * Collective behavior of a synchronization request operation in HTTP.
 *
 * @author Nazrul Islam
 * @since  JDK1.4
 */
public class HttpRequestMediator extends BaseRequestMediator {

    /**
     * Initializes the variables.
     *
     * @param    p    obj that provides access to DAS info
     * @param    req  synchronization request
     * @param    tx   synchronization transaction
     * @param    url  synchronization servlet url
     */
    HttpRequestMediator(DASPropertyReader p, SynchronizationRequest req, 
            Transaction tx, String url) {
    ...
    /**
     * Returns a concrete implementation of Get command based on HTTP.
     */
    protected Command getGetCommand() {
        return new HttpGetCommand(_request, _dasProperties, _url);
    }

    /**
     * Returns a concreate implementation of response processing command.
     */
    protected Command getResponseCommand() {
