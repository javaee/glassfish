...
java -Xms128M -Xmx1024M -classpath  C:\ias\latest\publish\JDK1.4_DBG.OBJ\jmx\lib\jmxri.jar;c:\ias\latest\publish\JDK1.4_DBG.OBJ\jmx-remote\rjmx-impl\lib\rjmx-impl.jar;c:\ias\latest\publish\JDK1.4_DBG.OBJ\junit\junit.jar;c:\ias\latest\publish\JDK1.4_DBG.OBJ\admin-ee\synchronization\lib\synchronization.jar com.sun.enterprise.ee.synchronization.Client c:\xxx c:\yyy
