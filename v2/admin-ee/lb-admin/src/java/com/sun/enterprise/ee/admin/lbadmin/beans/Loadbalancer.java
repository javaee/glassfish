...
public class Loadbalancer extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public int addCluster(com.sun.enterprise.ee.admin.lbadmin.beans.Cluster value) {
	...
	//
	public int removeCluster(com.sun.enterprise.ee.admin.lbadmin.beans.Cluster value) {
	...
	// Add a new element returning its index in the list
	public int addProperty2(com.sun.enterprise.ee.admin.lbadmin.beans.Property value) {
	...
	// Returns the index the element had in the list
	//
	public int removeProperty2(com.sun.enterprise.ee.admin.lbadmin.beans.Property value) {
