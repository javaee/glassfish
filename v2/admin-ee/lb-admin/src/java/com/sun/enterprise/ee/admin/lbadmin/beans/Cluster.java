/**
 *	This generated bean class Cluster matches the schema element cluster
 *
...
public class Cluster extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	// Add a new element returning its index in the list
	public int addWebModule(com.sun.enterprise.ee.admin.lbadmin.beans.WebModule value) {
	...
	// Returns the index the element had in the list
	//
	public int removeWebModule(com.sun.enterprise.ee.admin.lbadmin.beans.WebModule value) {
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizeWebModule(); ++_index) {
			com.sun.enterprise.ee.admin.lbadmin.beans.WebModule element = getWebModule(_index);
			if (element != null) {
				element.validate();
			}
		}
