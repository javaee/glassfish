 ...
 */
public class SunWebModuleReaderImpl implements WebModuleReader {

    public SunWebModuleReaderImpl(ConfigContext ctx, ApplicationRef ref, 
        SunWebApp bean) {
    ...
    private static final StringManager _strMgr = 
        StringManager.getManager(SunWebModuleReaderImpl.class);
}
