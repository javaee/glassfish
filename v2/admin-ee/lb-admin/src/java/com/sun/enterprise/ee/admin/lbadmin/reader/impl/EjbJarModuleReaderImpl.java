 ...
 */
public class EjbJarModuleReaderImpl implements WebModuleReader {

    public EjbJarModuleReaderImpl(ConfigContext ctx, ApplicationRef ref, 
    ...
    public String getContextRoot() throws LbReaderException {
        String context = null;
        context =  _bean.getEndpointAddressUri();
        return context;
    }
    ...
    private WebserviceEndpoint _bean                   = null;
    private static final StringManager _strMgr = 
        StringManager.getManager(EjbJarModuleReaderImpl.class);
}
