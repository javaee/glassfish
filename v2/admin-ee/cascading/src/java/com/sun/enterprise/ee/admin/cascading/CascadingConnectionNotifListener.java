...
/**
 * Listens to the jmx connection closure notifications
 * and sets the server state accordingly
 *
 * @author Sreenivas Munnangi
 */

public class CascadingConnectionNotifListener 
	...
	// If the notification type is jmx.remote.connection.closed
	// then set the server state to stopped.

	// This may need to be refined in the future as we find sophisticated
	// ways of determining the status.
