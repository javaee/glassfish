...
/**
 * Returns outbound associations count.
 */
public class OutboundAssociationsHandler extends BaseHandler {

    /**
     * Constructor.
     */
    public OutboundAssociationsHandler() {
        super();
    }
    ...
    public Object handleAttribute(ObjectName peer, String attribute, 
        ...
        try {
            ...
            Set outboundConnections = new HashSet();
            ...
            //Get the sum of all the "connectionsinuse-count" attributes from all the
            //outbound connections. 
            outboundAssociations = 
                Utils.getAttributeSum(mbs, outboundConnections, "connectionsinuse-count"); 
            ...
            //Get the of sum of all the "numconnused-current" attribute from all the
            //Connector Connection Pool objects and add it to the outbound associations count.
            outboundAssociations = outboundAssociations +
                Utils.getAttributeSum(mbs, objectNames, "numconnused-current");
        ...
        return new Long(outboundAssociations);
    }
}
