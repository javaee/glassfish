...
/**
 * Gets the Last Inbound Activity of the Server
 */
public class LastInboundActivityHandler extends BaseHandler {
    
    /**
     * Constructor.
     */
    public LastInboundActivityHandler() {
        super();
    }
    ...
    public Object handleAttribute(ObjectName peer, String attribute,
        ...
        try {
            ...
            Utils.log(Level.WARNING, "Unable to get LastInboundActivity", exception);
