...
public interface ServerConfigMBean 
    extends com.sun.enterprise.ee.admin.mbeanapi.ServerConfigMBean
{
	...
	public String	getNodeAgentRef() throws MBeanException;
	//KE public void	setNodeAgentRef( final String value ) throws MBeanException;
...
// -------------------- Operations --------------------
	...
	//KE public void	removeSystemPropertyByName( final String key ) throws MBeanException;
