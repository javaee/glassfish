...
public interface ClustersConfigMBean 
    extends com.sun.enterprise.ee.admin.mbeanapi.ClustersConfigMBean
{
...
// -------------------- Operations --------------------
	...
	//KE public ObjectName	createCluster( final javax.management.AttributeList attribute_list ) throws MBeanException;
	//KE public boolean	destroyConfigElement() throws MBeanException;
	public javax.management.ObjectName[]	getCluster() throws MBeanException;
	public ObjectName	getClusterByName( final String key ) throws MBeanException;
	//KE public javax.management.MBeanNotificationInfo[]	getNotificationInfo() throws MBeanException;
	//KE public void	removeClusterByName( final String key ) throws MBeanException;
