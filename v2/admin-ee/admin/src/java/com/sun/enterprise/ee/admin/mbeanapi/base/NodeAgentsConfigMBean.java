...
public interface NodeAgentsConfigMBean 
    extends com.sun.enterprise.ee.admin.mbeanapi.NodeAgentsConfigMBean
{
...
// -------------------- Operations --------------------
	...
	//KE public ObjectName	createNodeAgent( final javax.management.AttributeList attribute_list ) throws MBeanException;
	//KE public boolean	destroyConfigElement() throws MBeanException;
	public javax.management.ObjectName[]	getNodeAgent() throws MBeanException;
	public ObjectName	getNodeAgentByName( final String key ) throws MBeanException;
	//KE public javax.management.MBeanNotificationInfo[]	getNotificationInfo() throws MBeanException;
	//KE public void	removeNodeAgentByName( final String key ) throws MBeanException;
