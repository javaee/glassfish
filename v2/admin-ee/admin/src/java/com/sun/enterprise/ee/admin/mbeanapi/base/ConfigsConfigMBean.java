...
public interface ConfigsConfigMBean 
    extends com.sun.enterprise.ee.admin.mbeanapi.ConfigsConfigMBean
{
...
// -------------------- Operations --------------------
	...
	//KE public ObjectName	createConfig( final javax.management.AttributeList attribute_list ) throws MBeanException;
	//KE public boolean	destroyConfigElement() throws MBeanException;
	public javax.management.ObjectName[]	getConfig() throws MBeanException;
	public ObjectName	getConfigByName( final String key ) throws MBeanException;
	//KE public javax.management.MBeanNotificationInfo[]	getNotificationInfo() throws MBeanException;
	//KE public void	removeConfigByName( final String key ) throws MBeanException;
