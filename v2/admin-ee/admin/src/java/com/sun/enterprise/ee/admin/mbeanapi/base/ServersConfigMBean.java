...
public interface ServersConfigMBean 
    extends com.sun.enterprise.ee.admin.mbeanapi.ServersConfigMBean
{
...
// -------------------- Operations --------------------
	...
	//KE public ObjectName	createServer( final javax.management.AttributeList attribute_list ) throws MBeanException;
	...
	public javax.management.ObjectName[]	getServer() throws MBeanException;
	public ObjectName	getServerByName( final String key ) throws MBeanException;
	...
	//KE public void	removeServerByName( final String key ) throws MBeanException;
