...
public class DottedNameResolverForAliasesEE extends DottedNameResolverForAliases{
    ...
    public DottedNameResolverForAliasesEE(DottedNameQuery srcQuery, DottedNameServerInfo serverInfo,
    ...
    protected String getUnaliasedName( final String dottedNameString )	{
