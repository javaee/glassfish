...
/*
 * ClusterHealthCheckerMBean.java
 *
 * Created on August 5, 2005, 12:04 AM
 */
...
/**
 */
public interface ClusterHealthCheckerMBean {
     ...
     */
    Map<String, List<Long>> getClusterHealth(final String targetCluster) throws InstanceException;
}