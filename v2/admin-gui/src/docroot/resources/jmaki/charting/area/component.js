...
jmaki.namespace("jmaki.widgets.jmaki.charting.area");

jmaki.widgets.jmaki.charting.area.Widget = function(wargs) {
    ...
    function init() {
        ...
        for (var i = 0; i < serises.length; i++) {
            plot.addSeries({ data:serises[i], plotter: dojo.charting.Plotters.StackedCurvedArea });
        }
        pa.plots.push(plot);
