 ...
 *   interface class for providing administration service
 *
 * @author ylee
 *
 */

package com.sun.jbi.jsf.framework.services.administration;
...
public interface AdministrationService {
    ...
    public String deployServiceAssembly(String serviceAssemblyName);
