...
/**
 *  <p>	This Servlet exists so that the Application server doesn't recognize
 *	it as the <code>FacesServlet</code>.  This prevents it from loading
 *	our application at startup time and thus improves server startup
 *	performance.</p.
 */
public class DelayedInitFacesServlet implements Servlet {

    private FacesServlet facesServlet;
    private ConfigureListener listener;
    private ServletContext sc;

    public DelayedInitFacesServlet() {
