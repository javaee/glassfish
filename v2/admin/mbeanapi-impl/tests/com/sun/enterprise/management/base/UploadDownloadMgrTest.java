...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/tests/com/sun/enterprise/management/base/UploadDownloadMgrTest.java,v 1.4 2006/03/09 20:30:52 llc Exp $
 * $Revision: 1.4 $
...
/**
    ...
    <p>
 */
public final class UploadDownloadMgrTest extends AMXTestBase
{
		public
	...
	private final class UploadDownloadTestThread extends Thread
	{
		...
		long		mElapsed;
			...
			public
		UploadDownloadTestThread( final int length )
		{
			mThrowable	= null;
			mDone		= false;
			mLength		= length;
