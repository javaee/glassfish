...
// -------------------- Operations --------------------
	public ObjectName	createJmsHost( final AttributeList attribute_list );
	public boolean	destroyConfigElement();
	public String	getDefaultAttributeValue( final String attributeName );
	public javax.management.ObjectName[]	getJmsHost();
	public ObjectName	getJmsHostByName( final String key );
	public void	removeJmsHostByName( final String key );
}