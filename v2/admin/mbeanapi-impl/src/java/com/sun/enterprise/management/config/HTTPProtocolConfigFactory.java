...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/HTTPProtocolConfigFactory.java,v 1.4 2006/03/09 20:30:38 llc Exp $
 * $Revision: 1.4 $
...
final class HTTPProtocolConfigFactory extends ConfigFactory
{
	private final OldHTTPServiceMBean	mOldHTTPServiceMBean;
	
		public
	HTTPProtocolConfigFactory( final ConfigFactoryCallback	callbacks )
	{
		super( callbacks );
	...
	private final Set<String>	LEGAL_OPTIONAL_KEYS	= 
		GSetUtil.newUnmodifiableStringSet(
    		HTTPProtocolConfigKeys.VERSION_KEY,
    		HTTPProtocolConfigKeys.DNS_LOOKUP_ENABLED_KEY,
    		HTTPProtocolConfigKeys.FORCED_RESPONSE_TYPE_KEY,
    		HTTPProtocolConfigKeys.DEFAULT_RESPONSE_TYPE_KEY,
    		HTTPProtocolConfigKeys.SSL_ENABLED_KEY );
	...
	{
		mOldHTTPServiceMBean.removeHttpProtocol();
	}

		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldHTTPServiceMBean.createHttpProtocol( attrs );
	}
}
