...
/**
	...
	com.sun.appserv:type=web-module,name=com_sun_web_ui,category=config
*/
...
/**
	Configuration for the &lt;rar-module&gt; element.
*/

public final class RARModuleConfigImpl  extends AMXConfigImplBase
{
		public
	RARModuleConfigImpl( final Delegate delegate )
	{
		super( delegate );
	}
