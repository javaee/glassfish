...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/RequestProcessingConfigFactory.java,v 1.4 2006/03/09 20:30:40 llc Exp $
 * $Revision: 1.4 $
...
final class RequestProcessingConfigFactory extends ConfigFactory
{
	private final OldHTTPServiceMBean	mOldHTTPServiceMBean;
		...
		public
	RequestProcessingConfigFactory( final ConfigFactoryCallback	callbacks )
	{
		super( callbacks );
	...
	private final Set<String>	LEGAL_OPTIONAL_KEYS	= 
		...
		RequestProcessingConfigKeys.THREAD_COUNT_KEY,
		RequestProcessingConfigKeys.INITIAL_THREAD_COUNT_KEY,
		RequestProcessingConfigKeys.THREAD_INCREMENT_KEY,
		RequestProcessingConfigKeys.REQUEST_TIMEOUT_IN_SECONDS_KEY,
		RequestProcessingConfigKeys.HEADER_BUFFER_LENGTH_IN_BYTES_KEY );
	...
	{
		mOldHTTPServiceMBean.removeRequestProcessing();
	}
		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldHTTPServiceMBean.createRequestProcessing( attrs );
	}
}
