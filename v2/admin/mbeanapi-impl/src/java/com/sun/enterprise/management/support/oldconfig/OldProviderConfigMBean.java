...
public interface OldProviderConfigMBean extends OldProperties
{
...
// -------------------- Operations --------------------
	public ObjectName	createRequestPolicy( final AttributeList attribute_list );
	public ObjectName	createResponsePolicy( final AttributeList attribute_list );
	public boolean	destroyConfigElement();
	public String	getDefaultAttributeValue( final String attributeName );
	public ObjectName	getRequestPolicy();
	public ObjectName	getResponsePolicy();
