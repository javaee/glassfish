...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/ModuleMonitoringLevelsConfigFactory.java,v 1.5 2006/03/09 20:30:40 llc Exp $
 * $Revision: 1.5 $
...
public final class ModuleMonitoringLevelsConfigFactory extends ConfigFactory
{
	private final OldMonitoringServiceMBean	mOldMonitoringServiceMBean;
		...
		public
	ModuleMonitoringLevelsConfigFactory( final ConfigFactoryCallback	callbacks)
	{
		super( callbacks );
		mOldMonitoringServiceMBean	=
		    getOldConfigProxies().getOldMonitoringServiceMBean( getConfigName() );
	}
	...
	{
		return mOldMonitoringServiceMBean.createModuleMonitoringLevels( attrs );
	}

		public void
	internalRemove( final ObjectName objectName )
	{
		mOldMonitoringServiceMBean.removeModuleMonitoringLevels();
	}
}
