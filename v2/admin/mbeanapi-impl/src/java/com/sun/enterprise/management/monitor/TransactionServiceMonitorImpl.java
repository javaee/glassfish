...
public class TransactionServiceMonitorImpl
	extends MonitoringStatsImplBase
	// implements TransactionServiceMonitor
{
		public
	TransactionServiceMonitorImpl( Delegate delegate ) 
	{
		super( XTypes.TRANSACTION_SERVICE_MONITOR, delegate );
	}
	
		protected Class
	getStatsInterface()
	{
		return( TransactionServiceStats.class );
	}
	
		public TransactionServiceStats
	getTransactionServiceStats()
	{
