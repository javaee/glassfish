...
public final class MessageSecurityConfigImpl extends AMXConfigImplBase
	implements ConfigFactoryCallback
{
		public
	MessageSecurityConfigImpl (final Delegate delegate)
	{
		super( delegate );
	}
/*
		...
		public Map
	getProviderConfigObjectNameMap()
	{
		return( getContaineeObjectNameMap( XTypes.PROVIDER_CONFIG ) );
	}
	...
	getOldMessageSecurityConfigMBean()
	{
		...
		private final ProviderConfigFactory
	getProviderConfigFactory()
	{
	...
	createProviderConfig(
		...
		final  Map reserved)
	{
		return getProviderConfigFactory().create( providerID, providerType, className, reserved );
	}

		public void
	removeProviderConfig(String providerID)
	{
		final ObjectName	objectName	= (ObjectName)
			getProviderConfigObjectNameMap().get( providerID );
			
		getProviderConfigFactory().remove( objectName );
	}
	*/
}
