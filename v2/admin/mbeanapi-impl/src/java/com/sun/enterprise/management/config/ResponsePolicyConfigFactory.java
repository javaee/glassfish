...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/ResponsePolicyConfigFactory.java,v 1.4 2006/03/09 20:30:41 llc Exp $
 * $Revision: 1.4 $
...
public final class ResponsePolicyConfigFactory extends ConfigFactory
{
	...
	{
		mOldProviderConfigMBean.removeResponsePolicy();
	}
	
		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldProviderConfigMBean.createResponsePolicy( attrs );
	}
}