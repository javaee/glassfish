...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/JMSServiceConfigImpl.java,v 1.7 2005/12/25 03:39:24 tcfujii Exp $
 * $Revision: 1.7 $
 * $Date: 2005/12/25 03:39:24 $
 */
...
*/
public final class JMSServiceConfigImpl  extends AMXConfigImplBase
	// implements JMSServiceConfig
	implements ConfigFactoryCallback
{
		public
	JMSServiceConfigImpl( final Delegate delegate )
	{
		super( delegate );
	}
		...
		private final OldJMSServiceMBean
	getOldJMSServiceMBean()
	{
		return getOldConfigProxies().getOldJMSServiceMBean( getConfigName() );
	}
	
		private final JMSHostConfigFactory
	getJMSHostConfigFactory()
	{
