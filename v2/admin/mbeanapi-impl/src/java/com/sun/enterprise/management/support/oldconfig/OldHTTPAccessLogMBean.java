...
/**
	Generated: Fri May 07 13:59:10 PDT 2004
	Generated from:
	com.sun.appserv:type=http-access-log,virtual-server=server,config=server-config,category=config
*/
...
public interface OldHTTPAccessLogMBean
{
	public boolean	getIponly();
	public void	setIponly( final boolean value );
