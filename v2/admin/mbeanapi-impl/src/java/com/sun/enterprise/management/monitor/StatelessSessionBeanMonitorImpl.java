...
public class StatelessSessionBeanMonitorImpl extends BeanMonitorImplBase
	//implements StatelessSessionBeanMonitor
{
		public
	StatelessSessionBeanMonitorImpl( final Delegate delegate) 
	{
		super( XTypes.STATELESS_SESSION_BEAN_MONITOR, delegate );
	}
	...
	getStatsInterface()
	{
		return( StatelessSessionBeanStats.class );
	}
	
		public StatelessSessionBeanStats
	getStatelessSessionBeanStats()
	{
