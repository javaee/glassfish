...
public interface OldEJBContainerConfigMBean  extends OldProperties
{
	...
	public void	setCacheResizeQuantity( final String value );
	...
	public void	setSessionStore( final String value );
...
// -------------------- Operations --------------------
	public ObjectName	createEjbTimerService( final AttributeList attribute_list );
	public boolean	destroyConfigElement();
	public String	getDefaultAttributeValue( final String attributeName );
	public ObjectName	getEjbTimerService();
