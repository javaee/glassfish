...
import static com.sun.appserv.management.config.SecurityServiceConfig.*;
...
public final class SecurityServiceConfigImpl extends AMXConfigImplBase
	// implements SecurityServiceConfig
	implements ConfigFactoryCallback
{
		public
	SecurityServiceConfigImpl( final Delegate delegate )
	{
		super(  delegate );
	}
