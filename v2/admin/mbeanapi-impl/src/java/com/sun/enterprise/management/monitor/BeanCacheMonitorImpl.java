...
public class BeanCacheMonitorImpl extends MonitoringStatsImplBase
	// implements BeanCacheMonitor
{
	public BeanCacheMonitorImpl( Delegate delegate ) 
	{
		super( XTypes.BEAN_CACHE_MONITOR, delegate );
	}
		protected Class
	getStatsInterface()
	{
		return( EJBCacheStats.class );
	}    
	
		public EJBCacheStats
	getEJBCacheStats()
	{
		return (EJBCacheStats)getStats();
	}
