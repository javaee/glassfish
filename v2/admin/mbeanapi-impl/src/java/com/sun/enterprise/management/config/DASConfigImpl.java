...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/DASConfigImpl.java,v 1.7 2005/12/25 03:39:06 tcfujii Exp $
 * $Revision: 1.7 $
...
{
		public
	DASConfigImpl( final Delegate delegate )
	{
		super( delegate );
	}
