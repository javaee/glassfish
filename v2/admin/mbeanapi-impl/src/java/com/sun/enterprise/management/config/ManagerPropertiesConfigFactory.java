...
public final class ManagerPropertiesConfigFactory extends ConfigFactory
{
	private final OldSessionManagerMBean	mOldSessionManager;
		...
		public 
	ManagerPropertiesConfigFactory(
		final ConfigFactoryCallback		callbacks,
		final OldSessionManagerMBean	mgr)
	{
		super( callbacks );
	...
	private final Set<String>	LEGAL_OPTIONAL_KEYS	= 
		...
		ManagerPropertiesConfigKeys.SESSION_FILE_NAME_KEY,
		ManagerPropertiesConfigKeys.MAX_SESSIONS_KEY,
		ManagerPropertiesConfigKeys.REAP_INTERVAL_IN_SECONDS_KEY,
		ManagerPropertiesConfigKeys.SESSION_ID_GENERATOR_CLASS_NAME_KEY
	);
	...
	{
		mOldSessionManager.removeManagerProperties();
	}

		protected ObjectName
	createOldChildConfig( final AttributeList attrs )
	{
		return mOldSessionManager.createManagerProperties( attrs );
	}
