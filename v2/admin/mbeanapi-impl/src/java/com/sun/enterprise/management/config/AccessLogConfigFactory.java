...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/AccessLogConfigFactory.java,v 1.4 2006/03/09 20:30:36 llc Exp $
 * $Revision: 1.4 $
...
final class AccessLogConfigFactory extends ConfigFactory
{
	private final OldHTTPServiceMBean	mOldHTTPServiceMBean;
		...
		public
	AccessLogConfigFactory( final ConfigFactoryCallback	callbacks )
	{
		super( callbacks );
	...
	private final Set<String>	LEGAL_OPTIONAL_KEYS	= 
		...
		AccessLogConfigKeys.FORMAT_KEY,
		AccessLogConfigKeys.ROTATION_POLICY_KEY,
		AccessLogConfigKeys.ROTATION_SUFFIX_KEY,
		AccessLogConfigKeys.ROTATION_ENABLED_KEY,
		AccessLogConfigKeys.ROTATION_INTERVAL_IN_MINUTES_KEY,
		AccessLogConfigKeys.ROTATION_SIZE_LIMIT_IN_BYTES_KEY );
	...
	{
		mOldHTTPServiceMBean.removeAccessLog();
	}
	
		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldHTTPServiceMBean.createAccessLog( attrs );
	}
}
