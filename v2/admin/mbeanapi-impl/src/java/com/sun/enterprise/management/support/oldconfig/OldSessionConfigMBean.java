...
/**
	Generated: Sat May 08 06:04:41 PDT 2004
	Generated from:
	com.sun.appserv:type=session-config,config=default-config,category=config
*/
...
// -------------------- Operations --------------------
	...
	public ObjectName	createSessionManager( final AttributeList attribute_list );
	public ObjectName	createSessionProperties( final AttributeList attribute_list );
	public boolean	destroyConfigElement();
	public javax.management.MBeanNotificationInfo[]	getNotificationInfo();
	public ObjectName	getSessionManager();
	public ObjectName	getSessionProperties();
