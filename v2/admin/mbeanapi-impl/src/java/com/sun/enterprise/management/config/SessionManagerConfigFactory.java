...
final class SessionManagerConfigFactory extends ConfigFactory
{
		...
		final ConfigFactoryCallback	callbacks)
	{
		...
		mOldSessionConfigMBean	=
		    getOldConfigProxies().getOldSessionConfigMBean( getConfigName() );
	}
	...
	{
		mOldSessionConfigMBean.removeSessionManager();
	}

		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldSessionConfigMBean.createSessionManager( attrs );
	}
}
