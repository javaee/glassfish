...
/**
 */
public class ThreadPoolMonitorImpl extends MonitoringStatsImplBase
	// implements ThreadPoolMonitor
{
	public ThreadPoolMonitorImpl(Delegate delegate) 
	{
		super( XTypes.THREAD_POOL_MONITOR, delegate );
	}
	...
	getStatsInterface()
	{
		return( ThreadPoolStats.class );
	}  
	
		public ThreadPoolStats
	getThreadPoolStats()
	{
		return( (ThreadPoolStats)getStats() );
	}  
}
