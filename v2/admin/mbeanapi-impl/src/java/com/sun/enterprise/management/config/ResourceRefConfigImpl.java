...
/**
	...
	com.sun.appserv:type=resource-ref,ref=jdbc/PointBase,server=server,category=config
*/
...
public final class ResourceRefConfigImpl  extends AMXConfigImplBase
{
		public
	ResourceRefConfigImpl( final Delegate		delegate )
	{
		super( delegate );
	}
