...
public interface AMXAttributeNameMapper
{
	...
	matchName(
	    final String   derivedName,
	    final String candidates1, final String candidate2 );
	
	/**
	    Call {@link #getUnmappedOriginals} to get the original names
	    which are not used in a mapping.
	 */
	    public void
	matchNames(
	    final String[] derivedCandidates ,
	    final String[] originalCandidates );
