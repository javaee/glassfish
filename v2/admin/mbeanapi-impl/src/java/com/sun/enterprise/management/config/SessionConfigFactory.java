...
public final class SessionConfigFactory  extends ConfigFactory
{
	private final OldWebContainerConfigMBean	mOldWebContainerConfigMBean;
		...
		public
	SessionConfigFactory(final ConfigFactoryCallback	callbacks)
	{
		super( callbacks );
		
		mOldWebContainerConfigMBean	=
		    getOldConfigProxies().getOldWebContainerConfigMBean( getConfigName() );
	}
	...
	removeSessionConfig()
	{
		mOldWebContainerConfigMBean.removeSessionConfig();
	}

		protected ObjectName
	createOldChildConfig( AttributeList attrs )
	{
		return mOldWebContainerConfigMBean.createSessionConfig( attrs );
	}
}
