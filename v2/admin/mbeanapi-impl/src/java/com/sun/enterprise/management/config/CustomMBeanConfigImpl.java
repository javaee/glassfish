...
/*
 * $Header: /cvs/glassfish/admin/mbeanapi-impl/src/java/com/sun/enterprise/management/config/CustomMBeanConfigImpl.java,v 1.4 2005/12/25 03:39:05 tcfujii Exp $
 * $Revision: 1.4 $
 * $Date: 2005/12/25 03:39:05 $
 */
 ...
 */
public final class CustomMBeanConfigImpl extends AMXConfigImplBase
	// implements CustomMBeanConfig
{
		public
	CustomMBeanConfigImpl( Delegate	delegate )
	{
		super( delegate );
	}
