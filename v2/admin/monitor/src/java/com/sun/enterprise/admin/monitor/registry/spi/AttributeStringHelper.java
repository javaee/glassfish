...
/* AttributeStringHelper.java
 * $Id: AttributeStringHelper.java,v 1.3 2005/12/25 03:43:32 tcfujii Exp $
 * $Revision: 1.3 $
...
/**
 * Helper to handle concatenation and splitting up of attr names 
 * @author  Shreedhar Ganapathy<mailto:shreedhar.ganapathy@sun.com>
 */
public class AttributeStringHelper {
    private static final String DELIMITER="_";

    public static String joinAttributes(String a, String b){
    ...
    static String[] splitAttribute(String a){
