...
/* OrbChangeHandler.java
 * $Id: OrbChangeHandler.java,v 1.3 2005/12/25 03:43:41 tcfujii Exp $
 * $Revision: 1.3 $
 * $Date: 2005/12/25 03:43:41 $
...
/**
 * Provides for dynamic reconfiguration of ORB and related components like
 * connection manager. This class decides the actions to take when there are
 ...
 */
class OrbChangeHandler implements ChangeHandler {
	...
	private boolean isOrbType(MonitoredObjectType t) {
		return ( t == MonitoredObjectType.ORB		||
				 t == MonitoredObjectType.CONNECTION_MANAGER);
	}
