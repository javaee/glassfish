...
/* EmptyChangeHandler.java
 * $Id: EmptyChangeHandler.java,v 1.3 2005/12/25 03:43:39 tcfujii Exp $
 * $Revision: 1.3 $
...
class EmptyChangeHandler implements ChangeHandler {
	...
	public void handleChange(MonitoredObjectType t, MonitoringLevel from, MonitoringLevel to) {
		logger.finer("Received handleChange monitoring event for type: " + t.getTypeName());
