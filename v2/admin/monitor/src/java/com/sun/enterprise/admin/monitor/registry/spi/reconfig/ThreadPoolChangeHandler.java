...
/* ThreadPoolChangeHandler.java
 * $Id: ThreadPoolChangeHandler.java,v 1.3 2005/12/25 03:43:41 tcfujii Exp $
 * $Revision: 1.3 $
...
/**
 * Provides for dynamic reconfiguration of all the Thread Pool.
 ...
 */
class ThreadPoolChangeHandler implements ChangeHandler {
	...
	ThreadPoolChangeHandler(ChangeHandler successor, ValueListMap listeners) {
	...
	private boolean isThreadPoolType(MonitoredObjectType t) {
