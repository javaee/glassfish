...
/* MonitoringMBeansFactory.java
 * $Id: MonitoringMBeansFactory.java,v 1.3 2005/12/25 03:43:34 tcfujii Exp $
 * $Revision: 1.3 $
...
/**
 * Factory to produce a DynamicMBean for a given Stats object.
 * @author  Shreedhar Ganapathy
 */
public class MonitoringMBeansFactory {
    /**
     * returns a DynamicMBean for monitoring purposes given a Stats object. 
     * @param javax.management.j2ee.statistics.Stats
     * @return javax.management.DynamicMBean
     */
    public static DynamicMBean generateMonitoringMBean(Stats stats) {
        GeneratedMonitoringMBeanImpl m = new GeneratedMonitoringMBeanImpl(stats);
        m.introspect();
        return m;
    }
