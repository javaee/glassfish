...
/**
 * Listener impl to handle web-service-endpoint/registry location 
 * element events.
 */
public class RegistryLocationEventListenerImpl implements 
     ...
     *         process the event.
     */
    public void handleDelete(RegistryLocationEvent event)
             throws AdminEventListenerException {
    }

    private void handleReconfiguration(RegistryLocationEvent event, boolean 
    ...
    /**
     * Handles web-service-endpoint/registry location element modification 
     ...
     *         process the event.
     */
    public void handleUpdate(RegistryLocationEvent event)
             throws AdminEventListenerException {
     ...
     *         process the event.
     */
    public void handleCreate(RegistryLocationEvent event)
             throws AdminEventListenerException {
    }
