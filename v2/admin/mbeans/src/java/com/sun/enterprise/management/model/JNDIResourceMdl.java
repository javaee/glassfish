...
public class JNDIResourceMdl extends J2EEResourceMdl {

    private static String MANAGED_OBJECT_TYPE = "JNDIResource";
    public JNDIResourceMdl(String name) {
        super(name);
    }
    public JNDIResourceMdl(String name,String serverName) {
        super(name,serverName);
    }
    
    //constructor for generic instantiation from the MBeanRegistry
    public JNDIResourceMdl(String[] location) {
