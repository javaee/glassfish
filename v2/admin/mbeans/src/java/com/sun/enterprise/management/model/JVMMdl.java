...
public class JVMMdl extends J2EEManagedObjectMdl {
    ...
    public JVMMdl(String name){
        super(name,false,false,false);
        this.jvmName = name;
    }
    public JVMMdl(String name, String serverName){
        super(name,serverName,false,false,false);
        this.jvmName = name;
    }

    //constructor for generic instantiation from the MBeanRegistry
    public JVMMdl(String[] location) {
        this(location[2], location[1]);
    }

    public String getjavaVersion(){ return System.getProperty("java.version"); }

    public String getjavaVendor(){ return System.getProperty("java.vendor"); }
    ...
    public String getobjectName() {
        Set s = findNames("j2eeType="+getj2eeType()+",name="+this.jvmName);
