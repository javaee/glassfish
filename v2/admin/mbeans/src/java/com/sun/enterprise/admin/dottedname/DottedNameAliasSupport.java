...
/*
 * $Header: /cvs/glassfish/admin/mbeans/src/java/com/sun/enterprise/admin/dottedname/DottedNameAliasSupport.java,v 1.3 2005/12/25 03:42:02 tcfujii Exp $
 * $Revision: 1.3 $
...
public class DottedNameAliasSupport
{
	 ...
	 */
	static public final Set	DOMAIN_PARTS	= ArrayConversion.toSet( new String []
		{
			// these are prefixes
			"applications",
			"resources"
	 ...
	 */
	static private final Set	NON_ALIASED_PARTS_SET	= ArrayConversion.toSet( new String []
		{
			// these are prefixes
			"application-ref",
			"resource-ref",
