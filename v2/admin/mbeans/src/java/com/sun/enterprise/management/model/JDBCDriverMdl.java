...
public class JDBCDriverMdl extends J2EEManagedObjectMdl {

    private static String MANAGED_OBJECT_TYPE = "JDBCDriver";
    ...
    public String getobjectName() {
        Set s = findNames("j2eeType="+getj2eeType()+",name="+this.jdbcDriverName+",J2EEServer="+getJ2EEServer());
