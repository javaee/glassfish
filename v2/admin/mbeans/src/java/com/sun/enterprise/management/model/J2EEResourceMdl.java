...
public abstract class J2EEResourceMdl extends J2EEManagedObjectMdl {
    
    private String resourceName;
    J2EEResourceMdl(String name) {
        super(name,false, false, false);
        this.resourceName = name;
    }
    J2EEResourceMdl(String name, String serverName) {
    ...
    public String getobjectName() {
        Set s = findNames("j2eeType="+getj2eeType()+",name="+this.resourceName+",J2EEServer="+getJ2EEServer());
