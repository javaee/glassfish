...
public class JMSResourceMdl extends J2EEResourceMdl {

    private static String MANAGED_OBJECT_TYPE = "JMSResource";
    
    protected String resType = null;
    protected String username = null;
    protected String password = null;
    protected String[] propNames = null;
    protected String[] propValues = null;
        
    public JMSResourceMdl(String name, String resType,
    ...
    public JMSResourceMdl(String name, String serverName, String resType,
                                    String username, String password,
                                    String[] propNames, String[] propValues) {
