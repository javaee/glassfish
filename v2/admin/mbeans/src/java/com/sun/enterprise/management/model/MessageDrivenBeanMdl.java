 ...
 */
public class MessageDrivenBeanMdl extends EJBMdl {

    private static String MANAGED_OBJECT_TYPE = "MessageDrivenBean";
    
    public MessageDrivenBeanMdl(String name, String bundleName, String appName) {
        super(name, bundleName, appName);        
    }
   
    public MessageDrivenBeanMdl(String name, String bundleName, String appName, String serverName) {
