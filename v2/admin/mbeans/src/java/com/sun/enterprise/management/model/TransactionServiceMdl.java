...
public class TransactionServiceMdl {
    ...
    public TransactionServiceMdl(String name){
	//name not used
    }
    ...
    public void rollback(java.lang.String[] txids) {
        for (int i = 0; i < txids.length; i++)
           JTAStatsImpl.getInstance().rollback(txids[i]);
    }

    private String stringify(String[] txids) {
	String ret = "";
	if(txids != null) {
	    for(int i = 0;i<txids.length;i++) {
	        ret += txids[i] + ",";
