...
/*
 * JCAConnectionFactoryMdl.java
 *
 * Created on March 5, 2002, 4:00 PM
 */
...
public class JCAConnectionFactoryMdl extends J2EEManagedObjectMdl {
    ...
    /** Creates new JCAConnectionFactoryMdl */
    public JCAConnectionFactoryMdl(String jcaResName, String jcaConnFactName, String managedConFact) {
    ...
    public String getobjectName() {
        Set s = findNames("j2eeType="+getj2eeType()+",name="+this.jcaConnectionFactoryName+",JCAResource="+this.getJCAResource()+",J2EEServer="+this.getJ2EEServer());
