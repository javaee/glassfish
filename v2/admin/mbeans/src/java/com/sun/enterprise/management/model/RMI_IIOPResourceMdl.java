...
public class RMI_IIOPResourceMdl extends J2EEResourceMdl {

    private static String MANAGED_OBJECT_TYPE = "RMI_IIOPResource";
    public RMI_IIOPResourceMdl(String name) {
        super(name);
    }
    public RMI_IIOPResourceMdl(String name, String serverName) {
        super(name,serverName);
    }

    //constructor for generic instantiation from the MBeanRegistry
    public RMI_IIOPResourceMdl(String[] location) {
