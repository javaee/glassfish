...
public class ResourceAdapterMdl extends J2EEManagedObjectMdl {
    private static String MANAGED_OBJECT_TYPE = "ResourceAdapter";
    
    private String raModuleName = null;
    ...
    public String getobjectName() {
        Set s = findNames("j2eeType="+getj2eeType()+",name="+this.resourceAdapterName+",ResourceAdapterModule="+this.getResourceAdapterModule()+",J2EEApplication="+this.getJ2EEApplication()+",J2EEServer="+this.getJ2EEServer());
