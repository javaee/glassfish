 ...
 * JUnit based test
 *
 * Created on March 18, 2004, 5:24 PM
 */
...
public class BackupManagerTest extends TestCase
{
	...
	public BackupManagerTest(java.lang.String testName)
	{
		super(testName);
	}
	...
	{
		TestSuite suite = new TestSuite(BackupManagerTest.class);
		return suite;
	}
	
	/** Test of backup method, of class com.sun.enterprise.config.backup.BackupManager. */
