...
/**
 * AddonException indicates that the Addon has failed to execute the 
...
public class AddonException extends Exception {
    ...
    /**
     * Constructs an <code>AddonException</code> object with null reason;
     */
    public AddonException() {
    }

    /**
     * Constructs an <code>AddonException</code> object with a reason;
     *
    ...
    /**
     * Constructs an <code>AddonException</code> object with a cause.
     *
    ...
    /**
     * Constructs an <code>AddonException</code> object with a reason and
     * and cause.
     *
     * @param reason a description of the exception
     * @param cause cause of the exception.
