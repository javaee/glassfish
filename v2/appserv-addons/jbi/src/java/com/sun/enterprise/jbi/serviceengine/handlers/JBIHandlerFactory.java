 ...
 */
public class JBIHandlerFactory {

    private static JBIHandlerFactory factory = new JBIHandlerFactory();
    private static List<JBIHandler> handlers;
    ...
    public static JBIHandlerFactory getInstance() {
        return factory;
    }
     ...
     */
    public List<JBIHandler> getHandlers() {
        return handlers;
    }
}
