...
public class JAXRPCClientTransportFactory implements ClientTransportFactory {
    ...
    //private Object endpt;
    
    public JAXRPCClientTransportFactory(ServiceRefPortInfo portInfo) {
        //setServiceQName(portInfo.getServiceReference().getServiceName());
        setServicePortInfo(portInfo);
    }
    
    public ClientTransport create() {
        JAXRPCClientTransport transport = new JAXRPCClientTransport();
	//transport.setServiceQName(serviceQName);
    ...
    /*public void setJBIEndpoint(Object e) {
	endpt = e;
    }*/
