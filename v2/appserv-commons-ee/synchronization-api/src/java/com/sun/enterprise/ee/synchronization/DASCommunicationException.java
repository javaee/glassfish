...
/**
 * This exception is thrown when client is unable to communicate with 
...
public class DASCommunicationException extends SynchronizationException {
     ...
     */
    public DASCommunicationException(String msg, Throwable cause) {
        super(msg, cause);
    }

    /**
     * Constructs exception with the cause.
     *
     * @param   cause  the cause of this error
     */
    public DASCommunicationException(Throwable cause) {
        super(cause);
    }
     ...
     * @param   msg    the detail message for this exception
     */
    public DASCommunicationException(String msg) {
        super(msg);
    }
