...
/**
 * API for security service synchronization. The APIs can be called
 * in a server instance to download bits from central repository.
 *
 * <xmp>
 * Example: The following code snippet synchronizes a key file.
 *
 ...
 *
 *   // auth realm name
 *   String fileRealmName = event.getAuthRealmName();
 *
...
public interface SecurityServiceMgr {
    ...
    /**
     * Synchronizes a key file from central repository.
     *
     * @param   realmName   name of the auth realm
     *
