...
public abstract class NioProvider{
    ...
    private static final String NIO_PROVIDER_CLASS = 
    "com.sun.enterprise.web.connector.grizzly.NioProviderImpl";

    private static NioProvider nioProvider = null;
    static {
        try {
     ...
     */
    public abstract SelectionKey keyFor(SelectableChannel channel, Selector sel); 
