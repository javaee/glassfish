...
public class Event extends ConfigBean implements Serializable
{
	...
	* @return  the Type of the Element event
	*/
	...
	* @return  the RecordEvent of the Element event
	*/
	...
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setRecordEvent(boolean v, boolean overwrite) throws StaleWriteConfigException {
