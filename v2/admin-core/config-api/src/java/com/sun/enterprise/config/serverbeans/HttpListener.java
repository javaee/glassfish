...
public class HttpListener extends ConfigBean implements Serializable
{
	...
	* @return  the Id of the Element http-listener
	*/
	public String getId() {
	...
	* @return  the Address of the Element http-listener
	*/
	...
	* @return  the Port of the Element http-listener
	*/
	...
	* @return  the ExternalPort of the Element http-listener
	*/
	...
	* @return  the Family of the Element http-listener
	*/
	...
	* @return  the BlockingEnabled of the Element http-listener
	*/
	...
	* @return  the AcceptorThreads of the Element http-listener
	*/
	...
	* @return  the SecurityEnabled of the Element http-listener
	*/
	...
	* @return  the DefaultVirtualServer of the Element http-listener
	*/
	...
	* @return  the ServerName of the Element http-listener
	*/
	...
	* @return  the RedirectPort of the Element http-listener
	*/
	...
	* @return  the XpoweredBy of the Element http-listener
	*/
	...
	* @return  the Enabled of the Element http-listener
	*/
