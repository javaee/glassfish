...
/**
 *	This generated bean class WebContainer matches the DTD element web-container
 *
 */
...
public class WebContainer extends ConfigBean implements Serializable
{

	static Vector comparators = new Vector();
	private static final org.netbeans.modules.schema2beans.Version runtimeVersion = new org.netbeans.modules.schema2beans.Version(4, 2, 0);

	static public final String SESSION_CONFIG = "SessionConfig";
	...
	public WebContainer(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(2);
		this.createProperty("session-config", SESSION_CONFIG, 
	...
	public int addElementProperty(ElementProperty value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(WebContainer.class).getString("cannotAddDuplicate",  "ElementProperty"));
		}
