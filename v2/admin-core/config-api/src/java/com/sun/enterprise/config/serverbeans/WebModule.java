...
/**
 *	This generated bean class WebModule matches the DTD element web-module
 *
 */
...
public class WebModule extends ConfigBean implements Serializable
{
	...
	/**
	* Return  the Description of the Element web-module
	*/
	public String getDescription() {
		return (String) getValue(ServerTags.DESCRIPTION);
	}
	/**
	* Modify  the Description of the Element web-module
	...
	*/
	...
	public int addWebServiceEndpoint(WebServiceEndpoint value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(WebModule.class).getString("cannotAddDuplicate",  "WebServiceEndpoint"));
		}
	...
	public int addElementProperty(ElementProperty value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(WebModule.class).getString("cannotAddDuplicate",  "ElementProperty"));
		}
	...
	/**
	* Getter for Name of the Element web-module
	* @return  the Name of the Element web-module
	*/
	public String getName() {
		return getAttributeValue(ServerTags.NAME);
	}
	/**
	* Modify  the Name of the Element web-module
	* @param v the new value
	...
	*/
	...
	/**
	* Getter for ContextRoot of the Element web-module
	* @return  the ContextRoot of the Element web-module
	*/
	public String getContextRoot() {
		return getAttributeValue(ServerTags.CONTEXT_ROOT);
	}
	/**
	* Modify  the ContextRoot of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setContextRoot(String v, boolean overwrite) throws StaleWriteConfigException {
		setAttributeValue(ServerTags.CONTEXT_ROOT, v, overwrite);
	}
	/**
	* Modify  the ContextRoot of the Element web-module
	* @param v the new value
	*/
	public void setContextRoot(String v) {
		setAttributeValue(ServerTags.CONTEXT_ROOT, v);
	}
	/**
	* Getter for Location of the Element web-module
	* @return  the Location of the Element web-module
	*/
	public String getLocation() {
		return getAttributeValue(ServerTags.LOCATION);
	}
	/**
	* Modify  the Location of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for ObjectType of the Element web-module
	* @return  the ObjectType of the Element web-module
	*/
	public String getObjectType() {
		return getAttributeValue(ServerTags.OBJECT_TYPE);
	}
	/**
	* Modify  the ObjectType of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for Enabled of the Element web-module
	* @return  the Enabled of the Element web-module
	*/
	public boolean isEnabled() {
		return toBoolean(getAttributeValue(ServerTags.ENABLED));
	}
	/**
	* Modify  the Enabled of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for Libraries of the Element web-module
	* @return  the Libraries of the Element web-module
	*/
	public String getLibraries() {
			return getAttributeValue(ServerTags.LIBRARIES);
	}
	/**
	* Modify  the Libraries of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for AvailabilityEnabled of the Element web-module
	* @return  the AvailabilityEnabled of the Element web-module
	*/
	public boolean isAvailabilityEnabled() {
		return toBoolean(getAttributeValue(ServerTags.AVAILABILITY_ENABLED));
	}
	/**
	* Modify  the AvailabilityEnabled of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for DirectoryDeployed of the Element web-module
	* @return  the DirectoryDeployed of the Element web-module
	*/
	public boolean isDirectoryDeployed() {
		return toBoolean(getAttributeValue(ServerTags.DIRECTORY_DEPLOYED));
	}
	/**
	* Modify  the DirectoryDeployed of the Element web-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	protected String getRelativeXPath() {
	    String ret = null;
	    ret = "web-module" + (canHaveSiblings() ? "[@name='" + getAttributeValue("name") +"']" : "") ;
