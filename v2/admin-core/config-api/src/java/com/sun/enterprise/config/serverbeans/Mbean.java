...
public class Mbean extends ConfigBean implements Serializable
{
	...
	* @return  the Name of the Element mbean
	*/
	...
	* @return  the ObjectType of the Element mbean
	*/
	...
	* @return  the ImplClassName of the Element mbean
	*/
	...
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setImplClassName(String v, boolean overwrite) throws StaleWriteConfigException {
	...
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setObjectName(String v, boolean overwrite) throws StaleWriteConfigException {
	...
	* @return  the Enabled of the Element mbean
	*/
