...
/**
 *	This generated bean class AppclientModule matches the DTD element appclient-module
 *
 */
...
public class AppclientModule extends ConfigBean implements Serializable
{
	...
	public AppclientModule(int options)
	{
	...
	/**
	* Return  the Description of the Element appclient-module
	*/
	public String getDescription() {
		return (String) getValue(ServerTags.DESCRIPTION);
	}
	/**
	* Modify  the Description of the Element appclient-module
	...
	*/
	...
	public int addElementProperty(ElementProperty value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(AppclientModule.class).getString("cannotAddDuplicate",  "ElementProperty"));
		}
	...
	/**
	* Getter for Name of the Element appclient-module
	* @return  the Name of the Element appclient-module
	*/
	public String getName() {
		return getAttributeValue(ServerTags.NAME);
	}
	/**
	* Modify  the Name of the Element appclient-module
	* @param v the new value
	...
	*/
	...
	/**
	* Getter for Location of the Element appclient-module
	* @return  the Location of the Element appclient-module
	*/
	public String getLocation() {
		return getAttributeValue(ServerTags.LOCATION);
	}
	/**
	* Modify  the Location of the Element appclient-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for DirectoryDeployed of the Element appclient-module
	* @return  the DirectoryDeployed of the Element appclient-module
	*/
	public boolean isDirectoryDeployed() {
		return toBoolean(getAttributeValue(ServerTags.DIRECTORY_DEPLOYED));
	}
	/**
	* Modify  the DirectoryDeployed of the Element appclient-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for JavaWebStartEnabled of the Element appclient-module
	* @return  the JavaWebStartEnabled of the Element appclient-module
	*/
	public boolean isJavaWebStartEnabled() {
		return toBoolean(getAttributeValue(ServerTags.JAVA_WEB_START_ENABLED));
	}
	/**
	* Modify  the JavaWebStartEnabled of the Element appclient-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setJavaWebStartEnabled(boolean v, boolean overwrite) throws StaleWriteConfigException {
	...
	*/
	protected String getRelativeXPath() {
	    String ret = null;
	    ret = "appclient-module" + (canHaveSiblings() ? "[@name='" + getAttributeValue("name") +"']" : "") ;
