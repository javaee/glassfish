...
public class SystemProperty extends ConfigBean implements Serializable
{
	...
	* @return  the Name of the Element system-property
	*/
	...
	* @return  the Value of the Element system-property
	*/
