...
/**
 *	This generated bean class ResourceRef matches the DTD element resource-ref
 *
 */
...
public class ResourceRef extends ConfigBean implements Serializable
{
	...
	/**
	* Getter for Enabled of the Element resource-ref
	* @return  the Enabled of the Element resource-ref
	*/
	public boolean isEnabled() {
		return toBoolean(getAttributeValue(ServerTags.ENABLED));
	}
	/**
	* Modify  the Enabled of the Element resource-ref
	...
	*/
	...
	/**
	* Getter for Ref of the Element resource-ref
	* @return  the Ref of the Element resource-ref
	*/
	public String getRef() {
		return getAttributeValue(ServerTags.REF);
	}
	/**
	* Modify  the Ref of the Element resource-ref
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	protected String getRelativeXPath() {
	    String ret = null;
	    ret = "resource-ref" + (canHaveSiblings() ? "[@ref='" + getAttributeValue("ref") +"']" : "") ;
