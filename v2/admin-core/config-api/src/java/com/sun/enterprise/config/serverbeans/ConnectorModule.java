...
/**
 *	This generated bean class ConnectorModule matches the DTD element connector-module
 *
 */
...
public class ConnectorModule extends ConfigBean implements Serializable
{
	...
	public ConnectorModule(int options)
	{
	...
	/**
	* Return  the Description of the Element connector-module
	*/
	public String getDescription() {
		return (String) getValue(ServerTags.DESCRIPTION);
	}
	/**
	* Modify  the Description of the Element connector-module
	...
	*/
	...
	public int addElementProperty(ElementProperty value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(ConnectorModule.class).getString("cannotAddDuplicate",  "ElementProperty"));
		}
	...
	/**
	* Getter for Name of the Element connector-module
	* @return  the Name of the Element connector-module
	*/
	public String getName() {
		return getAttributeValue(ServerTags.NAME);
	}
	/**
	* Modify  the Name of the Element connector-module
	* @param v the new value
	...
	*/
	...
	/**
	* Getter for Location of the Element connector-module
	* @return  the Location of the Element connector-module
	*/
	public String getLocation() {
		return getAttributeValue(ServerTags.LOCATION);
	}
	/**
	* Modify  the Location of the Element connector-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for ObjectType of the Element connector-module
	* @return  the ObjectType of the Element connector-module
	*/
	public String getObjectType() {
		return getAttributeValue(ServerTags.OBJECT_TYPE);
	}
	/**
	* Modify  the ObjectType of the Element connector-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for Enabled of the Element connector-module
	* @return  the Enabled of the Element connector-module
	*/
	public boolean isEnabled() {
		return toBoolean(getAttributeValue(ServerTags.ENABLED));
	}
	/**
	* Modify  the Enabled of the Element connector-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for DirectoryDeployed of the Element connector-module
	* @return  the DirectoryDeployed of the Element connector-module
	*/
	public boolean isDirectoryDeployed() {
		return toBoolean(getAttributeValue(ServerTags.DIRECTORY_DEPLOYED));
	}
	/**
	* Modify  the DirectoryDeployed of the Element connector-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	protected String getRelativeXPath() {
	    String ret = null;
	    ret = "connector-module" + (canHaveSiblings() ? "[@name='" + getAttributeValue("name") +"']" : "") ;
