...
/**
 *	This generated bean class ExtensionModule matches the DTD element extension-module
 *
 */
...
public class ExtensionModule extends ConfigBean implements Serializable
{
	...
	public ExtensionModule(int options)
	{
	...
	/**
	* Return  the Description of the Element extension-module
	*/
	public String getDescription() {
		return (String) getValue(ServerTags.DESCRIPTION);
	}
	/**
	* Modify  the Description of the Element extension-module
	...
	*/
	...
	public int addElementProperty(ElementProperty value, boolean overwrite)
		...
		if(old != null) {
			throw new ConfigException(StringManager.getManager(ExtensionModule.class).getString("cannotAddDuplicate",  "ElementProperty"));
		}
	...
	/**
	* Getter for Name of the Element extension-module
	* @return  the Name of the Element extension-module
	*/
	public String getName() {
		return getAttributeValue(ServerTags.NAME);
	}
	/**
	* Modify  the Name of the Element extension-module
	* @param v the new value
	...
	*/
	...
	/**
	* Getter for Location of the Element extension-module
	* @return  the Location of the Element extension-module
	*/
	public String getLocation() {
		return getAttributeValue(ServerTags.LOCATION);
	}
	/**
	* Modify  the Location of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for ModuleType of the Element extension-module
	* @return  the ModuleType of the Element extension-module
	*/
	public String getModuleType() {
		return getAttributeValue(ServerTags.MODULE_TYPE);
	}
	/**
	* Modify  the ModuleType of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	public void setModuleType(String v, boolean overwrite) throws StaleWriteConfigException {
		setAttributeValue(ServerTags.MODULE_TYPE, v, overwrite);
	}
	/**
	* Modify  the ModuleType of the Element extension-module
	* @param v the new value
	*/
	public void setModuleType(String v) {
		setAttributeValue(ServerTags.MODULE_TYPE, v);
	}
	/**
	* Getter for ObjectType of the Element extension-module
	* @return  the ObjectType of the Element extension-module
	*/
	public String getObjectType() {
		return getAttributeValue(ServerTags.OBJECT_TYPE);
	}
	/**
	* Modify  the ObjectType of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for Enabled of the Element extension-module
	* @return  the Enabled of the Element extension-module
	*/
	public boolean isEnabled() {
		return toBoolean(getAttributeValue(ServerTags.ENABLED));
	}
	/**
	* Modify  the Enabled of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for Libraries of the Element extension-module
	* @return  the Libraries of the Element extension-module
	*/
	public String getLibraries() {
			return getAttributeValue(ServerTags.LIBRARIES);
	}
	/**
	* Modify  the Libraries of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for AvailabilityEnabled of the Element extension-module
	* @return  the AvailabilityEnabled of the Element extension-module
	*/
	public boolean isAvailabilityEnabled() {
		return toBoolean(getAttributeValue(ServerTags.AVAILABILITY_ENABLED));
	}
	/**
	* Modify  the AvailabilityEnabled of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	...
	/**
	* Getter for DirectoryDeployed of the Element extension-module
	* @return  the DirectoryDeployed of the Element extension-module
	*/
	public boolean isDirectoryDeployed() {
		return toBoolean(getAttributeValue(ServerTags.DIRECTORY_DEPLOYED));
	}
	/**
	* Modify  the DirectoryDeployed of the Element extension-module
	* @param v the new value
	* @throws StaleWriteConfigException if overwrite is false and file changed on disk
	*/
	...
	*/
	protected String getRelativeXPath() {
	    String ret = null;
	    ret = "extension-module" + (canHaveSiblings() ? "[@name='" + getAttributeValue("name") +"']" : "") ;
