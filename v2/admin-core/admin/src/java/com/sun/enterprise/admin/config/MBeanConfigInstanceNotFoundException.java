...
/*
 *   $Id: MBeanConfigInstanceNotFoundException.java,v 1.3 2005/12/25 03:47:30 tcfujii Exp $
 *   @author: alexkrav
 *
 *   $Log: MBeanConfigInstanceNotFoundException.java,v $
 *   Revision 1.3  2005/12/25 03:47:30  tcfujii
 ...
 *
 *   Revision 1.3  2004/11/14 07:04:17  tcfujii
 *   Updated copyright text and/or year.
 *
 *   Revision 1.2  2004/02/20 03:56:08  qouyang
 *
 *
 ...
 *
 *   Revision 1.1.4.1  2004/02/02 07:25:14  tcfujii
 *   Copyright updates notices; reviewer: Tony Ng
 *
 *   Revision 1.1  2003/09/16 23:19:11  kravtch
 *   Bug #4923642
 *   reviewer: Abhijit
...
// This Exception can be ONLY (!!!!) for getXXX()/getXXXbyYYY(name) operation returning ObjectName
// GUI uses its type to special treatment
// please contact GUI team before using it (throw or extend)
