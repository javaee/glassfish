...
/*
 *   $Id: MBeanMetaException.java,v 1.3 2005/12/25 03:47:36 tcfujii Exp $
 *   @author: alexkrav
 *
 *   $Log: MBeanMetaException.java,v $
 ...
 *
 *   Revision 1.6  2004/11/14 07:04:20  tcfujii
 *   Updated copyright text and/or year.
 *
 *   Revision 1.5  2004/02/20 03:56:14  qouyang
 *
 *
 ...
 *
 *   Revision 1.4  2003/11/20 22:41:27  sridatta
 *   implemented registration of all config mbeans. see javadoc for more details.
 *
 *   Revision 1.3.4.1  2004/02/02 07:25:18  tcfujii
...
{
    /**
        Creates new <code>MBeanMetaException</code> without detail message.
    */
    ...
    /**
        Constructs an <code>MBeanMetaException</code> with the specified detail message.
   ...
   /**
    * Constructs an <code>MBeanMetaException</code> with the specified 
