...
/*
 * $Header: /cvs/glassfish/admin-core/admin/src/java/com/sun/enterprise/admin/dottedname/DottedNameSource.java,v 1.3 2005/12/25 03:47:33 tcfujii Exp $
 * $Revision: 1.3 $
...
public interface DottedNameSource
{
	/*
		...
		@returns Set	the Set of all dotted names
	 */
