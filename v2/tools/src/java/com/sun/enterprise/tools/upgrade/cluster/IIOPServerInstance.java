...
/*
 * IIOPServerInstance.java
 *
 * Created on June 13, 2004, 12:10 AM
 */
...
public class IIOPServerInstance {
    ...
    /** Creates a new instance of IIOPServerInstance */
    public IIOPServerInstance(String name) {
        this.name = name;
    }
    public void addIIOPEndPoint(String id, String host, String port){
        if(this.iiopEndPoints == null)
            this.iiopEndPoints = new ArrayList();
        this.iiopEndPoints.add(new IIOPEndPoint(id,host,port));
    }
