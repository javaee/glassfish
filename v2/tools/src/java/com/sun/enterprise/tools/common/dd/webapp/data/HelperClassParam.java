...
/**
 *	This generated bean class HelperClassParam matches the schema element helper-class-param
 *
...
public class HelperClassParam extends com.sun.enterprise.tools.common.dd.ParamData
{
	...
	public HelperClassParam() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public HelperClassParam(int options)
	{
