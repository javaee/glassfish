...
/**
 *	This generated bean class BeanCache matches the schema element bean-cache
 *
...
public class BeanCache extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	static public final String RESIZE_QUANTITY = "ResizeQuantity";	// NOI18N
	static public final String IS_CACHE_OVERFLOW_ALLOWED = "IsCacheOverflowAllowed";	// NOI18N
	static public final String CACHE_IDLE_TIMEOUT_IN_SECONDS = "CacheIdleTimeoutInSeconds";	// NOI18N
	static public final String REMOVAL_TIMEOUT_IN_SECONDS = "RemovalTimeoutInSeconds";	// NOI18N
	static public final String VICTIM_SELECTION_POLICY = "VictimSelectionPolicy";	// NOI18N
