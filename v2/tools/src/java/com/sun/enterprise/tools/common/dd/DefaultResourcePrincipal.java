...
/**
 *	This generated bean class DefaultResourcePrincipal matches the schema element default-resource-principal
 *
...
public class DefaultResourcePrincipal extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	public DefaultResourcePrincipal(int options)
	{
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		if (getPassword() == null) {
			throw new org.netbeans.modules.schema2beans.ValidateException("getPassword() == null", "password", this);	// NOI18N
		}
	}
	...
	public String dumpBeanNode(){
		...
		str.append("DefaultResourcePrincipal\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
