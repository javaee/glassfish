...
public class GenericComponent extends BaseElement {
    ...
    /**
     * element - lifecycle-module | j2ee-application | ejb-module | web-module | connector-module
     * parentSource - applications
     * parentResult - domain
     */
    public void transform(Element element, Element parentSource, Element parentResult){
        logger.log(java.util.logging.Level.FINE, stringManager.getString("upgrade.transform.componentUpgradedByDeployModule"),element.getTagName());
        return;
    }
