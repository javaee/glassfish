...
/**
 *	This generated bean class MdbConnectionFactory matches the schema element mdb-connection-factory
 *
...
public class MdbConnectionFactory extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	public MdbConnectionFactory() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public MdbConnectionFactory(int options)
	{
	...
	public String dumpBeanNode(){
		...
		str.append("MdbConnectionFactory\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
