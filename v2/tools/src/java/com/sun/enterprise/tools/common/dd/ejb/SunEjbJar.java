...
/**
 *	This generated bean class SunEjbJar matches the schema element sun-ejb-jar
 *
 ...
 *				principal : Principal?
 *					name : String
 *				mdb-connection-factory : MdbConnectionFactory?
 *					jndi-name : String
 *					default-resource-principal : DefaultResourcePrincipal?
 *						name : String
 *						password : String
 ...
 *				ior-security-config : IorSecurityConfig?
 ...
 *				cmt-timeout-in-seconds : String?
 *				gen-classes : GenClasses?
 *					remote-impl : String?
 *					local-impl : String?
 *					remote-home-impl : String?
 *					local-home-impl : String?
 *				bean-pool : BeanPool?
 ...
 *				session : Session?
 *					checkpoint-location : String?
 *					quick-checkpoint : String?
 *					checkpointed-methods : CheckpointedMethods?
 *						description : String?
 *						method : Method[1,n]
 *							description : String?
 *							method-intf : String?
 ...
 *								method-param : String[0,n]
 *			pm-descriptors : PmDescriptors?
 *				pm-descriptor : PmDescriptor[1,n]
 ...
 *					pm-identifier : String
 *					pm-version : String
 *			cmp-resource : CmpResource?
 *				jndi-name : String
 *				default-resource-principal : DefaultResourcePrincipal?
 *					name : String
 *					password : String
 *				property : PropertyElement[0,n]
 *					name : String
 *					value : String
 *				create-tables-at-deploy : String?
 *				drop-tables-at-undeploy : String?
 *				database-vendor-name : String?
 *				schema-generator-properties : SchemaGeneratorProperties?
 *					property : PropertyElement[0,n]
 *						name : String
 *						value : String
...
public class SunEjbJar extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	public SunEjbJar() throws org.netbeans.modules.schema2beans.Schema2BeansException {
		this(null, Common.USE_DEFAULT_VALUES);
	}

	public SunEjbJar(org.w3c.dom.Node doc, int options) throws org.netbeans.modules.schema2beans.Schema2BeansException {
	...
	//
	public static SunEjbJar createGraph(org.w3c.dom.Node doc) throws org.netbeans.modules.schema2beans.Schema2BeansException {
		return new SunEjbJar(doc, Common.NO_DEFAULT_VALUES);
	}

	public static SunEjbJar createGraph(java.io.InputStream in) throws org.netbeans.modules.schema2beans.Schema2BeansException {
		return createGraph(in, false);
	}

	public static SunEjbJar createGraph(java.io.InputStream in, boolean validate) throws org.netbeans.modules.schema2beans.Schema2BeansException {
