/**
 *	This generated bean class CheckpointAtEndOfMethod matches the schema element checkpoint-at-end-of-method
 *
...
public class CheckpointAtEndOfMethod extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	public CheckpointAtEndOfMethod() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public CheckpointAtEndOfMethod(int options)
	{
	...
	public String dumpBeanNode(){
		...
		str.append("CheckpointAtEndOfMethod\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
