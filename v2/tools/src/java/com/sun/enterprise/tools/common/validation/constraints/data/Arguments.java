...
/**
 *	This generated bean class Arguments matches the schema element arguments
 *
...
public class Arguments extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizeArgument(); ++_index) {
			com.sun.enterprise.tools.common.validation.constraints.data.Argument element = getArgument(_index);
			if (element != null) {
				element.validate();
			}
		}
