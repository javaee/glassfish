...
/**
 *	This generated bean class ServiceQname matches the schema element service-qname
 *
...
public class ServiceQname extends com.sun.enterprise.tools.common.dd.SunBaseBean
{

	static Vector comparators = new Vector();

	static public final String NAMESPACEURI = "NamespaceURI";	// NOI18N
	static public final String LOCALPART = "Localpart";	// NOI18N

	public ServiceQname() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public ServiceQname(int options)
	{
		super(comparators, new org.netbeans.modules.schema2beans.Version(1, 2, 0));
		// Properties (see root bean comments for the bean graph)
		this.createProperty("namespaceURI", 	// NOI18N
			NAMESPACEURI, 
			Common.TYPE_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			String.class);
		this.createProperty("localpart", 	// NOI18N
			LOCALPART, 
			Common.TYPE_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			String.class);
	...
	public void setNamespaceURI(String value) {
		this.setValue(NAMESPACEURI, value);
	}

	//
	public String getNamespaceURI() {
		return (String)this.getValue(NAMESPACEURI);
	}

	// This attribute is mandatory
	public void setLocalpart(String value) {
		this.setValue(LOCALPART, value);
	}

	//
	public String getLocalpart() {
		return (String)this.getValue(LOCALPART);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property namespaceURI
		if (getNamespaceURI() == null) {
			throw new org.netbeans.modules.schema2beans.ValidateException("getNamespaceURI() == null", "namespaceURI", this);	// NOI18N
		}
		// Validating property localpart
		if (getLocalpart() == null) {
			throw new org.netbeans.modules.schema2beans.ValidateException("getLocalpart() == null", "localpart", this);	// NOI18N
		}
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("NamespaceURI");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		s = this.getNamespaceURI();
		str.append((s==null?"null":s.trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(NAMESPACEURI, 0, str, indent);

		str.append(indent);
		str.append("Localpart");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		s = this.getLocalpart();
		str.append((s==null?"null":s.trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(LOCALPART, 0, str, indent);

	}
	public String dumpBeanNode(){
		StringBuffer str = new StringBuffer();
		str.append("ServiceQname\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
