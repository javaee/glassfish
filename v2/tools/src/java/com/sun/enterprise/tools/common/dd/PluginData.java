...
/**
 *	This generated bean class PluginData matches the schema element plugin-data
 *
...
public class PluginData extends com.sun.enterprise.tools.common.dd.SunBaseBean
{
	...
	static public final String AUTO_GENERATE_SQL = "AutoGenerateSql";	// NOI18N
	static public final String CLIENT_JAR_PATH = "ClientJarPath";	// NOI18N
	static public final String CLIENT_ARGS = "ClientArgs";	// NOI18N
	...
	public void setAutoGenerateSql(String value) {
		this.setValue(AUTO_GENERATE_SQL, value);
	}

	//
	public String getAutoGenerateSql() {
		return (String)this.getValue(AUTO_GENERATE_SQL);
	}

	// This attribute is optional
	public void setClientJarPath(String value) {
	...
	// This attribute is optional
	public void setClientArgs(String value) {
