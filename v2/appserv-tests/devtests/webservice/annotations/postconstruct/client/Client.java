...
public class Client {
        ...
        @WebServiceRef(wsdlLocation="http://localhost:8080/postconstruct/webservice/HelloService?WSDL")
       ...
       public void doTest(String[] args) {
		    ...
		    if(ret.indexOf("postconstruct called") == -1) {
                        System.out.println("Postconstruct not called : " + ret);
                        stat.addStatus(args[0], stat.FAIL);
                        return;
		    }
