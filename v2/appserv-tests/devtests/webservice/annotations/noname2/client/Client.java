...
public class Client {
        ...
        @WebServiceRef(wsdlLocation="http://localhost:8080/Hello2/HelloService?WSDL")
       ...
       public void doTest(String[] args) {
		    ...
		    if(ret.indexOf("WebSvcTest-Hello") == -1) {
                        ...
                        stat.addStatus("Annotation-overrides-SvcName", stat.FAIL);
                        return;
		    }
                    System.out.println(ret);
                }
                stat.addStatus("Annotation-overrides-SvcName", stat.PASS);
            } catch(Exception e) {
                e.printStackTrace();
                stat.addStatus("Annotation-overrides-SvcName", stat.FAIL);
            }
