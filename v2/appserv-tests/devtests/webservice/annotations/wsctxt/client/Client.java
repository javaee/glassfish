...
public class Client {
	    ...
	    stat.addDescription("webservices-wsctxt");
            Client client = new Client();
            client.doTest(args);
	    stat.printSummary("webservices-wsctxt");
       }
       ...
       public void doTest(String[] args) {
		    ...
		    if(ret.indexOf("WebSvcTest-Hello") == -1) {
                        ...
                        stat.addStatus("Simple-wsctxt", stat.FAIL);
                        return;
		    }
                    System.out.println(ret);
                }
                stat.addStatus("Simple-wsctxt", stat.PASS);
            } catch(Exception e) {
                e.printStackTrace();
                stat.addStatus("Simple-wsctxt", stat.FAIL);
            }
