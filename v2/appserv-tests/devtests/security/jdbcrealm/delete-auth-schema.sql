...
DROP TABLE USER_TABLE_MD2;
DROP TABLE USER_TABLE_MD5;
DROP TABLE USER_TABLE_SHA;
DROP TABLE USER_TABLE_SHA256;
DROP TABLE USER_TABLE_SHA384;
DROP TABLE USER_TABLE_SHA512;
