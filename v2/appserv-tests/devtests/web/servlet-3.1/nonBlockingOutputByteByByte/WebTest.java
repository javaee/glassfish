...
/*
 * Unit test for Non blocking Write byte by byte
 */
public class WebTest {

    private static String TEST_NAME = "non-blocking-output-byte-by-byte";
    ...
    public static void main(String[] args) {
        ...
        stat.addDescription("Unit test for non blocking output byte by byte");
