...
public class ClassFileBuilderFactoryFactory {

    private static ClassFileBuilderFactory _factory;

    private static final String FACTORY_CLASS_NAME_PROPERTY
        = "com.sun.persistence.enhancer.classfile.builder.factory";

    private static final String DEFAULT_FACTORY_CLASS_NAME
        = "com.sun.org.apache.jdo.impl.enhancer.jdo.asm.ClassFileBuilderFactoryImpl";

    public static synchronized ClassFileBuilderFactory getClassFileBuilderFactory()
            ...
            InstantiationException
    {
        if (_factory == null) {
            ...
            _factory = (ClassFileBuilderFactory) Class.forName(className)
                    .newInstance();
        }
