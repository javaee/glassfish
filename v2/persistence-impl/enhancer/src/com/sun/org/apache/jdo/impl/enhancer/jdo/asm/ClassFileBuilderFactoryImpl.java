...
public class ClassFileBuilderFactoryImpl
    implements ClassFileBuilderFactory
{
    public ClassFileBuilder createClassFileBuilder(ClassInfo classInfo,
            ClassFileAnalyzer analyzer) {
        
        return new ClassFileBuilderImpl(classInfo, analyzer);
    }
}
