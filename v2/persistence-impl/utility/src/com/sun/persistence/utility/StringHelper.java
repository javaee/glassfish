...
/**
 * NOTE: These utilities have been moved from another (more specific package's)
 * utility class so that more classes can have access to them. There can be some
 * refactoring work to combine these with some of the methods in the
 * StringScanner class.
 */
...
public class StringHelper {
    ...
    /**
     * Convert an array of objects into a separated string.  This method assumes
     * there is no instance of the separator in the strings of list.
     ...
     * separator.  This method assumes there is no instance of the separator in
     * the strings of list.
     * @param list The list of objects to be expanded.
     * @param beginIndex The index of the first element in the list to be used.
     * @param endIndex The index of the last element in the list to be used.
     ...
     * separator and the entire array.  This method assumes there is no instance
     * of the separator in the strings of list.
     * @param list The list of objects to be expanded.
     * @param separator The separator to be used between strings.
     * @return a string representing the expanded list.
     */
    public static String arrayToSeparatedList(List list, String separator) {
        return arrayToSeparatedList(
                list, 0, ((list != null) ? (list.size() - 1) : 0), separator);
    }
    ...
    public static String arrayToSeparatedList(List list) {
        return arrayToSeparatedList(
                list, 0, ((list != null) ? (list.size() - 1) : 0));
    }
    ...
    public static String intArrayToSeparatedList(int[] intArray,
            String separator) {
        return intArrayToSeparatedList(
                intArray, 0, ((intArray != null) ? (intArray.length - 1) : 0),
                separator);
    }
     ...
     * Convert an array of int values into a separated string.
     * @param intArray The array of int values to be expanded.
     * @param beginIndex The index of the first element in the array to be
     * used.
     ...
     */
    public static String intArrayToSeparatedList(int[] intArray,
            int beginIndex, int endIndex, String separator) {
        StringBuffer result = new StringBuffer();
     ...
     * This can be used to convert a field name to get and set method names.
    ...
    /**
     * Replaces the first occurence of <code>oldString</code> in
     * <code>string</code> with <code>newString</code>. The methods returns
     * either a new string instance (in the case <code>oldString</code> is
     * included in the string) or the origial string itself (in the case
     * <code>oldString</code> is not included).
