 ...
 * jdo components.  It extends a java.util.logging.Logger which does the actual
 * logging.
...
public class LoggerJDK14 extends java.util.logging.Logger implements Logger {
    ...
    /**
     * Creates new LoggerJDK14.  The Thread context class loader or the loader
     ...
     * have to include the JDK 1.4 java.util.logging.Level class.
    ...
    public void fine(String msg, Object o1, Object o2) {
        if (isLoggable(Level.FINE)) {
            inferCaller();
            logp(
                    Level.FINE, sourceClassName, sourceMethodName, msg,
                    new Object[]{o1, o2});
        }
    }
    ...
    public void finer(String msg, Object o1, Object o2) {
        if (isLoggable(Level.FINER)) {
            inferCaller();
            logp(
                    Level.FINER, sourceClassName, sourceMethodName, msg,
                    new Object[]{o1, o2});
        }
    }
    ...
    public void finest(String msg, Object o1, Object o2) {
        if (isLoggable(Level.FINEST)) {
            inferCaller();
            logp(
                    Level.FINEST, sourceClassName, sourceMethodName, msg,
                    new Object[]{o1, o2});
        }
    }
    ...
    public String toString() {
        ...
        buf.append(", logging level: "); //NOI18N
        buf.append(getLevel());
        return buf.toString();
    }
    ...
    public void log(int level, String msg, Object o1, Object o2) {
        ...
        if (isLoggable(lvl)) {
            inferCaller();
            logp(
                    lvl, sourceClassName, sourceMethodName, msg,
                    new Object[]{o1, o2});
        }
    }
    ...
    /**
     * Convert an int level used by jdo logger to the Level instance used by JDK
     * 1.4 logger. This is done to allow components to use logging outside the
     * JDK 1.4 environment.
    ...
    /**
     * Method to infer the caller's class name and method name. The method
     * analyses the current stack trace, to find the method that issued the
     * logger call. It stores the callers class and method name into fields
     * sourceClassName and sourceMethodName.
     */
     ...
     * <code>true</code> if the specified class name denotes a logger class that
     * should be ignored when analysing the stack trace to infer the caller of a
     * log message.
    ...
    protected boolean isLoggerClass(String className) {
        return "com.sun.persistence.utility.logging.LoggerJDK14". //NOI18N
                equals(className);
    }
}
