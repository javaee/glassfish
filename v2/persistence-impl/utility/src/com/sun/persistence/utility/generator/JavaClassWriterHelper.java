...
public class JavaClassWriterHelper extends JavaTypeHelper {
    ...
    private final static String[] indentation_ = new String[]{"    ", // NOI18N
                                                              "        ", // NOI18N
                                                              "            ", // NOI18N
                                                              "                "}; // NOI18N
    ...
    /**
     * Returns java Object wrapper Class corresponding to the primitive Class if
     * the passed class represents a primitive. If the parameter is of Object
     * type, it is returned.
     ...
     * @return A String containing the expression for wrapping the primitive
     *         datatype in its corresponding wrapperclass
     */
     ...
     * of the wrapper class. example: boolean.class is mapped to
     * "booleanValue()".
     * @param primitiveType the class object of the primitive type.
     * @return the name of the method to access the primitive value of the
     *         wrapper
     */
    ...
    /**
     * Returns name of the primitive type corresponding to the Object wrapper
     * Class passed as a parameter. If the parameter is of primitive type, its
     * name is returned.
     * @param cls the Object wrapper Class to find name of the primitive type
     * for.
    ...
    /**
     * Returns list of method parameter types in format <code>type0[,type1[,...]]</code>
    ...
    /**
     * Returns list of method parameters in format <code>param0[,
     * param1[,...]]</code>
     * @param m the Method to identify list of method parameters for.
     ...
     */
    public static void addFields(String prop, int modifiers,
            JavaClassWriter writer) throws IOException {
     ...
     * @throws IOException if writer fails to add a field.
     */
    public static void addPrivateField(String prop, int modifiers,
            JavaClassWriter writer) throws IOException {
     ...
     * @throws IOException if writer fails to add a field.
     */
    public static void addGenericMethod(String mname, String[] body,
            JavaClassWriter writer) throws IOException {
        addGenericMethod(mname, void_, body, writer);
    }

    /**
     * Adds a private no-args method to a class with this method body and return
     * type.
     * @param mname method name
    ...
    public static void addGenericMethod(String mname, String type,
            String[] body, JavaClassWriter writer) throws IOException {
        addGenericMethod(mname, Modifier.PRIVATE, type, body, writer);
    }

    /**
     * Adds a private void no-args method to a class with this method body and
     * modifiers.
     * @param mname method name
     ...
     */
    public static void addGenericMethod(String mname, int modifiers,
            String type, String[] body, JavaClassWriter writer)
            throws IOException {
        writer.addMethod(
                mname, // name
                modifiers, // modifiers
     ...
     * @param mname method name if different from Method#getName(). This will be
     * true for finder/selector/create methods.
     * @param type return type of the method, that can differ from the bean's
     * local or remote interface.
     * @param body String to use for method body generation.
     * @param JavaClassWriter the Class writer.
     * @throws IOException if writer fails to add a field.
     */
    public static void addGenericMethod(Method m, String mname, String mtype,
            String body, JavaClassWriter writer) throws IOException {
    ...
    /**
     * Returns the String representation of the specified class instance. An
     * array is represented as the name of the element type followed by [].
     */
