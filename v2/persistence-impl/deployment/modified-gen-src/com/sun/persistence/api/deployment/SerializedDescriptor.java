...
@XmlType(name = "serialized", namespace = "http://java.sun.com/xml/ns/persistence_ORM")
public class SerializedDescriptor
    extends BasicDescriptor
{
    ...
    @Override public void accept(Visitor v) throws DeploymentException {
        v.visitSerializedDescriptor(this);
    }
}
