...
@XmlType(name = "embedded-id", namespace = "http://java.sun.com/xml/ns/persistence_ORM")
public class EmbeddedIdDescriptor
    extends DescriptorNode
{
    ...
    public void accept(Visitor v) throws DeploymentException {
        v.visitEmbeddedIdDescriptor(this);
    }
