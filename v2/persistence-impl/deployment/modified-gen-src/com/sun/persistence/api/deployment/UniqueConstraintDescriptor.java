...
@XmlType(name = "unique-constraint", namespace = "http://java.sun.com/xml/ns/persistence_ORM")
public class UniqueConstraintDescriptor
    extends DescriptorNode
{

    @XmlElement(defaultValue = "false", name = "primary", namespace = "http://java.sun.com/xml/ns/persistence_ORM", type = Boolean.class)
    protected Boolean primary;
    @XmlElement(name = "column-name", namespace = "http://java.sun.com/xml/ns/persistence_ORM", type = String.class)
    ...
    protected List<String> _getColumnName() {
        if (columnName == null) {
    ...
    public void accept(Visitor v) throws DeploymentException {
        v.visitUniqueConstraintDescriptor(this);
    }
}
