...
@XmlType(name = "sequence-generator", namespace = "http://java.sun.com/xml/ns/persistence_ORM")
    ...
    extends DescriptorNode
{
    ...
    @XmlElement(defaultValue = "", name = "sequence-name", namespace = "http://java.sun.com/xml/ns/persistence_ORM", type = String.class)
    protected String sequenceName;
    @XmlElement(defaultValue = "0", name = "initial-value", namespace = "http://java.sun.com/xml/ns/persistence_ORM", type = Integer.class)
    ...
    SequenceGeneratorDescriptor() {
    }

    public void accept(Visitor v) throws DeploymentException {
        v.visitSequenceGeneratorDescriptor(this);
    }
