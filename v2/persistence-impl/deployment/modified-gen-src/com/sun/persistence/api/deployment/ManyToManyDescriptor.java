...
@XmlType(name = "many-to-many", namespace = "http://java.sun.com/xml/ns/persistence_ORM")
public class ManyToManyDescriptor
    extends OneToManyDescriptor
{

    @XmlElement(defaultValue = "false", name = "is-inverse", namespace = "http://java.sun.com/xml/ns/persistence_ORM", type = Boolean.class)
    ...
    public void accept(Visitor v) throws DeploymentException {
        v.visitManyToManyDescriptor(this);
    }
