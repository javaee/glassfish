...
public interface ConfigBeanInterceptor {
      ...
      /**
           ...
           */
      Object postGetValue(ConfigBean cb, String name, Object res);
 
        String postGetAttributeValue(String name, String res);
        
        
        Object[] postGetValues(String name, Object[] res);
        
        Object preClone();
        
       void postClone(Object o);
       
       boolean isResolvingPaths();
       void setResolvingPaths(boolean resolve);
