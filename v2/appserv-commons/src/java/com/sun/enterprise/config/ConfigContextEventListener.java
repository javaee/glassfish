...
public interface ConfigContextEventListener extends EventListener {
    ...
    void preChangeNotification(ConfigContextEvent ccce);
    ...
    void postChangeNotification(ConfigContextEvent ccce);
    ...
    void preAccessNotification(ConfigContextEvent ccce);
    ...
    void postAccessNotification(ConfigContextEvent ccce);
