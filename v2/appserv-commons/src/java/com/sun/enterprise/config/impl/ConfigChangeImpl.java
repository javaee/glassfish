 ...
 */
public abstract class ConfigChangeImpl implements com.sun.enterprise.config.ConfigChange, Serializable {

    protected String xpath = null; // depends on which on is needed
    protected String parentXpath = null;
    
    /* used for checking for changes */
    ...
    /**
     * currently makes sense only for add.
