...
/**
 * <BR> <I>$Source: /cvs/glassfish/appserv-commons/src/java/com/sun/enterprise/util/collection/SynchronizedDListNode.java,v $</I>
...
public class SynchronizedDListNode
    extends DListNode
{
    ...
    public void insertBefore(DListNode node) {
    	synchronized (prev) {
    		synchronized (this) {
    			node.prev = prev;
    			node.next = this;
