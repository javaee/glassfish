...
/*
 * Filename: TimedoutException.java	
 *
...
/**
 * <BR> <I>$Source: /cvs/glassfish/appserv-commons/src/java/com/sun/enterprise/util/pool/InvalidPoolObjectException.java,v $</I>
...
public class InvalidPoolObjectException
    extends PoolException
{
    ...
    public InvalidPoolObjectException(String message, Throwable throwable) {
