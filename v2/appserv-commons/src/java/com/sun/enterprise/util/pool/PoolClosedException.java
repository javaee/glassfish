...
/*
 * Filename: PoolClosedException.java	
 *
...
/**
 * <BR> <I>$Source: /cvs/glassfish/appserv-commons/src/java/com/sun/enterprise/util/pool/PoolClosedException.java,v $</I>
...
public class PoolClosedException
    extends PoolException
{
    ...
    public PoolClosedException(String message, Throwable throwable) {
