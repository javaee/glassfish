...
/*
 * Filename: QueueClosedException.java	
 *
...
/**
 * <BR> <I>$Source: /cvs/glassfish/appserv-commons/src/java/com/sun/enterprise/util/collection/QueueClosedException.java,v $</I>
    ...
    extends QueueException
{
    ...
    public QueueClosedException(String message, Throwable throwable) {
        super(message);
