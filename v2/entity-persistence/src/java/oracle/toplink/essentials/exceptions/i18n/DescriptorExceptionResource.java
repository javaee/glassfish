...
public class DescriptorExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "55", "The descriptor callback method [{0}] cannot be found.  It must take a DescriptorEvent as its argument." },
    ...
    { "118", "The object [{0}] must not have read-only mappings to its write lock fields." },
                                           ...
                                           { "138", "The attribute [{0}] is not declared as a superclass of [{1}], but the mapping uses transparent indirection." },
                                           { "139", "The get method for the attribute [{0}] does not return a superclass of [{1}], but the mapping uses transparent indirection." },
                                           { "140", "The set method for the attribute [{0}] does not take a superclass of [{1}] as its parameter, but the mapping uses transparent indirection." },
                                           ...
                                           { "150", "The mapping for the attribute [{0}] uses transparent indirection so the attribute [{0}] must be initialized to an appropriate container.  Currently the value is [{1}]. {2} - JDK 1.1.x: an instance of IndirectList, IndirectMap or Hashtable, or one of their subclasses. {2} - JDK 1.2 or higher: an instance of an implementor of Collection or Map." },
                                           ...
                                           { "165", "This descriptor''s amendment method triggered an exception." },
