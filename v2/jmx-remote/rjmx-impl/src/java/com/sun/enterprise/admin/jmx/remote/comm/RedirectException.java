 ...
 * Created on February 16, 2007, 7:13 PM
 */
...
/**
 * This class holds the redirect URL this HTTP JMX Connector client
 * receives when it tries to connect to http server with mismatching 
 * protocol/port/both on admin-listener.
 */
public class RedirectException extends IOException {
    
    private String redirectURL;
    private static final Logger logger = 
        Logger.getLogger(RedirectException.class.getName());
