...
/*
 * This is the native toolkit for Windows.
 */
#include <stdio.h>
#include <stdlib.h>
#include <Windows.h>
...
JNIEXPORT jlong JNICALL Java_com_sun_enterprise_ee_selfmanagement_mbeans_DiskToolkit_getPartitionFreeSpace
  (JNIEnv *env, jobject obj, jstring partitionNameString)
{
        jboolean iscopy;
        ...
        unsigned __int64 totalFreeBytes = 0;
        status = GetDiskFreeSpaceEx(str,
