 ...
 * This class processes failure notifications from GMS
 *
 */
 ...
 * @author lwhite
 */
public class FailureNotificationEventHandler implements CallBack {
    
    private static final Logger _logger = LogDomains.getLogger(LogDomains.WEB_LOGGER);    
    
    /** Creates a new instance of FailureNotificationEventHandler */
    public FailureNotificationEventHandler() {
    }
    
    public void processNotification(Signal notification) {
        String failedPartnerInstance = notification.getMemberToken();
        if (_logger.isLoggable(Level.FINEST)) {
            _logger.finest("Received Failure Notification: " + failedPartnerInstance);
        }         
        //was this
        ...
        if(!ReplicationHealthChecker.isStopping()) {            
            ...
            System.out.println("failure notification causing call to respondToFailure");
