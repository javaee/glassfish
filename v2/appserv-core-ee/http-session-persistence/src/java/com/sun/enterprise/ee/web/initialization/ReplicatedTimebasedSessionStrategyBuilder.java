 ...
 */
/*
 * ReplicatedTimebasedSessionStrategyBuilder.java
 *
 * Created on November 9, 2006, 3:21 PM
 *
 */
 ...
 * @author lwhite
 */
public class ReplicatedTimebasedSessionStrategyBuilder extends BasePersistenceStrategyBuilder 
        implements PersistenceStrategyBuilder {
    
    /** Creates a new instance of ReplicatedTimebasedSessionStrategyBuilder */
    public ReplicatedTimebasedSessionStrategyBuilder() {
    }
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN ReplicatedTimebasedSessionStrategyBuilder");
