 ...
 */
/*
 * ReplicatedWebmethodSessionStrategyBuilder.java
 *
 * Created on November 17, 2005, 2:12 PM
 *
 */
 ...
 * @author Larry White
 */
public class ReplicatedWebmethodSessionStrategyBuilder extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    
    final static String MODE_WEB = ReplicationState.MODE_WEB;
    
    /** Creates a new instance of ReplicatedWebmethodSessionStrategyBuilder */
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        if(_logger.isLoggable(Level.FINEST)) {        
            _logger.finest("IN ReplicatedWebmethodSessionStrategyBuilder");
        }
        System.out.println("IN ReplicatedWebmethodSessionStrategyBuilder NEW");
