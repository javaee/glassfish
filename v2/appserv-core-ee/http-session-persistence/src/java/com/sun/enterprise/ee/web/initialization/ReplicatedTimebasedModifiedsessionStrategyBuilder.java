...
/*
/*
 * ReplicatedTimebasedModifiedsessionStrategyBuilder.java
 *
 * Created on November 9, 2006, 4:27 PM
 *
 */
 ...
 * @author lwhite
 */
public class ReplicatedTimebasedModifiedsessionStrategyBuilder 
        extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    
    /** Creates a new instance of ReplicatedTimebasedModifiedsessionStrategyBuilder */
    public ReplicatedTimebasedModifiedsessionStrategyBuilder() {
    }
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN ReplicatedTimebasedModifiedsessionStrategyBuilder");
