...
/*
 * HaOndemandModifiedsessionStrategyBuilder.java
 *
...
public class HaOndemandModifiedsessionStrategyBuilder extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    ...
    /** Creates a new instance of HaOndemandModifiedsessionStrategyBuilder */
    public HaOndemandModifiedsessionStrategyBuilder() {
    }   
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN HaOndemandModifiedsessionStrategyBuilder");
