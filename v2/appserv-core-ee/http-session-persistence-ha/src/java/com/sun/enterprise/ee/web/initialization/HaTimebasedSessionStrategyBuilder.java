...
/*
 * HaTimebasedSessionStrategyBuilder.java
 *
 * Created on September 30, 2002, 1:55 PM
 */
 ...
 * @author  lwhite
 */
public class HaTimebasedSessionStrategyBuilder extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    
    /** Creates a new instance of HaTimebasedSessionStrategyBuilder */
    public HaTimebasedSessionStrategyBuilder() {
    }
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN HaTimebasedSessionStrategyBuilder");
