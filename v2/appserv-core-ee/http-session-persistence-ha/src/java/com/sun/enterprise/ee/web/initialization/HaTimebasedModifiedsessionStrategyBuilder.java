...
/*
 * HaTimebasedModifiedsessionStrategyBuilder.java
 *
 * Created on October 4, 2002, 11:10 AM
 */
 ...
 * @author  lwhite
 */
public class HaTimebasedModifiedsessionStrategyBuilder extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    
    /** Creates a new instance of HaTimebasedModifiedsessionStrategyBuilder */
    public HaTimebasedModifiedsessionStrategyBuilder() {
    }
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN HaTimebasedModifiedsessionStrategyBuilder");
