...
/*
 * HaOndemandSessionStrategyBuilder.java
 *
 ...
 */
public class HaOndemandSessionStrategyBuilder extends BasePersistenceStrategyBuilder implements PersistenceStrategyBuilder {
    
    /** Creates a new instance of HaOndemandSessionStrategyBuilder */
    public HaOndemandSessionStrategyBuilder() {
    }
    ...
    public void initializePersistenceStrategy(Context ctx, SessionManager smBean) {
        ...
        _logger.finest("IN HaOndemandSessionStrategyBuilder");
