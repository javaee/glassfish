...
public class EETargetType extends TargetType {
    ...
    public static final TargetType NODEAGENT = new TargetType("nodeagent");
    public static final TargetType CLUSTER = new TargetType("cluster");
    public static final TargetType DOMAIN = new TargetType("domain");
    
    
    public EETargetType(String type) {
        super(type);
    }
}
