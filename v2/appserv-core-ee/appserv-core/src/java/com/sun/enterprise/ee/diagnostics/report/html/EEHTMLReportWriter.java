 ...
 */
public class EEHTMLReportWriter extends HTMLReportWriter {

        /** Creates a new instance of EEHTMLReportWriter */
    public EEHTMLReportWriter(ReportConfig config) {
        super(config);
    }

    protected void setTemplate(Data dataObj) {
         template = new EEHTMLReportTemplate(config, dataObj);
    }
