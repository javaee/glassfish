...
/**
 * Interface ThreadHangActionMBean
 * ThreadHangAction Description
 * @author Pankaj Jairath
 */
public interface ThreadHangActionMBean
{
   /**
    ...
    */
    public void setThresholdWait(long value);
    ...
    /**
     * Get the application ref of the mail alert
     */
     ...
     * Set MailAlertAppRef
     */
    public void setMailAlertAppRef(String refName);
