...
/*
 * $Id: EETargetBuilder.java,v 1.1.1.1 2006/08/08 19:48:22 dpatil Exp $
 */
    ...
    implements IAdminConstants
{
    ...
    {        
        //The default target is "server", the DAS, the same as it is in PE. 
        return  super.getDefaultTarget(cc);
    }

    protected TargetType[] getDefaultValidTargets()
    {
        //All targets are valid for SE/EE
        return null;
    }
}
