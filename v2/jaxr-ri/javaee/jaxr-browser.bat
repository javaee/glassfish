...
set CLASSPATH=%JAXR_LIB%\jaxb-api.jar;%JAXR_LIB%\jaxb-impl.jar;%JAXR_LIB%\jaxb-libs.jar;%JAXR_LIB%\jaxb-xjc.jar;%JAXR_LIB%\relaxngDatatype.jar;%JAXR_LIB%\xsdlib.jar;%JAXR_LIB%\xercesImpl.jar;%JAXR_LIB%\jaxr-api.jar;%JAXR_LIB%\mail.jar;%JAXR_LIB\activation.jar;%JAXR_LIB%\jaxr-impl.jar;$JAXR_HOME/../lib/jaxb-api.jar:$JAXR_HOME/../lib/jaxb-impl.jar:$JAXR_LIB/FastInfoset.jar:$JAXR_LIB/jaxb-libs.jar:$JAXR_LIB/jaxb-xjc.jar:$JAXR_LIB/relaxngDatatype.jar:$JAXR_LIB/xsdlib.jar:$jaxP_HOME/xercesImpl.jar:$JAXR_LIB/jaxr-api.jar:$JAXR_LIB/lib/mail.jar:$JAXR_LIB/activation.jar:$JAXR_LIB/jsse.jar:$JAXR_LIB/jaas.jar:$JAXR_LIB/jaxr-impl.jar:$JAXR_LIB/saaj-api.jar:$JAXR_LIB/saaj-impl.jar:$JAXR_LIB/jaxp-api.jar:$JAXR_LIB/dom.jar:$JAXR_LIB/sax.jar:$JAXR_LIB/dom.jar:$JAXR_HOME/samples/jaxr-browser/jaxr-browser.jar;%JAXR_LIB%\saaj-api.jar;%JAXR_LIB%\saaj-impl.jar;%JAXR_LIB%\jaxp-api.jar;%JAXR_LIB%\dom.jar;%JAXR_LIB%\sax.jar;%JAXR_HOME%\samples\jaxr-browser\jaxr-browser.jar
