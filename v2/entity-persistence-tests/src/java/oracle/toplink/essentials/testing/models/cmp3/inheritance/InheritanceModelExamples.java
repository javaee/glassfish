...
//        example.addPartNumber("101101MP-d");
    ...
    public static Company companyExample3() {
        ...
        example.setName("XYZ");
        example.setVehicles(vehicle);
        Engineer engineer = personExample7();
        engineer.setCompany(example);
        
        Desktop desktop = new Desktop();
        ComputerPK desktopPK = new ComputerPK();
        desktopPK.setManufacturer("Apple");
        desktopPK.setSerialNumber(new Integer(202075));
        desktop.setComputerPK(desktopPK);
        
        ArrayList<Desktop> desktops = new ArrayList<Desktop>();
        desktops.add(desktop);
        engineer.setDesktops(desktops);
        
        Laptop laptop = new Laptop();
        ComputerPK laptopPK = new ComputerPK();
        laptopPK.setManufacturer("Apple");
        laptopPK.setSerialNumber(new Integer(570202));
        laptop.setComputerPK(laptopPK);
        
        ArrayList<Laptop> laptops = new ArrayList<Laptop>();
        laptops.add(laptop);
        engineer.setLaptops(laptops);
        
        HashSet engineers = new HashSet();
        engineers.add(engineer);
        example.setEngineers(engineers);
        return example;
    }
    ...
    public static Engineer personExample7() {
        Engineer example = new Engineer();
        example.setName("Lucky");
        example.setTitle("Design Engineer");
        return example;
    }
    ...
    // for test JUnitEJBQLInheritanceTestSuite#testJoinedInheritance to succeed
