 ...
 */
public interface HSServiceEventListener extends AdminEventListener {

    /**
     * Handles http-service element/attribute removal.
    ...
    /**
     * Handles http-service element/attribute modification.
     * It is called whenever a HSServiceEvent is received.
     *
     * @param event                        Event to be processed.
     *
    ...
    /**
     * Handles http-service element/attribute creation.
     * It is called whenever a HSServiceEvent is received.
     *
     * @param event                        Event to be processed.
     *
