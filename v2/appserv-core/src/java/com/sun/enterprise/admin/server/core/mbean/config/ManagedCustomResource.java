...
/**
    This Config MBean represents a Custom resource.
    ...
    ObjectName of this MBean is:
        ias: type=custom-resource, instance-name=<instance-name>, name=<resource-name>
*/
...
//ms1        kEnabled        + ", boolean,  RW" ,
    ...
    */
    public ManagedCustomResource() throws MBeanConfigException
    {
    ...
    */
    public ManagedCustomResource(String instanceName, String jndiName) throws MBeanConfigException
    {
        this();
