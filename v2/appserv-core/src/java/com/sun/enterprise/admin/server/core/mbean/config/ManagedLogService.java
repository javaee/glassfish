...
/**
    This Config MBean represents a Log Service.
    ...
    ObjectName of this MBean is:
        ias: type=log-service, instance-name=<instance-name>
*/
public class ManagedLogService extends ConfigMBeanBase implements ConfigAttributeName .LogService
{
    ...
    {
        {kLogFile              , ATTRIBUTE + ServerTags.FILE},
        {kUseSystemLogging     , ATTRIBUTE + ServerTags.USE_SYSTEM_LOGGING},
    };
    /** 
    ...
    */
    ...
    /**
        Constructs Config MBean for Log Service.
        @param instanceName The server instance name.
    */
    public ManagedLogService(String instanceName) throws MBeanConfigException
    {
        this(); //set description tables
        initialize(ObjectNames.kLogService, new String[]{instanceName});
    }
}
