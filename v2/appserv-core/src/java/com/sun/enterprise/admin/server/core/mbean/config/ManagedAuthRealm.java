...
/**
    This Config MBean represents a AuthRealm element.
    ...
    ObjectName of this MBean is:
        ias: type=auth-db, instance-name=<instance-name>, name=<AuthRealm-id>
*/
public class ManagedAuthRealm extends ConfigMBeanBase implements ConfigAttributeName.AuthRealm
{
    ...
    private static final String[][] MAPLIST  =
    {
        ...
        {kClassName     , ATTRIBUTE + ServerTags.CLASSNAME},
    };
    /** 
    ...
    */
    ...
    /**
        Constructs Config MBean for AuthRealm .
        @param instanceName The server instance name.
    */
    public ManagedAuthRealm(String instanceName, String authRealmId) throws MBeanConfigException
    {
        this();
        this.initialize(ObjectNames.kAuthRealmType, new String[]{instanceName, authRealmId});
    }
}