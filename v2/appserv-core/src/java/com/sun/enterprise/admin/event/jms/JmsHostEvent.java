...
/**
 * <pre>
 *      This event deals with jms-host config element, 
 *   its attributes and properties
 * </pre>
 *
 * @author: alexkrav
 */
public class JmsHostEvent extends ElementChangeEvent {

    /**
     * Event type
     */
    public static final String eventType =
                        JmsHostEvent.class.getName();


    /**
     * Create a new JmsHostEvent.
     *
     ...
     */
    public JmsHostEvent(String instance, int action, String id) {
