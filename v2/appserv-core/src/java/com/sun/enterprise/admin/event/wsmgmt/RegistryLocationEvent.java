...
/**
 * This event deals with registry-location
 * config element, its attributes and properties
 */
public class RegistryLocationEvent extends ElementChangeEvent {

    /** Event type */
    public static final String eventType =
                        RegistryLocationEvent.class.getName();

    /**
     * Create a new RegistryLocationEvent.
     *
     ...
     */
    public RegistryLocationEvent(String instance, int action, String id) {
