...
/**
 * This event deals with web-service-endpoint/transformation-rule 
 * config element, its attributes and properties
 */
public class TransformationRuleEvent extends ElementChangeEvent {

    /** Event type */
    public static final String eventType =
                        TransformationRuleEvent.class.getName();

    /**
     * Create a new TransformationRuleEvent.
     *
     ...
     */
    public TransformationRuleEvent(String instance, int action, String id) {
