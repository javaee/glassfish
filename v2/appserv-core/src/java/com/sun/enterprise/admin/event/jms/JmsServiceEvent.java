...
/**
 * <pre>
 *      This event deals with jms-service config element, 
 *   its attributes and properties
 * </pre>
 *
 * @author: alexkrav
 */
public class JmsServiceEvent extends ElementChangeEvent {

    /**
     * Event type
     */
    public static final String eventType =
                        JmsServiceEvent.class.getName();


    /**
     * Create a new JmsServiceEvent.
     *
     ...
     */
    public JmsServiceEvent(String instance, int action) {
