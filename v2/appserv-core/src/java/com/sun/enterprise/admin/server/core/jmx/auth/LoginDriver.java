...
public interface LoginDriver {
    ...
    /**
     * Login using the specified user, password to the realm. If login fails,
     * the method throws SecurityException.
     * @param user the remote user
     * @param password the password for remote user
     * @param realm the realm to authenticate against
     */
    Subject login(String user, String password, String realm);
}
