...
public interface WSMonitorLifeCycleProvider {
     ...
     * @param bd      BundleDescriptor for the module
     */
     void registerWebServiceEndpoints(String appId, BundleDescriptor bd);
     ...
     * @param bd      BundleDescriptor for the module
     */
     void unregisterWebServiceEndpoints(String appId, BundleDescriptor bd);
}
