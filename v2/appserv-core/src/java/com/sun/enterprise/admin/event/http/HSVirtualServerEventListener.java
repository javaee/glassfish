...
/**
 * Listener interface to handle HTTP service virtual server element events.
 *
...
public interface HSVirtualServerEventListener extends AdminEventListener {
    ...
    /**
     * Handles http-service/virtual-server element/attribute removal.
    ...
    /**
     * Handles http-service/virtual-server element/attribute modification.
     * It is called whenever a HSVirtualServerEvent is received.
     *
     * @param event                        Event to be processed.
     *
    ...
    /**
     * Handles http-service/virtual-server element/attribute additions.
     * It is called whenever a HSVirtualServerEvent is received.
     *
     * @param event                        Event to be processed.
     *
