...
/**
 * This event deals with web-service-endpoint config element, 
 * its attributes and properties
 */
public class WebServiceEndpointEvent extends ElementChangeEvent {

    /** Event type */
    public static final String eventType =
                        WebServiceEndpointEvent.class.getName();
