...
/**
 * <pre>
 *   This event deals with message-security-config element
 * </pre>
 *
 * @author: sreeni
 */
public class MessageSecurityConfigEvent extends ElementChangeEvent {
    ...
    public static final String eventType =
                        MessageSecurityConfigEvent.class.getName();

    /**
     * @param instance name of the instance to which the event applies
     * @param action type of action, create, delete, or update
     * @param id/primary key
     */
    public MessageSecurityConfigEvent(String instance, int action, String id) {
