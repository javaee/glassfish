 ...
 * holder.
 */
package com.sun.enterprise.admin.event.selfmanagement;

import com.sun.enterprise.admin.event.ElementChangeEvent;

/**
 * This event deals with management-rule element, 
 * its attributes and properties
 *
 * @author Pankaj Jairath
 */
public class ManagementRuleEvent extends ElementChangeEvent {

    /** Event type */
    public static final String eventType =
                        ManagementRuleEvent.class.getName();

    /**
     * Create a new ManagementRuleEvent.
     *
     ...
     */
    public ManagementRuleEvent(String instance, int action, String id) {
