...
public interface AvailabilityServiceEventListener extends AdminEventListener {
     ...
     * It is called whenever a AvailabilityServiceEvent is received.
     *
    ...
    /**
     * Handles availability-service element/attribute modification.
     * It is called whenever a AvailabilityServiceEvent is received.
     *
     * @param event  Event to be processed.
     *
    ...
    /**
     * Handles availability-service element/attribute addtions.
     * It is called whenever a AvailabilityServiceEvent is received.
     *
     * @param event Event to be processed.
     *
