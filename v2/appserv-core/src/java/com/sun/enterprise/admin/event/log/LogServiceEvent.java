...
/**
 * <pre>
 *      This event deals with log-service config element, 
...
public class LogServiceEvent extends ElementChangeEvent {
    ...
    public static final String eventType =
                        LogServiceEvent.class.getName();


    /**
     * Create a new LogServiceEvent.
     *
     ...
     */
    public LogServiceEvent(String instance, int action) {
