...
/**
 * It informs the changes  for transaction-service config element,
 * its creation/deletion and changes of its attributes and properties
 *
 * @author: Satish Viswanatham
 */
public class JTSEvent extends ElementChangeEvent {

    /**
     * Event type
     */
    public static final String eventType = JTSEvent.class.getName();
