...
public interface JTSEventListener extends AdminEventListener {
    ...
    /**
     * Handles transaction-service element/attribute removal.
     ...
     *         process the event.
     */
    public void handleDelete(JTSEvent event)
             throws AdminEventListenerException;

    /**
     * Handles transaction-service element/attribute modification.
     * It is called whenever a JTSEvent is received.
     *
     * @param event                        Event to be processed.
     *
     ...
     *         process the event.
     */
    public void handleUpdate(JTSEvent event)
             throws AdminEventListenerException;

    /**
     * Handles transaction-service element/attribute creation.
     * It is called whenever a JTSEvent is received.
     *
     * @param event                        Event to be processed.
     *
     ...
     *         process the event.
     */
    public void handleCreate(JTSEvent event)
             throws AdminEventListenerException;
