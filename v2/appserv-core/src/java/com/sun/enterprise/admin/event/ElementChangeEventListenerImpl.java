 ...
 */
public class  ElementChangeEventListenerImpl implements ElementChangeEventListener {
    ...
    {
       //String type = event.getElementType();
       int action = event.getActionType();
       System.out.println("ElementChangeEventListenerImpl.processEvent(): action="+action);
    }
}
