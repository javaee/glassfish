...
/**
    This Config MBean represents a Acl element.
    ...
    ObjectName of this MBean is:
        ias: type=Acl, instance-name=<instance-name>, name=<Acl-id>
*/
public class ManagedHTTPAcl extends ConfigMBeanBase implements ConfigAttributeName.Acl
{
    ...
    */
    ...
    /**
        Constructs Config MBean for Acl .
        @param instanceName The server instance name.
    */
    public ManagedHTTPAcl(String instanceName, String aclId) throws MBeanConfigException
    {
        this();
        initialize(ObjectNames.kAclType, new String[]{instanceName, aclId});
    }
}