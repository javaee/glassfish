 ...
 * events related to standalone J2EE module deployment (deployed, undeployed,
 * redeployed, enabled and disabled).
 */
public interface ModuleDeployEventListener extends AdminEventListener {
     ...
     */
    public void moduleDeployed(ModuleDeployEvent event)
     ...
     *         process the event.
     */
    public void moduleUndeployed(ModuleDeployEvent event)
             throws AdminEventListenerException;
     ...
     *         process the event.
     */
    public void moduleRedeployed(ModuleDeployEvent event)
             throws AdminEventListenerException;
     ...
     *         process the event.
     */
    public void moduleEnabled(ModuleDeployEvent event)
             throws AdminEventListenerException;
     ...
     *         process the event.
     */
    public void moduleDisabled(ModuleDeployEvent event)
             throws AdminEventListenerException;
