...
//ms1   kLogLevel                       + ",  String, RW",
 ...
 private static final String[]   OPERATIONS  = null;
    ...
    */
    ...
    public ManagedWebContainer(String instanceName) throws ConfigException, MBeanConfigException
    {
        this(); //set description tables
        initialize(ObjectNames.kWebContainer, new String[]{instanceName});
    }
