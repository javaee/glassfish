...
public interface HTMLReportConstants {
    ...
    // Diagnostic Report related
    //@todo move this entire file contents to LogStrings.properties
    
    public static final String report_heading = "SJS AS Diagnostic Report Summary";
    public static final String report_description = "This Snapshot was generated for {0} at " +
            "{1 , time} on {1, date}";
