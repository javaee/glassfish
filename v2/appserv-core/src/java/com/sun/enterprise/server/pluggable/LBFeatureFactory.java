...
/**
 * Interface for getting lb specific pluggable features.
 */
public interface LBFeatureFactory {
    public void applyChanges(String lbConfigName);
    public void applyChanges(String lbConfigName, String lbName);
    public boolean isApplyChangeRequired(String lbConfigName,String lbName);
    public String getLoadBalancerXML(String lbConfigName,String lbName);
    public LoadBalancerStatsInterface getLoadBalancerMonitoringStats(String lbConfigName,String lbName);
    /**
