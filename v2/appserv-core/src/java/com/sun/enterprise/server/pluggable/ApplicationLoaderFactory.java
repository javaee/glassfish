...
/** 
 * Support for pluggable loader features. This interface provides 
 * access to application loader objects that are pluggable amongst  
 * various editions of the product. 
 */
