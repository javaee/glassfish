...
/**
 * Build a servicegroup. This class defines the composition of 
 * the servicegroups in the appserver.
 * 
 * @author Binod PG
...
public class ServiceGroupBuilder {
     ...
     */
    public ServiceGroup buildServiceGroup(OnDemandServer server) {
