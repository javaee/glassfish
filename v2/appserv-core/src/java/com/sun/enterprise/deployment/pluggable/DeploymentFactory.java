...
/**
 * Provides access to different deployment implementation necessary to 
...
public interface DeploymentFactory {    
     ...
     *
     * @param  configContext config context object
     * @param  instanceName the name of the this instance
     */
    public DeployEventListenerHelper createDeployEventListenerHelper();

    /**
     * @return Returns the appropriate implementation for DeployemntTargetFactory
     */
