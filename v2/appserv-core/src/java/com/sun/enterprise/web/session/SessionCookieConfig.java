 ...
 *
 * NOTICE: THIS FILE HAS BEEN DEACTIVATED AND WILL BE REMOVED FROM CVS.
 *
 * IT HAS BEEN REPLACED BY THIS FILE:
 *
 * pwc-commons/src/java/com/sun/enterprise/web/session/SessionCookieConfig.java
 */
