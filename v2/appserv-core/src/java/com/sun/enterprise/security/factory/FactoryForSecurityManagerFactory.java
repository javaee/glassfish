...
/*
 * FactoryForSecurityManagerFactory.java
 *
...
public interface FactoryForSecurityManagerFactory {
    ...
    /** Returns the SecurityManagerFactory
     * @param type web/ejb Returns a web or ejb SecurityManagerFactory
     * @return SecurityManagerFactory - either WebSecurityManagerFactory or
