...
interface IReporterEnum
{
	// duplicates are for programmer convenience...
	static final int		OBJECT_DUMP	= 0;
	...
	static final int		ASSERT		= 6;
	static final int		DISABLED	= 1000;
	static final String		severityNames[]		= { "Dump", "Verbose", "Info", "Warning", "Error", "Critical Error", "Assertion" };//NOI18N
}