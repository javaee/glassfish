...
/**
 *  This class defines interfaces for connector admin functionality 
...
public interface ConnectorAdminService {
    ...
    /**
     *  Performs the creation  functionality for a specific admin service. 
    ...
    /**
     *  Performs the deletion  functionality for a specific admin service. 
     *  Ex. For connectorConnectionPool admin service, it deletes the pool.
     *  @throws ConnectorRuntimeException If deletion fails.    
     */
