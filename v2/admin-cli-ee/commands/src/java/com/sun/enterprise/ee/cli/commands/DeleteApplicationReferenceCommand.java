 ...
 */
public class DeleteApplicationReferenceCommand extends S1ASCommand
{
    ...
    {
        final String cascade = getOption(CASCADE_OPTION);                
        Properties props = new Properties();

        CLILogger.getInstance().printDebugMessage(DeploymentProperties.CASCADE);
        if (props != null) 
            props.put(DeploymentProperties.CASCADE, cascade);
