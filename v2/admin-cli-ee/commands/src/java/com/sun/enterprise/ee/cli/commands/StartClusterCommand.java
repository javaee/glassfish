...
public class StartClusterCommand extends GenericCommand {
    ...
    public void displayExceptionMessage(Exception e) throws CommandException
    {
        if (e instanceof MBeanException &&
            ((MBeanException)e).getTargetException().getClass().getName().equals(
                        "com.sun.enterprise.admin.WarningException"))
        {
            CLILogger.getInstance().printDetailMessage(((MBeanException)e).getTargetException().getLocalizedMessage()); 
        ...
        if (e.getLocalizedMessage() != null)
        {
            ...
            if (e instanceof MBeanException) {
                ...
                CLILogger.getInstance().printDebugMessage("Target Exception name = " + targetException.getClass().getName());
