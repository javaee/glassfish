...
public class ConfigureLBWeightCommand extends GenericCommand {

    private static final String CLUSTER_OPTION = "cluster";
    private static final StringManager _strMgr = 
        StringManager.getManager(ConfigureLBWeightCommand.class);
   ...
   /**
    ...
    {
        validateOptions();
        String clusterName = getOption(CLUSTER_OPTION);
    ...
    {
        Properties instanceWeightsProps = createPropertiesParam((String) getOperands().get(0));
