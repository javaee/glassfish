 ...
 */
public class ListApplicationReferenceCommand extends S1ASCommand
{
    /**
	...
	try
        {
            ...
            {
                throw new CommandException(getLocalizedString("CouldNotConnectToDAS"));
        ...
        catch (IOException ioe)
        {
            ...
            throw new CommandException(getLocalizedString(
                "CommandUnSuccessful", new Object[] {name} ), ioe);
        }
        catch (Exception e)
        {
            //e.printStackTrace();
    ...
    {
        Vector operandsList = getOperands();
