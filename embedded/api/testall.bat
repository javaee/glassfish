...
rem set CP=%CP%;glassfish-embedded-nucleus-10.0-SNAPSHOT.jar
rem set CP=%CP%;glassfish-embedded-web-10.0-SNAPSHOT.jar
set CP=%CP%;glassfish-embedded-all-10.0-SNAPSHOT.jar
