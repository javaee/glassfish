...
@GenerateServiceFromMethod(implementation=Constants.GENERATE_METHOD_CREATE_IMPL,
    advertisedContracts={Constants.GENERATE_METHOD_CREATE_IMPL,
        Constants.GENERATE_METHOD_CREATE_CONTRACT})
