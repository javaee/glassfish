 ...
 * Specialized web application class loader.
 ...
 public class WebappClassLoader
     ...
     implements Reloader, Lifecycle, InstrumentableClassLoader
  {
    ...
    // END PE 4985680
      ...
      */
     protected final HashSet<String> notFoundResources = new HashSet<String>();
      ...
      * application context.
      */
     private final HashMap<String,PermissionCollection> loaderPC = new HashMap<String,PermissionCollection>();
 ...
 // END OF IASRI 4657979
     ...
     protected void clearReferences() {
         ...
         for (Object o : ((HashMap) resourceEntries.clone()).values()) {
 ...
 // END OF IASRI 4717252
     ...
     protected ResourceEntry findResourceInternal(String name, String path) {
         ...
         if (entry != null) {
             return entry;
         } else if (notFoundResources.contains(name)) {
             return null;
         }
     ...
     protected boolean filter(String name) {
         ...
         if (overridablePackages != null){
             for (String overridablePackage : overridablePackages) {
                 if (packageName.startsWith(overridablePackage))
                     return false;
             }
         }
     ...
     private void purgeELBeanClasses() {
         for (Field fld : BeanELResolver.class.getDeclaredFields()) {
