...
//        implements MessageSecurityConfigEventListener {
//
//    /**
...
//     *         process the event.
//     */
//    public void handleDelete(MessageSecurityConfigEvent event)
...
//     *         process the event.
//     */
//    public void handleUpdate(MessageSecurityConfigEvent event)
//             throws AdminEventListenerException {
//         GFServerConfigProvider.loadConfigContext(event.getConfigContext());
//    }
...
//     *         process the event.
//     */
//    public void handleCreate(MessageSecurityConfigEvent event)
//             throws AdminEventListenerException {
//         GFServerConfigProvider.loadConfigContext(event.getConfigContext());
//    }
}
