...
public interface StorageVol {
     ...
     * @throws VirtException if the connection to the virtualization infrastructure failed
     */
    String getName() throws VirtException;

    /**
     * Deletes the volume definition and the underlying disk image from the virtualization
     * infrastructure.
     * @throws VirtException  if the connection to the virtualization infrastructure failed
     */
