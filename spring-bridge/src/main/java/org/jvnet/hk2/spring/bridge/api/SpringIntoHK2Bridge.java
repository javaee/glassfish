...
public interface SpringIntoHK2Bridge {
    ...
    /**
     * Tells HK2 which Spring bean factory to use when finding
     * spring services
     * 
     * @param beanFactory The non-null spring BeanFactory from which
     * to find spring services to be injected into hk2 services
     */
