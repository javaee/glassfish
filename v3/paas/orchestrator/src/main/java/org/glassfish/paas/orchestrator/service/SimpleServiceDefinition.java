...
public class SimpleServiceDefinition implements ServiceDefinition {
    ...
    public String toString() {
        return "SimpleServiceDefinition [name=" + name + ", serviceType = " +
                serviceType + ", properties = " + getProperties() + "]";
    }
    ...
    static {
        ...
        serviceTypeMap.put("rdbms", new RDBMSServiceType());
        serviceTypeMap.put("lb", new HTTPLoadBalancerServiceType());
    }
