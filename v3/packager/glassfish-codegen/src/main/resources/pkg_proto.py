...
pkg = {
    "name"          : "glassfish-codegen",
    "version"       : conf.corba_version,
    "attributes"    : {
                        "pkg.summary" : "CORBA Code Generation for GlassFish",
                        "pkg.description" : "Library used for runtime Java class generation.  "+conf.glassfish_description_long,
