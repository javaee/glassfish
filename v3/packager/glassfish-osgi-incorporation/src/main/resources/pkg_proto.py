...
pkg = {
    "name"          : "glassfish-osgi-incorporation",
    "version"       : conf.glassfish_version,
    "attributes"    : {
                        "pkg.summary" : "GlassFish OSGi Feature Pack Incorporation",
                        "pkg.description" : "GlassFish OSGi Feature Pack Incorporation Package.  "+conf.glassfish_description_long,
    ...
    "depends"       : { 
			...
			"pkg:/glassfish-osgi-gui@" + conf.glassfish_version : {"type" : "incorporate" },
                      },
    "licenses"      : {
