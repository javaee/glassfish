...
pkg = {
    "name"          : "glassfish-osgi-feature-pack",
    "version"       : conf.glassfish_version,
    "attributes"    : {
                        "pkg.summary" : "GlassFish OSGi Feature Pack",
                        "pkg.description" : "GlassFish OSGi Feature Pack Metapackage.  "+conf.glassfish_description_long,
