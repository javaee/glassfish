...
pkg = {
    ...
    "attributes"    : {
                        "pkg.summary" : "GlassFish JDBC Console Plugin",
                        "pkg.description" : "This package is now obsolete. GlassFish JDBC Console Plugin package content has been moved to glassfish-jdbc package.  "+conf.glassfish_description_long,
