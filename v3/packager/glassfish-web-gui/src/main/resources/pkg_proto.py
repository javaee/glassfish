...
pkg = {
    ...
    "attributes"    : {
                        ...
                        "pkg.description" : "This package is now obsolete. GlassFish Web Container Console Plugin content has been moved to glassfish-web package. "+conf.glassfish_description_long,
