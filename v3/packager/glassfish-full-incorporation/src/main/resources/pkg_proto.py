...
pkg = {
    ...
    "depends"       : { 
			...
			"pkg:/mq-server@4.4" : {"type" : "incorporate" },
			"pkg:/mq-bin-sh@4.4" : {"type" : "incorporate" },
			"pkg:/mq-bin-exe@4.4" : {"type" : "incorporate" },
                        "pkg:/mq-config-gf@4.4" : {"type" : "incorporate" },
			"pkg:/mq-locale@4.4" : {"type" : "incorporate" },
                      },
    "licenses"      : {
