...
public class ActiveJmsResourceAdapter extends ActiveInboundResourceAdapterImpl implements LazyServiceInitializer, PostConstruct {
   ...
   //private void hackMergedProps(Set mergedProps) {
    ...
    private String getNodeAgentHostName() {
        ...
        //todo: enable this
       /* try {
            ServerContext context = null;//todo: ApplicationServer.getServerContext();
   ...
   /* private String getPropertyFromPool(JdbcConnectionPool jdbcConPool,
    ...
    private JdbcConnectionPool getJDBCConnectionPoolInfo(String poolJndiName){
        ...
        return null; //todo: ResourcesUtil.createInstance().getJDBCPoolForResource(poolJndiName);
    }
    ...
    //todo: boolean asAvailability = as.isAvailabilityEnabled();
   ...
   /*todo: if (ja != null) {
        ...
        //todo: .logFine("JMS availability :: " + (jmsAvailability && asAvailability));
        return false; //todo: (jmsAvailability && asAvailability);
    }
   ...
   private Properties listToProperties(List<Property> props){
    ...
    public static String getBrokerInstanceName(JmsService js)
                      throws Exception, ConnectorRuntimeException {
       ...
       boolean validate =  "true".equals(System.getProperty("validate.jms.ra"));
                if (validate) {
                    try {
                        ...
                        logger.log(Level.SEVERE,  "endpointfactory.as_validate_Failed", ex);
                    }
                }
    }
     /**
     ...
     */
    private String getMQClusterName() throws Exception {
    ...
    private void setJmsServiceProperties(JmsService service) throws
        ...
        logger.log(Level.INFO, "ADDRESSLIST in setJmsServiceProvider " + addressList);
        ConnectorDescriptor cd = super.getDescriptor();
   ...
   public ManagedConnectionFactory [] createManagedConnectionFactories
       ...
       logger.log(Level.FINE, "No of addresses found " +
        ...
        String brokerurl = tokenizer.nextToken();
         ...
         String propValue = prop.getValue();
          ...
          logger.log(Level.INFO, "ADDRESSLIST " + brokerurl);
    ...
    public ManagedConnectionFactory createManagedConnectionFactory
        ...
        if(ConnectorAdminServiceUtils.isJMSRA(moduleName))
        {
            ...
            logger.log(Level.FINE,"rardeployment.mcfcreation_error",
                    Ex);
           }
          }
