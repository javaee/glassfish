 ...
 * holder.
 */
package org.glassfish.jms.admin.monitor.config;
 ...
 */
@Service
public class JmsServiceConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = MonitoringItem.LEVEL_OFF;
    private String name = MonitoringItem.JMS_SERVICE;
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        MonitoringItem newItem = param.createChild(
                            org.glassfish.jms.admin.monitor.config.JmsServiceMI.class);
