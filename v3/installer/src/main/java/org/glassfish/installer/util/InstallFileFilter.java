 ...
 * to perform operations on a specific types of files. 
 *
 * @author sathyan
 */
public class InstallFileFilter implements java.io.FileFilter {

    // Holds the file extension to filter
    public String fileExtension;

    public InstallFileFilter(String fileExtension) {
