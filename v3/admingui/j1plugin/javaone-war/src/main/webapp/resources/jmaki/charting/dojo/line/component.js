...
jmaki.namespace("jmaki.widgets.jmaki.charting.dojo.line");

jmaki.widgets.jmaki.charting.dojo.line.Widget = function(wargs) {
    ...
    function init() {
        ...
        for (var i = 0; i < serises.length; i++) {
            plot.addSeries({ data:serises[i], plotter: jmdojo.charting.Plotters.Line });
        }
        pa.plots.push(plot);
