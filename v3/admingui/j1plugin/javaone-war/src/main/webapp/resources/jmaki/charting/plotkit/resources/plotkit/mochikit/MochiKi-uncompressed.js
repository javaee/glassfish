...
***/
/**
 * This file contains a fix to preven incompatibilities with ExtJS
 * Search for gmurray to see the change.
*/
...
MochiKit.Base.VERSION="1.3.1_mod";
...
var _20=[];
for(var _21 in obj){
  if (typeof obj[_21] != 'function') _20.push(_21);
}
return _20;
},items:function(obj){
var _22=[];
...
// gmurray : added NaN check to prevent conflict with Mochikit and ExtJS
var _65=(typeof (a)=="undefined"||a===null || isNaN(a));
var _66=(typeof (b)=="undefined"||b===null || isNaN(b));
if(_65&&_66){
return 0;
}else{
if(_65){
