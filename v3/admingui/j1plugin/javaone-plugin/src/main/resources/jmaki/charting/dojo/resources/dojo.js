...
if(dj_undef("jmdojo",this)){
var jmdojo={};
}
jmdojo.global=function(){
return dj_currentContext;
};
jmdojo.locale=djConfig.locale;
jmdojo.version={major:0,minor:0,patch:0,flag:"dev",revision:Number("$Rev: 7460 $".match(/[0-9]+/)[0]),toString:function(){
with(jmdojo.version){
return major+"."+minor+"."+patch+flag+" ("+revision+")";
}
}};
jmdojo.getObject=function(_3,_4,_5,_6){
var _7,_8;
if(typeof _3!="string"){
return undefined;
}
...
jmdojo.exists=function(_e,_f){
if(typeof _f=="string"){
jmdojo.deprecated("jmdojo.exists(obj, name)","use jmdojo.exists(name, obj, /*optional*/create)","0.6");
var tmp=_e;
_e=_f;
_f=tmp;
}
return (!!jmdojo.getObject(_e,false,_f));
};
jmdojo.evalProp=function(_11,_12,_13){
jmdojo.deprecated("jmdojo.evalProp","just use hash syntax. Sheesh.","0.6");
return _12[_11]||(_13?(_12[_11]={}):undefined);
};
jmdojo.parseObjPath=function(_14,_15,_16){
jmdojo.deprecated("jmdojo.parseObjPath","use jmdojo.getObject(path, create, context, true)","0.6");
return jmdojo.getObject(_14,_16,_15,true);
};
jmdojo.evalObjPath=function(_17,_18){
jmdojo.deprecated("jmdojo.evalObjPath","use jmdojo.getObject(path, create)","0.6");
return jmdojo.getObject(_17,_18);
};
jmdojo.errorToString=function(_19){
return (_19["message"]||_19["description"]||_19);
};
jmdojo.raise=function(_1a,_1b){
if(_1b){
_1a=_1a+": "+jmdojo.errorToString(_1b);
}else{
_1a=jmdojo.errorToString(_1a);
}
try{
if(djConfig.isDebug){
jmdojo.hostenv.println("FATAL exception raised: "+_1a);
}
}
catch(e){
}
...
jmdojo.debug=function(){
};
jmdojo.debugShallow=function(obj){
};
jmdojo.profile={start:function(){
},end:function(){
},stop:function(){
},dump:function(){
}};
...
jmdojo.unimplemented=function(_1e,_1f){
...
jmdojo.deprecated=function(_21,_22,_23){
...
return {name:"",ver:jmdojo.version,os:{win:false,linux:false,osx:false},html:vscaffold(["html"],["ie","opera","khtml","safari","moz"]),svg:vscaffold(["svg"],["corel","adobe","batik"]),vml:vscaffold(["vml"],["ie"]),swf:vscaffold(["Swf","Flash","Mm"],["mm"]),swt:vscaffold(["Swt"],["ibm"])};
})();
jmdojo.hostenv=(function(){
...
jmdojo.unimplemented("getText","uri="+uri);
}};
})();
jmdojo.hostenv.getBaseScriptUri=function(){
if(djConfig.baseScriptUri.length){
return djConfig.baseScriptUri;
}
var uri=new String(djConfig.libraryScriptUri||djConfig.baseRelativePath);
if(!uri){
jmdojo.raise("Nothing returned by getLibraryScriptUri(): "+uri);
}
djConfig.baseScriptUri=djConfig.baseRelativePath;
return djConfig.baseScriptUri;
};
(function(){
var _2d={pkgFileName:"__package__",loading_modules_:{},loaded_modules_:{},addedToLoadingCount:[],removedFromLoadingCount:[],inFlightCount:0,modulePrefixes_:{jmdojo:{name:"jmdojo",value:"src"}},registerModulePath:function(_2e,_2f){
...
for(var _33 in _2d){
jmdojo.hostenv[_33]=_2d[_33];
}
})();
jmdojo.hostenv.loadPath=function(_34,_35,cb){
var uri;
...
if(djConfig.cacheBust&&jmdojo.render.html.capable){
...
jmdojo.hostenv.loadUri=function(uri,cb){
...
jmdojo.hostenv.loadUriAndCheck=function(uri,_3d,cb){
var ok=true;
try{
ok=this.loadUri(uri,cb);
}
catch(e){
jmdojo.debug("failed loading ",uri," with error: ",e);
}
return Boolean(ok&&this.findModule(_3d,false));
};
jmdojo.loaded=function(){
};
jmdojo.unloaded=function(){
};
jmdojo.hostenv.loaded=function(){
...
jmdojo.hostenv.unloaded=function(){
...
jmdojo.addOnLoad=function(obj,_44){
var dh=jmdojo.hostenv;
...
jmdojo.addOnUnload=function(obj,_47){
var dh=jmdojo.hostenv;
if(arguments.length==1){
...
jmdojo.hostenv.modulesLoaded=function(){
if(this.post_load_){
return;
}
if(this.loadUriStack.length==0&&this.getTextStack.length==0){
if(this.inFlightCount>0){
jmdojo.debug("files still in flight!");
return;
}
jmdojo.hostenv.callLoaded();
}
};
jmdojo.hostenv.callLoaded=function(){
if(typeof setTimeout=="object"||(djConfig["useXDomain"]&&jmdojo.render.html.opera)){
setTimeout("jmdojo.hostenv.loaded();",0);
}else{
jmdojo.hostenv.loaded();
}
};
jmdojo.hostenv.getModuleSymbols=function(_49){
var _4a=_49.split(".");
...
jmdojo.hostenv._global_omit_module_check=false;
jmdojo.hostenv.loadModule=function(_4e,_4f,_50){
if(!_4e){
return;
}
...
if(!ok&&!_50){
jmdojo.raise("Could not load '"+_4e+"'; last tried '"+_52+"'");
}
}
if(!_50&&!this["isXDomain"]){
_51=this.findModule(_4e,false);
if(!_51){
jmdojo.raise("symbol '"+_4e+"' is not defined after loading '"+_52+"'");
}
}
return _51;
};
jmdojo.hostenv.startPackage=function(_59){
var _5a=String(_59);
var _5b=_5a;
var _5c=_59.split(/\./);
if(_5c[_5c.length-1]=="*"){
...
var _5d=jmdojo.getObject(_5b,true);
this.loaded_modules_[_5a]=_5d;
this.loaded_modules_[_5b]=_5d;
return _5d;
};
jmdojo.hostenv.findModule=function(_5e,_5f){
var lmn=String(_5e);
if(this.loaded_modules_[lmn]){
return this.loaded_modules_[lmn];
}
if(_5f){
jmdojo.raise("no loaded module named '"+_5e+"'");
}
return null;
};
jmdojo.kwCompoundRequire=function(_61){
var _62=_61["common"]||[];
var _63=_62.concat(_61[jmdojo.hostenv.name_]||_61["default"]||[]);
for(var x=0;x<_63.length;x++){
var _65=_63[x];
if(_65.constructor==Array){
jmdojo.hostenv.loadModule.apply(jmdojo.hostenv,_65);
}else{
jmdojo.hostenv.loadModule(_65);
}
}
};
jmdojo.require=function(_66){
jmdojo.hostenv.loadModule.apply(jmdojo.hostenv,arguments);
};
jmdojo.requireIf=function(_67,_68){
var _69=arguments[0];
if((_69===true)||(_69=="common")||(_69&&jmdojo.render[_69].capable)){
var _6a=[];
for(var i=1;i<arguments.length;i++){
_6a.push(arguments[i]);
}
jmdojo.require.apply(jmdojo,_6a);
}
};
jmdojo.requireAfterIf=jmdojo.requireIf;
jmdojo.provide=function(_6c){
return jmdojo.hostenv.startPackage.apply(jmdojo.hostenv,arguments);
};
jmdojo.registerModulePath=function(_6d,_6e){
return jmdojo.hostenv.registerModulePath(_6d,_6e);
};
if(djConfig["modulePaths"]){
for(var param in djConfig["modulePaths"]){
jmdojo.registerModulePath(param,djConfig["modulePaths"][param]);
}
}
jmdojo.requireLocalization=function(_6f,_70,_71,_72){
jmdojo.require("jmdojo.i18n.loader");
jmdojo.i18n._requireLocalization.apply(jmdojo.hostenv,arguments);
};
}
...
var _7b=/(__package__|jmdojo|bootstrap1)\.js([\?\.]|$)/i;
...
var dr=jmdojo.render;
var drh=jmdojo.render.html;
var drs=jmdojo.render.svg;
...
jmdojo.locale=jmdojo.locale||(drh.ie?navigator.userLanguage:navigator.language).toLowerCase();
...
jmdojo.hostenv.startPackage("jmdojo.hostenv");
jmdojo.render.name=jmdojo.hostenv.name_="browser";
jmdojo.hostenv.searchIds=[];
jmdojo.hostenv._XMLHTTP_PROGIDS=["Msxml2.XMLHTTP","Microsoft.XMLHTTP","Msxml2.XMLHTTP.4.0"];
jmdojo.hostenv.getXmlhttpObject=function(){
var _8d=null;
var _8e=null;
try{
...
if(!_8d){
for(var i=0;i<3;++i){
var _90=jmdojo.hostenv._XMLHTTP_PROGIDS[i];
try{
...
if(_8d){
jmdojo.hostenv._XMLHTTP_PROGIDS=[_90];
break;
}
}
}
if(!_8d){
return jmdojo.raise("XMLHTTP not available",_8e);
}
return _8d;
};
jmdojo.hostenv._blockAsync=false;
jmdojo.hostenv.getText=function(uri,_92,_93){
if(!_92){
...
if(_92){
var _97=this,_98=null,gbl=jmdojo.global();
var xhr=jmdojo.getObject("jmdojo.io.XMLHTTPTransport");
...
jmdojo.hostenv.defaultDebugContainerId="dojoDebug";
jmdojo.hostenv._println_buffer=[];
jmdojo.hostenv._println_safe=false;
jmdojo.hostenv.println=function(_9c){
if(!jmdojo.hostenv._println_safe){
jmdojo.hostenv._println_buffer.push(_9c);
}else{
try{
var _9d=document.getElementById(djConfig.debugContainerId?djConfig.debugContainerId:jmdojo.hostenv.defaultDebugContainerId);
if(!_9d){
_9d=jmdojo.body();
}
...
jmdojo.addOnLoad(function(){
jmdojo.hostenv._println_safe=true;
while(jmdojo.hostenv._println_buffer.length>0){
jmdojo.hostenv.println(jmdojo.hostenv._println_buffer.shift());
}
});
...
var _a5=function(){
if(jmdojo.render.html.ie){
jmdojo.hostenv.makeWidgets();
}
};
if(jmdojo.hostenv.inFlightCount==0){
_a5();
jmdojo.hostenv.modulesLoaded();
}else{
jmdojo.hostenv.modulesLoadedListeners.unshift(_a5);
}
}
if(document.addEventListener){
if(jmdojo.render.html.opera||(jmdojo.render.html.moz&&(djConfig["enableMozDomContentLoaded"]===true))){
document.addEventListener("DOMContentLoaded",dj_load_init,null);
}
window.addEventListener("load",dj_load_init,null);
}
if(jmdojo.render.html.ie&&jmdojo.render.os.win){
...
jmdojo.hostenv._unloading=true;
window.setTimeout(function(){
jmdojo.hostenv._unloading=false;
},0);
});
}
dj_addNodeEvtHdlr(window,"unload",function(){
if((!jmdojo.render.html.ie)||(jmdojo.render.html.ie&&jmdojo.hostenv._unloading)){
jmdojo.hostenv.unloaded();
}
});
jmdojo.hostenv.makeWidgets=function(){
var _a6=[];
if(djConfig.searchIds&&djConfig.searchIds.length>0){
_a6=_a6.concat(djConfig.searchIds);
}
if(jmdojo.hostenv.searchIds&&jmdojo.hostenv.searchIds.length>0){
_a6=_a6.concat(jmdojo.hostenv.searchIds);
}
if((djConfig.parseWidgets)||(_a6.length>0)){
if(jmdojo.getObject("jmdojo.widget.Parse")){
var _a7=new jmdojo.xml.Parse();
if(_a6.length>0){
...
jmdojo.widget.getParser().createComponents(_aa);
}
}else{
if(djConfig.parseWidgets){
var _aa=_a7.parseElement(jmdojo.body(),null,true);
jmdojo.widget.getParser().createComponents(_aa);
}
}
}
...
jmdojo.hostenv.writeIncludes=function(){
};
...
jmdojo.body=function(){
return jmdojo.doc().body||jmdojo.doc().getElementsByTagName("body")[0];
};
jmdojo.byId=function(id,doc){
...
jmdojo.setContext=function(_af,_b0){
dj_currentContext=_af;
dj_currentDocument=_b0;
};
jmdojo._fireCallback=function(_b1,_b2,_b3){
if((_b2)&&((typeof _b1=="string")||(_b1 instanceof String))){
_b1=_b2[_b1];
}
return (_b2?_b1.apply(_b2,_b3||[]):_b1());
};
jmdojo.withGlobal=function(_b4,_b5,_b6,_b7){
var _b8;
var _b9=dj_currentContext;
var _ba=dj_currentDocument;
try{
jmdojo.setContext(_b4,_b4.document);
_b8=jmdojo._fireCallback(_b5,_b6,_b7);
}
finally{
jmdojo.setContext(_b9,_ba);
}
return _b8;
};
jmdojo.withDoc=function(_bb,_bc,_bd,_be){
var _bf;
var _c0=dj_currentDocument;
try{
dj_currentDocument=_bb;
_bf=jmdojo._fireCallback(_bc,_bd,_be);
}
finally{
...
jmdojo.requireIf((djConfig["isDebug"]||djConfig["debugAtAllCosts"]),"jmdojo.debug");
jmdojo.requireIf(djConfig["debugAtAllCosts"]&&!window.widget&&!djConfig["useXDomain"],"jmdojo.browser_debug");
jmdojo.requireIf(djConfig["debugAtAllCosts"]&&!window.widget&&djConfig["useXDomain"],"jmdojo.browser_debug_xd");
jmdojo.provide("jmdojo.lang.common");
jmdojo.lang.inherits=function(_c1,_c2){
if(!jmdojo.lang.isFunction(_c2)){
jmdojo.raise("jmdojo.inherits: superclass argument ["+_c2+"] must be a function (subclass: ["+_c1+"']");
}
...
jmdojo.lang._mixin=function(obj,_c4){
var _c5={};
for(var x in _c4){
...
if(jmdojo.render.html.ie&&(typeof (_c4["toString"])=="function")&&(_c4["toString"]!=obj["toString"])&&(_c4["toString"]!=_c5["toString"])){
obj.toString=_c4.toString;
}
return obj;
};
jmdojo.lang.mixin=function(obj,_c8){
for(var i=1,l=arguments.length;i<l;i++){
jmdojo.lang._mixin(obj,arguments[i]);
}
return obj;
};
jmdojo.lang.extend=function(_cb,_cc){
for(var i=1,l=arguments.length;i<l;i++){
jmdojo.lang._mixin(_cb.prototype,arguments[i]);
}
return _cb;
};
jmdojo.lang._delegate=function(obj,_d0){
function TMP(){
}
TMP.prototype=obj;
var tmp=new TMP();
if(_d0){
jmdojo.lang.mixin(tmp,_d0);
}
return tmp;
};
jmdojo.inherits=jmdojo.lang.inherits;
jmdojo.mixin=jmdojo.lang.mixin;
jmdojo.extend=jmdojo.lang.extend;
jmdojo.lang.find=function(_d2,_d3,_d4,_d5){
var _d6=jmdojo.lang.isString(_d2);
if(_d6){
_d2=_d2.split("");
}
if(_d5){
...
jmdojo.lang.indexOf=jmdojo.lang.find;
jmdojo.lang.findLast=function(_da,_db,_dc){
return jmdojo.lang.find(_da,_db,_dc,true);
};
jmdojo.lang.lastIndexOf=jmdojo.lang.findLast;
jmdojo.lang.inArray=function(_dd,_de){
return jmdojo.lang.find(_dd,_de)>-1;
};
jmdojo.lang.isObject=function(it){
if(typeof it=="undefined"){
return false;
}
return (typeof it=="object"||it===null||jmdojo.lang.isArray(it)||jmdojo.lang.isFunction(it));
};
jmdojo.lang.isArray=function(it){
return (it&&it instanceof Array||typeof it=="array");
};
jmdojo.lang.isArrayLike=function(it){
if((!it)||(jmdojo.lang.isUndefined(it))){
return false;
}
if(jmdojo.lang.isString(it)){
return false;
}
if(jmdojo.lang.isFunction(it)){
return false;
}
if(jmdojo.lang.isArray(it)){
return true;
}
if((it.tagName)&&(it.tagName.toLowerCase()=="form")){
return false;
}
if(jmdojo.lang.isNumber(it.length)&&isFinite(it.length)){
return true;
}
return false;
};
jmdojo.lang.isFunction=function(it){
return (it instanceof Function||typeof it=="function");
};
(function(){
if((jmdojo.render.html.capable)&&(jmdojo.render.html["safari"])){
jmdojo.lang.isFunction=function(it){
...
jmdojo.lang.isString=function(it){
return (typeof it=="string"||it instanceof String);
};
jmdojo.lang.isAlien=function(it){
if(!it){
return false;
}
return !jmdojo.lang.isFunction(it)&&/\{\s*\[native code\]\s*\}/.test(String(it));
};
jmdojo.lang.isBoolean=function(it){
return (it instanceof Boolean||typeof it=="boolean");
};
jmdojo.lang.isNumber=function(it){
return (it instanceof Number||typeof it=="number");
};
jmdojo.lang.isUndefined=function(it){
return ((typeof (it)=="undefined")&&(it==undefined));
};
jmdojo.provide("jmdojo.lang.func");
jmdojo.lang.hitch=function(_e9,_ea){
var _eb=[];
for(var x=2;x<arguments.length;x++){
_eb.push(arguments[x]);
}
var fcn=(jmdojo.lang.isString(_ea)?_e9[_ea]:_ea)||function(){
};
return function(){
var ta=_eb.concat([]);
...
jmdojo.lang.anonCtr=0;
jmdojo.lang.anon={};
jmdojo.lang.nameAnonFunc=function(_f0,_f1,_f2){
var _f3=(jmdojo.render.html.capable&&jmdojo.render.html["ie"]);
var jpn="$joinpoint";
var nso=(_f1||jmdojo.lang.anon);
if(_f3){
...
var ret="__"+jmdojo.lang.anonCtr++;
while(typeof nso[ret]!="undefined"){
ret="__"+jmdojo.lang.anonCtr++;
}
nso[ret]=_f0;
return ret;
};
jmdojo.lang.forward=function(_fa){
return function(){
return this[_fa].apply(this,arguments);
};
};
jmdojo.lang.curry=function(_fb,_fc){
var _fd=[];
_fb=_fb||dj_global;
if(jmdojo.lang.isString(_fc)){
_fc=_fb[_fc];
}
for(var x=2;x<arguments.length;x++){
...
jmdojo.lang.curryArguments=function(_107,func,args,_10a){
var _10b=[];
var x=_10a||0;
for(x=_10a;x<args.length;x++){
_10b.push(args[x]);
}
return jmdojo.lang.curry.apply(jmdojo.lang,[_107,func].concat(_10b));
};
jmdojo.lang.tryThese=function(){
for(var x=0;x<arguments.length;x++){
try{
...
jmdojo.lang.delayThese=function(farr,cb,_111,_112){
if(!farr.length){
...
(farr.shift())();
cb();
jmdojo.lang.delayThese(farr,cb,_111,_112);
},_111);
};
jmdojo.provide("jmdojo.string.common");
jmdojo.string.trim=function(str,wh){
if(!str.replace){
return str;
}
if(!str.length){
...
jmdojo.string.trimStart=function(str){
return jmdojo.string.trim(str,1);
};
jmdojo.string.trimEnd=function(str){
return jmdojo.string.trim(str,-1);
};
jmdojo.string.repeat=function(str,_119,_11a){
var out="";
...
jmdojo.string.pad=function(str,len,c,dir){
var out=String(str);
if(!c){
c="0";
}
...
jmdojo.string.padLeft=function(str,len,c){
return jmdojo.string.pad(str,len,c,1);
};
jmdojo.string.padRight=function(str,len,c){
return jmdojo.string.pad(str,len,c,-1);
};
jmdojo.provide("jmdojo.lang.array");
jmdojo.lang.mixin(jmdojo.lang,{has:function(obj,name){
try{
...
if(jmdojo.lang.isArrayLike(obj)||jmdojo.lang.isString(obj)){
return obj.length===0;
}else{
if(jmdojo.lang.isObject(obj)){
var tmp={};
for(var x in obj){
if(obj[x]&&(!tmp[x])){
return false;
...
var _130=jmdojo.lang.isString(arr);
if(_130){
arr=arr.split("");
}
if(jmdojo.lang.isFunction(obj)&&(!_12f)){
_12f=obj;
obj=dj_global;
}else{
if(jmdojo.lang.isFunction(obj)&&_12f){
...
jmdojo.lang.map(arr,function(val){
_138=_135.call(ob,_138,val);
});
return _138;
},forEach:function(_13b,_13c,_13d){
if(jmdojo.lang.isString(_13b)){
_13b=_13b.split("");
}
if(Array.forEach){
...
var _150=jmdojo.lang.isString(arr);
if(_150){
arr=arr.split("");
}
var _151;
...
jmdojo.raise("thisObject doesn't exist!");
}
_14f=dj_global;
}
_151=[];
...
if(jmdojo.lang.isArrayLike(arguments[i])){
var add=jmdojo.lang.unnest.apply(this,arguments[i]);
out=out.concat(add);
}else{
...
jmdojo.provide("jmdojo.string.extras");
jmdojo.string.substitute=function(_15a,map,_15c,_15d){
return _15a.replace(/\$\{([^\s\:]+)(?:\:(\S+))?\}/g,function(_15e,key,_160){
var _161=jmdojo.getObject(key,false,map).toString();
if(_160){
_161=jmdojo.getObject(_160,false,_15d)(_161);
}
if(_15c){
_161=_15c(_161);
}
...
jmdojo.string.capitalize=function(str){
if(!jmdojo.lang.isString(str)){
return "";
}
...
jmdojo.string.isBlank=function(str){
if(!jmdojo.lang.isString(str)){
return true;
}
return (jmdojo.string.trim(str).length==0);
};
jmdojo.string.encodeAscii=function(str){
if(!jmdojo.lang.isString(str)){
return str;
}
var ret="";
...
jmdojo.string.escape=function(type,str){
var args=jmdojo.lang.toArray(arguments,1);
switch(type.toLowerCase()){
case "xml":
case "html":
case "xhtml":
return jmdojo.string.escapeXml.apply(this,args);
case "sql":
return jmdojo.string.escapeSql.apply(this,args);
case "regexp":
case "regex":
return jmdojo.string.escapeRegExp.apply(this,args);
case "javascript":
case "jscript":
case "js":
return jmdojo.string.escapeJavaScript.apply(this,args);
case "ascii":
return jmdojo.string.encodeAscii.apply(this,args);
default:
return str;
}
};
jmdojo.string.escapeXml=function(str,_170){
...
jmdojo.string.escapeSql=function(str){
return str.replace(/'/gm,"''");
};
jmdojo.string.escapeRegExp=function(str,_173){
...
jmdojo.string.escapeJavaScript=function(str){
return str.replace(/(["'\f\b\n\t\r])/gm,"\\$1");
};
jmdojo.string.escapeString=function(str){
return ("\""+str.replace(/(["\\])/g,"\\$1")+"\"").replace(/[\f]/g,"\\f").replace(/[\b]/g,"\\b").replace(/[\n]/g,"\\n").replace(/[\t]/g,"\\t").replace(/[\r]/g,"\\r");
};
jmdojo.string.summary=function(str,len){
if(!len||str.length<=len){
return str;
}
return str.substring(0,len).replace(/\.+$/,"")+"...";
};
jmdojo.string.endsWith=function(str,end,_17b){
if(_17b){
str=str.toLowerCase();
end=end.toLowerCase();
}
...
jmdojo.string.endsWithAny=function(str){
for(var i=1;i<arguments.length;i++){
if(jmdojo.string.endsWith(str,arguments[i])){
return true;
}
}
return false;
};
jmdojo.string.startsWith=function(str,_17f,_180){
if(_180){
str=str.toLowerCase();
...
jmdojo.string.startsWithAny=function(str){
for(var i=1;i<arguments.length;i++){
if(jmdojo.string.startsWith(str,arguments[i])){
return true;
}
}
return false;
};
jmdojo.string.has=function(str){
for(var i=1;i<arguments.length;i++){
...
jmdojo.string.normalizeNewlines=function(text,_186){
if(_186=="\n"){
text=text.replace(/\r\n/g,"\n");
...
jmdojo.string.splitEscaped=function(str,_188){
var _189=[];
...
jmdojo.provide("jmdojo.AdapterRegistry");
jmdojo.AdapterRegistry=function(_18c){
this.pairs=[];
this.returnWrappers=_18c||false;
};
jmdojo.lang.extend(jmdojo.AdapterRegistry,{register:function(name,_18e,wrap,_190,_191){
...
jmdojo.provide("jmdojo.json");
jmdojo.json={jsonRegistry:new jmdojo.AdapterRegistry(),register:function(name,_199,wrap,_19b){
jmdojo.json.jsonRegistry.register(name,_199,wrap,_19b);
...
if(_19e=="string"){
return jmdojo.string.escapeString(o);
}
...
try{
window.o=o;
_1a0=jmdojo.json.jsonRegistry.match(o);
return me(_1a0);
}
catch(e){
}
...
if(typeof (k)=="string"){
_1a5=jmdojo.string.escapeString(k);
}else{
continue;
}
}
...
jmdojo.provide("jmdojo.collections.Store");
jmdojo.collections.Store=function(_1a6){
var data=[];
var _1a8={};
this.keyField="Id";
this.get=function(){
...
if(!o[temp]){
jmdojo.raise("jmdojo.collections.Store.getField(obj, '"+_1c4+"'): '"+temp+"' is not a property of the passed object.");
}else{
o=o[temp]();
}
}else{
...
jmdojo.extend(jmdojo.collections.Store,{getField:function(obj,_1f2){
var _1f3=_1f2.split("."),i=0,o=obj;
do{
if(_1f3[i].indexOf("()")>-1){
var temp=_1f3[i++].split("()")[0];
if(!o[temp]){
jmdojo.raise("jmdojo.collections.Store.getField(obj, '"+_1f2+"'): '"+temp+"' is not a property of the passed object.");
}else{
o=o[temp]();
}
}else{
...
if(i<_1f3.length){
jmdojo.raise("jmdojo.collections.Store.getField(obj, '"+_1f2+"'): '"+_1f2+"' is not a property of the passed object.");
}
return o;
...
jmdojo.provide("jmdojo.gfx.color");
jmdojo.gfx.color.Color=function(r,g,b,a){
if(jmdojo.lang.isArray(r)){
this.r=r[0];
this.g=r[1];
this.b=r[2];
this.a=r[3]||1;
}else{
if(jmdojo.lang.isString(r)){
var rgb=jmdojo.gfx.color.extractRGB(r);
this.r=rgb[0];
this.g=rgb[1];
this.b=rgb[2];
this.a=g||1;
}else{
if(r instanceof jmdojo.gfx.color.Color){
this.r=r.r;
this.b=r.b;
this.g=r.g;
this.a=r.a;
...
jmdojo.gfx.color.Color.fromArray=function(arr){
return new jmdojo.gfx.color.Color(arr[0],arr[1],arr[2],arr[3]);
};
jmdojo.extend(jmdojo.gfx.color.Color,{toRgb:function(_216){
if(_216){
return this.toRgba();
}else{
...
return jmdojo.gfx.color.rgb2hex(this.toRgb());
},toCss:function(){
...
var rgb=null;
if(jmdojo.lang.isArray(_217)){
rgb=_217;
}else{
if(_217 instanceof jmdojo.gfx.color.Color){
rgb=_217.toRgb();
}else{
rgb=new jmdojo.gfx.color.Color(_217).toRgb();
}
}
return jmdojo.gfx.color.blend(this.toRgb(),rgb,_218);
}});
jmdojo.gfx.color.named={white:[255,255,255],black:[0,0,0],red:[255,0,0],green:[0,255,0],lime:[0,255,0],blue:[0,0,255],navy:[0,0,128],gray:[128,128,128],silver:[192,192,192]};
jmdojo.gfx.color.blend=function(a,b,_21c){
if(typeof a=="string"){
return jmdojo.gfx.color.blendHex(a,b,_21c);
}
if(!_21c){
_21c=0;
}
...
jmdojo.gfx.color.blendHex=function(a,b,_221){
return jmdojo.gfx.color.rgb2hex(jmdojo.gfx.color.blend(jmdojo.gfx.color.hex2rgb(a),jmdojo.gfx.color.hex2rgb(b),_221));
};
jmdojo.gfx.color.extractRGB=function(_222){
...
var _225=jmdojo.gfx.color.hex2rgb(_222);
if(_225){
return _225;
}else{
return jmdojo.gfx.color.named[_222]||[255,255,255];
}
}
};
jmdojo.gfx.color.hex2rgb=function(hex){
...
jmdojo.gfx.color.rgb2hex=function(r,g,b){
if(jmdojo.lang.isArray(r)){
g=r[1]||0;
b=r[2]||0;
r=r[0]||0;
}
var ret=jmdojo.lang.map([r,g,b],function(x){
x=new Number(x);
var s=x.toString(16);
while(s.length<2){
s="0"+s;
...
jmdojo.provide("jmdojo.gfx.color.hsl");
jmdojo.lang.extend(jmdojo.gfx.color.Color,{toHsl:function(){
return jmdojo.gfx.color.rgb2hsl(this.toRgb());
}});
jmdojo.gfx.color.rgb2hsl=function(r,g,b){
if(jmdojo.lang.isArray(r)){
b=r[2]||0;
g=r[1]||0;
r=r[0]||0;
...
jmdojo.gfx.color.hsl2rgb=function(h,s,l){
if(jmdojo.lang.isArray(h)){
l=h[2]||0;
s=h[1]||0;
h=h[0]||0;
}
...
jmdojo.gfx.color.hsl2hex=function(h,s,l){
var rgb=jmdojo.gfx.color.hsl2rgb(h,s,l);
return jmdojo.gfx.color.rgb2hex(rgb[0],rgb[1],rgb[2]);
};
jmdojo.gfx.color.hex2hsl=function(hex){
var rgb=jmdojo.gfx.color.hex2rgb(hex);
return jmdojo.gfx.color.rgb2hsl(rgb[0],rgb[1],rgb[2]);
};
jmdojo.provide("jmdojo.charting.*");
jmdojo.provide("jmdojo.dom");
jmdojo.dom.ELEMENT_NODE=1;
jmdojo.dom.ATTRIBUTE_NODE=2;
jmdojo.dom.TEXT_NODE=3;
jmdojo.dom.CDATA_SECTION_NODE=4;
jmdojo.dom.ENTITY_REFERENCE_NODE=5;
jmdojo.dom.ENTITY_NODE=6;
jmdojo.dom.PROCESSING_INSTRUCTION_NODE=7;
jmdojo.dom.COMMENT_NODE=8;
jmdojo.dom.DOCUMENT_NODE=9;
jmdojo.dom.DOCUMENT_TYPE_NODE=10;
jmdojo.dom.DOCUMENT_FRAGMENT_NODE=11;
jmdojo.dom.NOTATION_NODE=12;
jmdojo.dom.dojoml="http://www.dojotoolkit.org/2004/dojoml";
jmdojo.dom.xmlns={svg:"http://www.w3.org/2000/svg",smil:"http://www.w3.org/2001/SMIL20/",mml:"http://www.w3.org/1998/Math/MathML",cml:"http://www.xml-cml.org",xlink:"http://www.w3.org/1999/xlink",xhtml:"http://www.w3.org/1999/xhtml",xul:"http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",xbl:"http://www.mozilla.org/xbl",fo:"http://www.w3.org/1999/XSL/Format",xsl:"http://www.w3.org/1999/XSL/Transform",xslt:"http://www.w3.org/1999/XSL/Transform",xi:"http://www.w3.org/2001/XInclude",xforms:"http://www.w3.org/2002/01/xforms",saxon:"http://icl.com/saxon",xalan:"http://xml.apache.org/xslt",xsd:"http://www.w3.org/2001/XMLSchema",dt:"http://www.w3.org/2001/XMLSchema-datatypes",xsi:"http://www.w3.org/2001/XMLSchema-instance",rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",dc:"http://purl.org/dc/elements/1.1/",dcq:"http://purl.org/dc/qualifiers/1.0","soap-env":"http://schemas.xmlsoap.org/soap/envelope/",wsdl:"http://schemas.xmlsoap.org/wsdl/",AdobeExtensions:"http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"};
jmdojo.dom.isNode=function(wh){
...
jmdojo.dom.getUniqueId=function(){
var _246=jmdojo.doc();
do{
...
jmdojo.dom.getUniqueId._idIncrement=0;
jmdojo.dom.firstElement=jmdojo.dom.getFirstChildElement=function(_248,_249){
var node=_248.firstChild;
while(node&&node.nodeType!=jmdojo.dom.ELEMENT_NODE){
node=node.nextSibling;
}
if(_249&&node&&node.tagName&&node.tagName.toLowerCase()!=_249.toLowerCase()){
node=jmdojo.dom.nextElement(node,_249);
}
return node;
};
jmdojo.dom.lastElement=jmdojo.dom.getLastChildElement=function(_24b,_24c){
var node=_24b.lastChild;
while(node&&node.nodeType!=jmdojo.dom.ELEMENT_NODE){
node=node.previousSibling;
}
if(_24c&&node&&node.tagName&&node.tagName.toLowerCase()!=_24c.toLowerCase()){
node=jmdojo.dom.prevElement(node,_24c);
}
return node;
};
jmdojo.dom.nextElement=jmdojo.dom.getNextSiblingElement=function(node,_24f){
if(!node){
return null;
}
do{
...
return jmdojo.dom.nextElement(node,_24f);
}
return node;
};
jmdojo.dom.prevElement=jmdojo.dom.getPreviousSiblingElement=function(node,_251){
if(!node){
return null;
}
if(_251){
...
return jmdojo.dom.prevElement(node,_251);
}
return node;
};
jmdojo.dom.moveChildren=function(_252,_253,trim){
var _255=0;
if(trim){
while(_252.hasChildNodes()&&_252.firstChild.nodeType==jmdojo.dom.TEXT_NODE){
_252.removeChild(_252.firstChild);
}
while(_252.hasChildNodes()&&_252.lastChild.nodeType==jmdojo.dom.TEXT_NODE){
...
jmdojo.dom.copyChildren=function(_256,_257,trim){
var _259=_256.cloneNode(true);
return this.moveChildren(_259,_257,trim);
};
jmdojo.dom.replaceChildren=function(node,_25b){
var _25c=[];
if(jmdojo.render.html.ie){
...
jmdojo.dom.removeChildren(node);
node.appendChild(_25b);
for(var i=0;i<_25c.length;i++){
jmdojo.dom.destroyNode(_25c[i]);
}
};
jmdojo.dom.removeChildren=function(node){
var _25f=node.childNodes.length;
while(node.hasChildNodes()){
jmdojo.dom.removeNode(node.firstChild);
}
return _25f;
};
jmdojo.dom.replaceNode=function(node,_261){
return node.parentNode.replaceChild(_261,node);
};
jmdojo.dom.destroyNode=function(node){
if(node.parentNode){
node=jmdojo.dom.removeNode(node);
}
if(node.nodeType!=3){
if(jmdojo.exists("jmdojo.event.browser.clean")){
jmdojo.event.browser.clean(node);
}
if(jmdojo.render.html.ie){
node.outerHTML="";
}
...
jmdojo.dom.removeNode=function(node){
if(node&&node.parentNode){
return node.parentNode.removeChild(node);
}
};
jmdojo.dom.getAncestors=function(node,_265,_266){
var _267=[];
...
jmdojo.dom.getAncestorsByTag=function(node,tag,_26b){
tag=tag.toLowerCase();
return jmdojo.dom.getAncestors(node,function(el){
return ((el.tagName)&&(el.tagName.toLowerCase()==tag));
},_26b);
};
jmdojo.dom.getFirstAncestorByTag=function(node,tag){
return jmdojo.dom.getAncestorsByTag(node,tag,true);
};
jmdojo.dom.isDescendantOf=function(node,_270,_271){
if(_271&&node){
node=node.parentNode;
}
while(node){
...
jmdojo.dom.innerXML=function(node){
if(node.innerXML){
...
jmdojo.dom.createDocument=function(){
var doc=null;
var _274=jmdojo.doc();
...
jmdojo.dom.createDocumentFromText=function(str,_278){
if(!_278){
_278="text/xml";
}
...
if(!dj_undef("ActiveXObject")){
var _27a=jmdojo.dom.createDocument();
if(_27a){
_27a.async=false;
_27a.loadXML(str);
return _27a;
}else{
jmdojo.debug("toXml didn't work?");
}
}else{
var _27b=jmdojo.doc();
...
jmdojo.dom.prependChild=function(node,_280){
if(_280.firstChild){
...
jmdojo.dom.insertBefore=function(node,ref,_283){
...
jmdojo.dom.insertAfter=function(node,ref,_287){
...
jmdojo.dom.insertAtPosition=function(node,ref,_28b){
if((!node)||(!ref)||(!_28b)){
return false;
}
switch(_28b.toLowerCase()){
case "before":
return jmdojo.dom.insertBefore(node,ref);
case "after":
return jmdojo.dom.insertAfter(node,ref);
case "first":
if(ref.firstChild){
return jmdojo.dom.insertBefore(node,ref.firstChild);
}else{
...
jmdojo.dom.insertAtIndex=function(node,_28d,_28e){
...
if(_28e==0){
return jmdojo.dom.prependChild(node,_28d);
}
return jmdojo.dom.insertAfter(node,_28f[_28e-1]);
};
jmdojo.dom.textContent=function(node,text){
if(arguments.length>1){
var _292=jmdojo.doc();
jmdojo.dom.replaceChildren(node,_292.createTextNode(text));
return text;
}else{
...
jmdojo.dom.hasParent=function(node){
return Boolean(node&&node.parentNode&&jmdojo.dom.isNode(node.parentNode));
};
jmdojo.dom.isTag=function(node){
...
jmdojo.dom.setAttributeNS=function(elem,_29a,_29b,_29c){
if(elem==null||((elem==undefined)&&(typeof elem=="undefined"))){
jmdojo.raise("No element given to jmdojo.dom.setAttributeNS");
}
...
jmdojo.provide("jmdojo.svg");
jmdojo.mixin(jmdojo.svg,jmdojo.dom);
jmdojo.svg.graphics=jmdojo.svg.g=new function(d){
...
jmdojo.svg.animations=jmdojo.svg.anim=new function(d){
...
jmdojo.svg.toCamelCase=function(_2a1){
...
jmdojo.svg.toSelectorCase=function(_2a5){
return _2a5.replace(/([A-Z])/g,"-$1").toLowerCase();
};
jmdojo.svg.getStyle=function(node,_2a7){
return document.defaultView.getComputedStyle(node,_2a7);
};
jmdojo.svg.getNumericStyle=function(node,_2a9){
return parseFloat(jmdojo.svg.getStyle(node,_2a9));
};
jmdojo.svg.getOpacity=function(node){
return Math.min(1,jmdojo.svg.getNumericStyle(node,"fill-opacity"));
};
jmdojo.svg.setOpacity=function(node,_2ac){
node.setAttributeNS(this.xmlns.svg,"fill-opacity",_2ac);
node.setAttributeNS(this.xmlns.svg,"stroke-opacity",_2ac);
};
jmdojo.svg.clearOpacity=function(node){
node.setAttributeNS(this.xmlns.svg,"fill-opacity","1.0");
node.setAttributeNS(this.xmlns.svg,"stroke-opacity","1.0");
};
jmdojo.svg.getCoords=function(node){
if(node.getBBox){
...
jmdojo.svg.setCoords=function(node,_2b1){
var p=jmdojo.svg.getCoords();
if(!p){
return;
}
var dx=p.x-_2b1.x;
var dy=p.y-_2b1.y;
jmdojo.svg.translate(node,dx,dy);
};
jmdojo.svg.getDimensions=function(node){
if(node.getBBox){
var box=node.getBBox();
...
jmdojo.svg.setDimensions=function(node,dim){
if(node.width){
...
jmdojo.svg.translate=function(node,dx,dy){
...
jmdojo.svg.scale=function(node,_2be,_2bf){
if(!_2bf){
var _2bf=_2be;
}
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
...
jmdojo.svg.rotate=function(node,ang,cx,cy){
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
var t=node.ownerSVGElement.createSVGTransform();
if(cx==null){
...
jmdojo.svg.skew=function(node,ang,axis){
var dir=axis||"x";
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
var t=node.ownerSVGElement.createSVGTransform();
if(dir!="x"){
...
jmdojo.svg.flip=function(node,axis){
var dir=axis||"x";
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
var t=node.ownerSVGElement.createSVGTransform();
...
jmdojo.svg.invert=function(node){
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
var t=node.ownerSVGElement.createSVGTransform();
...
jmdojo.svg.applyMatrix=function(node,a,b,c,d,e,f){
if(node.transform&&node.ownerSVGElement&&node.ownerSVGElement.createSVGTransform){
var m;
if(b){
...
jmdojo.svg.group=function(_2da){
...
jmdojo.svg.getGroup=function(node){
...
jmdojo.provide("jmdojo.charting.Axis");
jmdojo.charting.Axis=function(_2f0,_2f1,_2f2){
var id="jmdojo-charting-axis-"+jmdojo.charting.Axis.count++;
this.getId=function(){
return id;
};
...
jmdojo.charting.Axis.count=0;
jmdojo.extend(jmdojo.charting.Axis,{getCoord:function(val,_2f6,plot){
...
jmdojo.provide("jmdojo.charting.svg.Axis");
if(jmdojo.render.svg.capable){
jmdojo.extend(jmdojo.charting.Axis,{renderLines:function(_30b,plot,_30d){
if(this.nodes.lines){
...
var g=this.nodes.lines=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
var l=document.createElementNS(jmdojo.svg.xmlns.svg,"line");
...
var g=this.nodes.ticks=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
var text=document.createElementNS(jmdojo.svg.xmlns.svg,"text");
...
var g=this.nodes.labels=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
this.nodes.main=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var g=this.nodes.main;
g.setAttribute("id",this.getId());
var line=this.nodes.axis=document.createElementNS(jmdojo.svg.xmlns.svg,"line");
if(_338=="x"){
...
jmdojo.provide("jmdojo.charting.vml.Axis");
if(jmdojo.render.vml.capable){
jmdojo.extend(jmdojo.charting.Axis,{renderLines:function(_345,plot,_347){
if(this.nodes.lines){
while(this.nodes.lines.childNodes.length>0){
this.nodes.lines.removeChild(this.nodes.lines.childNodes[0]);
}
...
jmdojo.provide("jmdojo.charting.Plotters");
jmdojo.provide("jmdojo.charting.svg.Plotters");
if(jmdojo.render.svg.capable){
jmdojo.mixin(jmdojo.charting.Plotters,{Bar:function(_37c,plot,_37e,_37f){
var area=_37c.getArea();
var _381=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
var bar=document.createElementNS(jmdojo.svg.xmlns.svg,"rect");
...
var _398=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=plot.series.length;
var data=[];
for(var i=0;i<n;i++){
...
var _3af=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=plot.series.length;
var data=[];
for(var i=0;i<n;i++){
...
var _3c6=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=plot.series.length;
var data=[];
var _3c9=[];
for(var i=0;i<n;i++){
...
for(var i=n-1;i>=0;i--){
var path=document.createElementNS(jmdojo.svg.xmlns.svg,"path");
...
cmd.push(x+","+y);
var c=document.createElementNS(jmdojo.svg.xmlns.svg,"circle");
c.setAttribute("cx",x);
c.setAttribute("cy",y);
c.setAttribute("r","3");
...
var _3da=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=plot.series.length;
var data=[];
var _3dd=[];
for(var i=0;i<n;i++){
...
var _3f0=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=data.length;
...
var line=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
if(data.length==0){
return line;
}
var path=document.createElementNS(jmdojo.svg.xmlns.svg,"path");
...
var _438=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=data.length;
...
var _449=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=data.length;
var part=((area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower))/4;
var w=part*2;
for(var i=0;i<n;i++){
...
var g=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var bar=document.createElementNS(jmdojo.svg.xmlns.svg,"rect");
bar.setAttribute("fill",data[i].series.color);
bar.setAttribute("stroke-width","0");
bar.setAttribute("x",x);
...
bar.setAttribute("fill-opacity","0.6");
g.appendChild(bar);
var line=document.createElementNS(jmdojo.svg.xmlns.svg,"line");
...
var _45e=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var n=data.length;
var part=((area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower))/4;
var w=part*2;
for(var i=0;i<n;i++){
...
var r=7;
var _475=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
for(var i=0;i<data.length;i++){
var x=plot.axisX.getCoord(data[i].x,_471,plot);
var y=plot.axisY.getCoord(data[i].y,_471,plot);
var _479=document.createElementNS(jmdojo.svg.xmlns.svg,"path");
...
var _47e=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
var _47f=1;
for(var i=0;i<data.length;i++){
...
var _485=document.createElementNS(jmdojo.svg.xmlns.svg,"circle");
...
jmdojo.charting.Plotters["Default"]=jmdojo.charting.Plotters.Line;
}
jmdojo.provide("jmdojo.charting.vml.Plotters");
if(jmdojo.render.vml.capable){
jmdojo.mixin(jmdojo.charting.Plotters,{_group:function(_486){
...
var _48d=jmdojo.charting.Plotters._group(_488);
var n=plot.series.length;
var data=[];
for(var i=0;i<n;i++){
...
var _4a5=jmdojo.charting.Plotters._group(_4a0);
var n=plot.series.length;
var data=[];
for(var i=0;i<n;i++){
...
var _4be=jmdojo.charting.Plotters._group(_4b9);
var n=plot.series.length;
var data=[];
for(var i=0;i<n;i++){
...
var _4d6=jmdojo.charting.Plotters._group(_4d1);
var n=plot.series.length;
var data=[];
var _4d9=[];
for(var i=0;i<n;i++){
...
var _4ee=jmdojo.charting.Plotters._group(_4e8);
var n=plot.series.length;
var data=[];
var _4f1=[];
for(var i=0;i<n;i++){
...
var _50a=jmdojo.charting.Plotters._group(_506);
var n=data.length;
var w=(area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower);
...
var _51b=jmdojo.charting.Plotters._group(_517);
if(data.length==0){
return _51b;
}
var path=document.createElement("v:shape");
...
var _52c=jmdojo.charting.Plotters._group(_527);
if(data.length==0){
return _52c;
}
var path=document.createElement("v:shape");
...
var _541=jmdojo.charting.Plotters._group(_53d);
if(data.length==0){
return _541;
}
var path=document.createElement("v:shape");
...
var _553=jmdojo.charting.Plotters._group(_54e);
if(data.length==0){
return _553;
}
var path=document.createElement("v:shape");
...
var _569=jmdojo.charting.Plotters._group(_565);
var n=data.length;
var part=((area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower))/4;
var w=part*2;
for(var i=0;i<n;i++){
...
var _57b=jmdojo.charting.Plotters._group(_577);
var n=data.length;
var part=((area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower))/4;
var w=part*2;
for(var i=0;i<n;i++){
...
var _593=jmdojo.charting.Plotters._group(_58f);
var n=data.length;
var part=((area.right-area.left)/(plot.axisX.range.upper-plot.axisX.range.lower))/4;
var w=part*2;
for(var i=0;i<n;i++){
...
var _5af=jmdojo.charting.Plotters._group(_5a9);
for(var i=0;i<data.length;i++){
...
var _5bc=jmdojo.charting.Plotters._group(_5b7);
for(var i=0;i<data.length;i++){
...
jmdojo.provide("jmdojo.charting.Series");
jmdojo.charting.Series=function(_5c6){
...
jmdojo.extend(jmdojo.charting.Series,{bind:function(src,_5ca){
this.dataSource=src;
this.bindings=_5ca;
...
jmdojo.provide("jmdojo.charting.Plot");
jmdojo.charting.RenderPlotSeries={Singly:"single",Grouped:"grouped"};
jmdojo.charting.Plot=function(_605,_606,_607){
var id="jmdojo-charting-plot-"+jmdojo.charting.Plot.count++;
this.getId=function(){
return id;
};
this.setId=function(key){
...
this.series=[];
this.dataNode=null;
this.renderType=jmdojo.charting.RenderPlotSeries.Singly;
if(_605){
this.setAxis(_605,"x");
}
if(_606){
...
jmdojo.charting.Plot.count=0;
jmdojo.extend(jmdojo.charting.Plot,{addSeries:function(_60b,_60c){
if(_60b.plotter){
this.series.push(_60b);
}else{
this.series.push({data:_60b,plotter:_60c||jmdojo.charting.Plotters["Default"]});
}
...
jmdojo.provide("jmdojo.charting.PlotArea");
jmdojo.charting.PlotArea=function(){
var id="jmdojo-charting-plotarea-"+jmdojo.charting.PlotArea.count++;
this.getId=function(){
return id;
};
this.setId=function(key){
...
jmdojo.charting.PlotArea.count=0;
jmdojo.extend(jmdojo.charting.PlotArea,{nextColor:function(){
var rgb=jmdojo.gfx.color.hsl2rgb(this._color.h,this._color.s,this._color.l);
...
case jmdojo.charting.RenderPlotSeries.Grouped:
if(plot.series[0]){
_630.appendChild(plot.series[0].plotter(this,plot,_62c,_62d));
}
break;
case jmdojo.charting.RenderPlotSeries.Singly:
default:
...
jmdojo.provide("jmdojo.charting.svg.PlotArea");
if(jmdojo.render.svg.capable){
jmdojo.extend(jmdojo.charting.PlotArea,{resize:function(){
...
this.nodes.plots=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
this.nodes.axes=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
...
plot.destroy();
plot.dataNode=document.createElementNS(jmdojo.svg.xmlns.svg,"g");
plot.dataNode.setAttribute("id",plot.getId());
return plot.dataNode;
},initialize:function(){
this.destroy();
this.nodes.main=document.createElement("div");
this.nodes.area=document.createElementNS(jmdojo.svg.xmlns.svg,"svg");
this.nodes.area.setAttribute("id",this.getId());
this.nodes.main.appendChild(this.nodes.area);
var defs=document.createElementNS(jmdojo.svg.xmlns.svg,"defs");
var clip=document.createElementNS(jmdojo.svg.xmlns.svg,"clipPath");
clip.setAttribute("id",this.getId()+"-clip");
var rect=document.createElementNS(jmdojo.svg.xmlns.svg,"rect");
clip.appendChild(rect);
defs.appendChild(clip);
this.nodes.area.appendChild(defs);
this.nodes.background=document.createElementNS(jmdojo.svg.xmlns.svg,"rect");
...
jmdojo.provide("jmdojo.charting.vml.PlotArea");
if(jmdojo.render.vml.capable){
jmdojo.extend(jmdojo.charting.PlotArea,{resize:function(){
var a=this.getArea();
...
jmdojo.provide("jmdojo.charting.Chart");
jmdojo.charting.Chart=function(node,_64e,_64f){
this.node=node||null;
this.title=_64e||"Chart";
this.description=_64f||"";
this.plotAreas=[];
};
jmdojo.extend(jmdojo.charting.Chart,{addPlotArea:function(obj,_651){
...
if(!this.node){
jmdojo.raise("jmdojo.charting.Chart.initialize: there must be a root node defined for the Chart.");
}
this.destroy();
this.render();
