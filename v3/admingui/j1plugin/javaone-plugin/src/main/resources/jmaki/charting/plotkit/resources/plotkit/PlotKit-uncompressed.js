/***
    ...
    This file contains modifications by gmurray. To see the changes search the compressed version of this file for gmurray.
...
//gmurray71 - chunck used to determine starting point
var _chunck = this.layout.points.length / _346;
var _349=this.options.strokeColorTransform;
_342.save();
var _350=function(ctx){
ctx.beginPath();
//gmurray - move start point correctly when drawing line charts
if (!this.options.shouldFill) {
var _s = (i%_343 * (_chunck));
ctx.moveTo(this.area.x,this.layout.points[_s].y * this.area.h +this.area.y);
} else {
ctx.moveTo(this.area.x,this.area.y+this.area.h);
}
...
//gmurray - only finish off the line if we are filling
if (this.options.shouldFill) {
ctx.lineTo(this.area.w+this.area.x,this.area.h+this.area.y);
ctx.lineTo(this.area.x,this.area.y+this.area.h);
ctx.closePath();
...
if(this.options.shouldFill){
//gmurray - default to the white
_342.strokeStyle=Color.whiteColor().toRGBString();
bind(_350,this)(_342);
_342.fill();
} else {
    // gmurray set the color right
    _342.strokeStyle=_348.toRGBString();
}
if(this.options.shouldStroke){
bind(_350,this)(_342);
_342.stroke();
