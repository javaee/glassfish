...
public class JndiTest extends BaseSeleniumTestClass {
    ...
    public void testCustomResource() {
        ...
        clickAndWait("propertyForm:resourcesTable:topActionsGroup1:newButton", "New Custom Resource");
        ...
        clickAndWait("form1:basicTable:topActionsGroup1:addSharedTableButton", "Additional Properties (1)");
        ...
        clickAndWait("form1:propertyContentPage:topButtons:newButton", "Custom resources are nonstandard resources");
        ...
        clickAndWait(getLinkIdByLinkText("propertyForm:resourcesTable", resourceName), "Edit Custom Resource");
        assertEquals("off", selenium.getValue("form1:propertySheet:propertSectionTextField:statusProp:enabled"));
        clickAndWait("form1:propertyContentPage:topButtons:cancelButton", "Custom resources are nonstandard resources");
    ...
    public void testExternalResource() {
        ...
        clickAndWait("propertyForm:resourcesTable:topActionsGroup1:newButton", "New External Resource");
        ...
        selenium.type("form1:basicTable:rowGroup1:0:col3:col1St", "value");
        selenium.type("form1:basicTable:rowGroup1:0:col4:col1St", "description");
        clickAndWait("form1:propertyContentPage:topButtons:newButton", "Manage external JNDI resources when");

        selectTableRowByValue("propertyForm:resourcesTable", resourceName);
        selenium.click("propertyForm:resourcesTable:topActionsGroup1:button3");
        waitForButtonDisabled("propertyForm:resourcesTable:topActionsGroup1:button3");

        clickAndWait(getLinkIdByLinkText("propertyForm:resourcesTable", resourceName), "Edit External Resource");

        assertEquals("off", selenium.getValue("form1:propertySheet:propertSectionTextField:statusProp:enabled"));
        clickAndWait("form1:propertyContentPage:topButtons:cancelButton", "Manage external JNDI resources when");

        selectTableRowByValue("propertyForm:resourcesTable", resourceName);
        selenium.click("propertyForm:resourcesTable:topActionsGroup1:button2");
        waitForButtonDisabled("propertyForm:resourcesTable:topActionsGroup1:button2");

        clickAndWait("propertyForm:resourcesTable:rowGroup1:0:col1:link", "Edit External Resource");
        assertEquals("on", selenium.getValue("form1:propertySheet:propertSectionTextField:statusProp:enabled"));
        clickAndWait("form1:propertyContentPage:topButtons:cancelButton", "Manage external JNDI resources when");
