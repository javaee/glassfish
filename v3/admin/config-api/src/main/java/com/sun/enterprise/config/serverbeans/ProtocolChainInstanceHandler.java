...
public interface ProtocolChainInstanceHandler extends ConfigBeanProxy, PropertyBag, Injectable {
    /**
     * Get the {@link ProtocolChainInstanceHandler} name, which could be used
     * as reference
     *
     * @return the {@link ProtocolChainInstanceHandler} name, 
    ...
    /**
     * Set the {@link ProtocolChainInstanceHandler} name, which could be used
     * as reference
     *
     * @param name the {@link ProtocolChainInstanceHandler} name,
     * which could be used as reference
     */
     ...
     * {@link ProtocolChainInstanceHandler} implementation
     *
    ...
    /**
     * Get the {@link ProtocolChain} configuration
     * @return the {@link ProtocolChain} configuration
     */
    @Element(required=true)
    public ProtocolChain getProtocolChain();

    /**
     * Set the {@link ProtocolChain} configuration
