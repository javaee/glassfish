...
@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterface=com.sun.appserv.management.config.JACCProviderConfig.class)
@Configured
public interface JaccProvider extends ConfigBeanProxy, Injectable  {
