...
@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterface=com.sun.appserv.management.config.AdminObjectResourceConfig.class, nameHint="jndi-name")
@Configured
public interface AdminObjectResource extends ConfigBeanProxy, Injectable, Resource {
