...
@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterfaceName="com.sun.appserv.management.config.PersistenceManagerFactoryResourceConfig", nameHint="jndi-name")
@Configured
