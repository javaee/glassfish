...
@PropertiesDesc(
    props={
        ...
        /**
            ...
            component.
            <p>
            You can set this property for a specific web application. For details, see â€œsun-web-appâ€? 
        ...
        /**
            ...
            which the custom error page should be returned in the response.<p>
            ...
            (such as Unauthorized or Forbidden) to be returned. <p>
            For example:<br>
            ...
            returned with 401 responses, along with this response line:<br>
            HTTP/1.1 401 MY-401-REASON 
            */
        @PropertyDesc(name="send-error_*",
            description="The '*' denotes a positive integer. Example: " +
            "<property name=\"send-error_1\" value=\"code=401 path=/myhost/401.html reason=MY-401-REASON\" />"),
        ...
        /**
            ...
            value of each redirect_n property has two components, which may be specified in 
            any order--
            <p>
