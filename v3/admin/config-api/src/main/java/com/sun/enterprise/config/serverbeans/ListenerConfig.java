...
//@com.sun.appserv.management.annotation.AMXConfigInfo( amxInterface=com.sun.appserv.management.config.ListenerConfig.class)
@Configured
public interface ListenerConfig extends ConfigBeanProxy, Injectable  {
