...
/*
 * $Header: /cvs/glassfish/jmx-remote/rjmx-impl/src/java/com/sun/enterprise/admin/jmx/remote/protocol/s1ashttp/ClientProvider.java,v 1.3 2005/12/25 04:26:36 tcfujii Exp $
 * $Revision: 1.3 $
 * $Date: 2005/12/25 04:26:36 $
 */

package com.sun.enterprise.admin.jmx.remote.protocol.s1ashttp;
 ...
 * always use HTTP as the transport.
...
public class ClientProvider implements JMXConnectorProvider {
    ...
    /** Creates a new instance of ClientProvider. Requires to have
	 * public constructor, because the JMXConnectorFactory will try to load
	 * this class from classpath. As of now does nothing.
	 */
