...
public class AuthRealmDeleteUserResource {
...
private static final String resourceName = "AuthRealmDeleteUser";
private static final String commandName = "delete-file-user";
private static final String commandDisplayName = "delete-user";
