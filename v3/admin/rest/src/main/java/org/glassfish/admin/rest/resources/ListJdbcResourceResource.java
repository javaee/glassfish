...
@Path("commands/create-jdbc-resource ")
@GET
...
public List<org.jvnet.hk2.config.Dom> execCreateJdbcResource(
	 @QueryParam("connectionpoolid")  @DefaultValue("")  String Connectionpoolid 
 ,
 ...
 ,
	...
	p.put("connectionpoolid", Connectionpoolid);
	...
	cr.doCommand("create-jdbc-resource", p, ar);
