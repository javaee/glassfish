...
public class GeneratorResource {
    ...
    private static String ConfigBeansToCommandResourcesMap[][] = {
        ...
        {"Profiler", "delete-profiler", "DELETE", "delete-profiler", "Delete Profiler", "id=$parent"},
    ...
    public String get() {
        ...
        File loc = new File(GENERATOR_OUTPUT_DIR);
        loc.mkdirs();
    ...
    public void generateList(ConfigModel model) throws IOException {
        ...
        out.write("import org.glassfish.admin.rest.resources.TemplateListOfResource;\n");
    ...
    public void generateSingle(ConfigModel model) throws IOException {
        ...
        if (beanName.equals("Domain")) {
            ...
            out.write("public class " + beanName + "Resource extends org.glassfish.admin.rest.resources.GlassFishDomainResource {\n\n");
        } else {
...
//                }
    ...
    private void createCommandResourceFile(String commandResourceFileName,
        ...
        if (commandMethod.equals("GET")) {
            //get method
            out.write("public class " + commandResourceName + " extends org.glassfish.admin.rest.resources.TemplateCommandGetResource {\n");
        }
        if (commandMethod.equals("DELETE")) {
            //get method
            out.write("public class " + commandResourceName + " extends org.glassfish.admin.rest.resources.TemplateCommandDeleteResource {\n");
        }
        if (commandMethod.equals("POST")) {
            //get method
            out.write("public class " + commandResourceName + " extends org.glassfish.admin.rest.resources.TemplateCommandPostResource {\n");
        }
    ...
    private void createCollectionLeafResourceFile(String beanName) throws IOException {
        ...
        //imports
        out.write("import org.glassfish.admin.rest.resources.CollectionLeafResource;\n\n");
