...
public class ProvidersTest extends RestTestBase {
    ...
    public void test() {
        ...
        JsonActionReporter ar = new JsonActionReporter();
        ...
        props.put("test", new ArrayList(){{ add("value1"); add("value2");}});
        props.put("test2", new ArrayList(){{
            add("value1");
            add(new HashMap() {{
                put("entry1", "value1");
                put("entry2", new Long(1000));
                put("entry3", new HashMap(){{ put ("foo", new ArrayList() {{ add ("bar"); add (new BigDecimal(1000));}}); }} );
            }});
        }});
        ...
        ActionReportResult result = new ActionReportResult("test", ar, new OptionsResult());

        System.out.println(provider.getContent(result));
    }
