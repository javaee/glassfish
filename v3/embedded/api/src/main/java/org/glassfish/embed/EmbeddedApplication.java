...
public final class EmbeddedApplication {
    private final EmbeddedServer owner;
    private final ApplicationInfo app;
    private final DeploymentContext deploymentContext;

    public EmbeddedApplication(EmbeddedServer owner, ApplicationInfo app, DeploymentContext deploymentContext) {
        this.owner = owner;
        this.app = app;
     ...
     */
    public EmbeddedServer getOwner() {
        return owner;
    }
