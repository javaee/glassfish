 ...
 * @version 
 */
public class ResourceEnvRefNode extends RuntimeDescriptorNode {
	...
	appendTextChild(ejbRef, RuntimeTagNames.RESOURCE_ENV_REF_NAME, descriptor.getResourceEnvRefName());
