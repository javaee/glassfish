...
import delegate.MessagePolicyDelegate;
 ...
 * @author Ron Monzillo
 */
public class ServletAuthConfigProvider extends JAASAuthConfigProvider {
    ...
    public ServletAuthConfigProvider(Map properties, AuthConfigFactory factory) {
