...
public final class FileRealm extends IASRealm
{
    ...
    private static final String instanceRoot = Globals.getDefaultHabitat().getComponent(ServerEnvironment.class).getInstanceRoot().getAbsolutePath();
    ...
    private void loadKeyFile() throws BadRealmException
    {
        ...
        if ((file != null) && !filePath.exists()) {
            try {
                if (file.startsWith(instanceRoot)) {
