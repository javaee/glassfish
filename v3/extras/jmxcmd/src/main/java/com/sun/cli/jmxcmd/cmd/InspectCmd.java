...
public class InspectCmd extends JMXCmd
{
	...
	"--java			 produce a java class as output\n" +
	"";



		public	InspectCmdHelp()	{ super( getCmdInfos() ); }
		
		
		public String	getSynopsis()	{	return( formSynopsis( SYNOPSIS ) ); }
		public String	getText()		{	return( INSPECT_TEXT ); }
	}
		public CmdHelp
	getHelp()
	{
	...
	private final static OptionInfo JAVA_OPTION			= new OptionInfoImpl( "java", "j" );
	...
	static
	{
		...
		JAVA_OPTION.addDependency(
			new DisallowedOptionDependency( ALL_OPTION, ATTRIBUTES_OPTION, OPERATIONS_OPTION  ) );
	}
		...
		throws Exception
	{
		...
		request.includeMBeanInfo	= mShowJava;
		...
		throws Exception
	{
		...
		mShowJava	= getBoolean( JAVA_OPTION.getShortName(), Boolean.FALSE ).booleanValue();
