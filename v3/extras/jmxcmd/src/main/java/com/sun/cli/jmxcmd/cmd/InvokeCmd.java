...
import com.sun.cli.jcmd.framework.InvalidCommandException;
...
public class InvokeCmd extends JMXCmd
{
	...
	static final class InvokeCmdHelp extends CmdHelpImpl
	{
		...
		public	InvokeCmdHelp()	{ super( getCmdInfos() ); }
		
		
		public String	getName()		{	return( InvokeCmd.FORMAL_NAME ); }
		public String[]	getNames()		{	return( new String[] { getName(), "<mbean-operation>(...)" } ); }
		public String	getSynopsis()	{	return( formSynopsis( SYNOPSIS ) ); }
		public String	getSyntax()		{	return( INVOKE_SYNTAX ); }
		public String	getText()		{	return( INVOKE_TEXT ); }
	}
	 ...
	 */
		InvokeInfo
	getInvokeInfo( final String cmdString )
		throws IllegalUsageException, WrongNumberOfOperandsException, CmdNotFoundException
	{
		...
		else if ( dotIndex >= 1 )
		{
			...
			invokeInfo.targets			= new String[] { operationPortion.substring( 0, dotIndex ) };
		}
		else
		{
