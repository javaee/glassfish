...
public class CmdMgrImpl implements CmdMgr, CmdEventListener
{
	...
	{
			public
		MyCmdOutput( CmdEnv env, PrintStream output, PrintStream errorOutput )
		{
	 ...
	 */
		public
	CmdMgrImpl( final Map	metaOptions )
		throws Exception
	{
	...
	{
			public
		CmdMgrImplUnknownCmdClassGetter()
		{
		}
	...
	getPrompt()
	{
		...
		protected void
	handleInteractive( String greeting )
	{
	...
	private class MyCmdRunnerHook implements CmdRunner.Hook
	{
		private MyCmdRunnerHook()	{}
			...
			public void
		preExecute( String cmdName, String[] tokens )
		{
			// ignore
		}
		
			public void
		postExecute( String cmdName, String[] tokens, int errorCode)
		{
			if ( errorCode != 0 )
			{
	...
	initCmds() throws Exception
	{
		...
		protected int
	handleSingle( final String [] args )
		throws Exception
	{
	...
	getCmdHistory()
	{
		...
		protected void
	executeStartupScript( String theFile )
		throws Exception
	{
		// execute the 'source' command on theFile
		handleSingle( new String[] { "source", theFile } );
	}
