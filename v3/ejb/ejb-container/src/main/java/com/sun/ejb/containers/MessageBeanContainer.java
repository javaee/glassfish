    ...
    implements MessageBeanProtocolManager, MessageDrivenBeanStatsProvider
{
    private static final Logger _logger =
        LogDomains.getLogger(MessageBeanContainer.class, LogDomains.MDB_LOGGER);
    ...
    private void createMessageBeanPool(EjbMessageBeanDescriptor descriptor) {
        ...
        MdbContainer mdbc = ejbContainerUtilImpl.getDefaultHabitat().getComponent(MdbContainer.class);
     ...
     *
     * We use the EjbInvocation manager's thread-specific state
