 ...
 * holder.
 */
package org.glassfish.ejb.admin.monitor.config;
 ...
 */
@Service
public class EjbContainerConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = ContainerMonitoring.LEVEL_OFF;
    private String name = ContainerMonitoring.EJB_CONTAINER;
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        ContainerMonitoring newItem = param.createChild(
                            org.glassfish.ejb.admin.monitor.config.EjbContainerMI.class);
