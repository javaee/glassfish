...
/**
 * Holds the configuration parameters for the main or root server for 
 * synchronization.
...
public class MainServerConfig {
	...
	public MainServerConfig(Element config) {
		NodeList nodelist;
		Element e;
		nodelist = config.getElementsByTagName("base_dir");
		e = (Element)nodelist.item(0);
		base_dir = FileUtils.formatPath(e.getTextContent());
	}
	public MainServerConfig(String base) {
		base_dir = base;
	}
}
