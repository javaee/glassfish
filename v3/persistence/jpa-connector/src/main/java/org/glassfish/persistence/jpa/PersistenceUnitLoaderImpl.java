...
public class PersistenceUnitLoaderImpl implements PersistenceUnitLoader {
    ...
    PersistenceUnitLoaderImpl(ApplicationInfo appInfo) {
     ...
     */
    public void load() {
        String applicationLocation = appInfo.getApplicationLocation();
    ...
    private void load(PersistenceUnitDescriptor pud) {
        ...
        PersistenceUnitInfo pInfo = new PersistenceUnitInfoImpl(pud, appInfo);
        if(logger.isLoggable(Level.FINE)) {
        ...
        try {
            ...
            provider =
                    ...
                    ClassLoader.class.cast(appInfo.getClassLoader())
