                ...
                for (PersistenceUnitsDescriptor persistenceUnitsDescriptor : pusDescriptorForThisBundle) {
                    for (PersistenceUnitDescriptor pud : persistenceUnitsDescriptor.getPersistenceUnitDescriptors()) {
                        if(referencedPus.contains(pud)) {
                            ProviderContainerContractInfo providerContainerContractInfo = processEnvironment.getProcessType().isEmbedded() ?
                                    new EmbeddedProviderContainerContractInfo(context, connectorRuntime, habitat) :
                                    new ServerProviderContainerContractInfo(context, connectorRuntime);
