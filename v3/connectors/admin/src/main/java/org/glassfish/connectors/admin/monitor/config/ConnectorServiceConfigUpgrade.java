 ...
 */
@Service
public class ConnectorServiceConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = ContainerMonitoring.LEVEL_OFF;
    private String name = ContainerMonitoring.CONNECTOR_SERVICE;
    ...
    public void postConstruct() {
        try {
            ...
            if (mmls != null) {
                level = mmls.getConnectorService();
            }
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        ContainerMonitoring newItem = param.createChild(
                            org.glassfish.connectors.admin.monitor.config.ConnectorServiceMI.class);
