 ...
 *
 * @see org.glassfish.ha.store.spi.BackingStore
 */
public final class BackingStoreRegistry {
     ...
     * 
     * @see BackingStoreFactory#createBackingStore(String, Class, Class, Properties)
     */
     ...
     * then an instance is created using the public no-arg constructor.
     * 
     * @param type
