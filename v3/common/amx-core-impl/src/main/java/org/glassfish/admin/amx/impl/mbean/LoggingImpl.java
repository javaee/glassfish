...
//implements /*Logging,*/ LoggingImplHook
{
    ...
    private static synchronized MBeanNotificationInfo[] getSelfNotificationInfos()
    {
        if (SELF_NOTIFICATION_INFOS == null)
        {
            ...
            SELF_NOTIFICATION_INFOS = new MBeanNotificationInfo[]
                    {
                        selfInfo
                    };
        }
    ...
    public synchronized String getLogFile(final String key, final String fileName)
    {
        unimplemented();
    ...
    public String[] getDiagnosticCauses(final String messageID)
    {
        unimplemented();
    ...
    public String[] getDiagnosticChecks(final String messageID)
    {
        unimplemented();
