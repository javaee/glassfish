...
public interface TestDummyMBean extends NotificationEmitter
{
	...
	/**
	    Emit the specified number of Notifications.
	    
	    @return number of milliseconds it took to emit all of them.
	 */
	public long     emitNotifications( final String notifType,
	                    final int howMany );
}
