...
/*
 * $Header: /cvs/glassfish/appserv-api/src/java/com/sun/appserv/management/config/KeepAliveConfigKeys.java,v 1.2 2007/05/05 05:30:34 tcfujii Exp $
 * $Revision: 1.2 $
...
/**
	Keys for use with {@link HTTPServiceConfig#createKeepAliveConfig}
	
	All Map values associated with a key are of class java.lang.String
	unless otherwise documented.
 */
public final class KeepAliveConfigKeys	// note should be named KeepAliveConfigKeys
{
