...
public final class JMXUtil
{
	...
	isGetter( final MBeanOperationInfo info )
	{
		...
		public static Set<MBeanOperationInfo>
	findOperations(
    ...
    getAttribute(final MBeanServerConnection conn, final ObjectName o, final String attrName )
    {
        try
        {
    ...
    public static String toString( final MBeanAttributeInfo info, final int indent )
    {
        ...
        if ( info.isWritable() ) rw = rw + "W";
        if ( info.isIs() ) rw = rw + ",is";
