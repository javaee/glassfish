...
/**
    Exists to resolve any values provided by {@link AMXConfigInfo} into usable values eg classname.
 */
public final class AMXConfigInfoResolver
{
    ...
    amxInterface()
    {
        final String classname = mAMXConfigInfo.amxInterfaceName();
        
        Class<? extends AMXConfig>   theInterface = null;
    ...
    {
        return "AMXConfigInfoResolver for: " + mAMXConfigInfo;
    }
}
