...
public final class AMXCounterMonitorImpl extends JMXMonitorBase
	// implements AMXCounterMonitor
{
	/**
	 */
	AMXCounterMonitorImpl()
	{
        super( new CounterMonitor(), AMXCounterMonitor.J2EE_TYPE, AMXCounterMonitor.J2EE_TYPE, ObjectNames.getInstance().getDomainRootObjectName(), AMXCounterMonitor.class, null );
	}
