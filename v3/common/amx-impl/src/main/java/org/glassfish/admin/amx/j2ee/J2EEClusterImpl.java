	...
	extends J2EELogicalServerImplBase 
{
	...
	{
		super( J2EECluster.J2EE_TYPE, fullType, parentObjectName, J2EECluster.class, delegate );
	}
	...
	getstate()
	{
		...
		//int state = rsl.anyRunning() ?  StateManageable.STATE_RUNNING : StateManageable.STATE_STOPPED;
