 ...
 */
public final class AvailabilityServiceConfigImpl  extends AMXConfigImplBase
	implements ConfigFactoryCallback
	// implements AvailabilityServiceConfig
{
	    public
	AvailabilityServiceConfigImpl( final Delegate delegate )
	{
		super( delegate );
	}  
	...
	addCustomMappings( final AMXAttributeNameMapper mapper ) 
	{
		 ...
		 mapper.matchName( "HAStoreHealthcheckIntervalSeconds",
		    "ha-store-healthcheck-interval-in-seconds",	"HAStoreHealthcheckIntervalInSeconds" );
  	}
