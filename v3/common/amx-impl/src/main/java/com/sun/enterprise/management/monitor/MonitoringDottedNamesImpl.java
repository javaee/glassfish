...
public final class MonitoringDottedNamesImpl  extends DottedNamesBase
	implements DottedNames
{
		public
	MonitoringDottedNamesImpl( )
	{
	}
	...
	{
		return( getOldDottedNames().dottedNameMonitoringGet( names ) );
	}
	
		public Object
	dottedNameGet( String name )
	{
		return( getOldDottedNames().dottedNameMonitoringGet( name ) );
	}
	
		public Object[]
	dottedNameList( String[] names )
	{
		return( getOldDottedNames().dottedNameMonitoringList( names ) );
	}
	
		public Object[]
	dottedNameSet( String[] nameValuePairs )
	{
		throw new IllegalArgumentException( StringUtil.toString( nameValuePairs ) );
	}
