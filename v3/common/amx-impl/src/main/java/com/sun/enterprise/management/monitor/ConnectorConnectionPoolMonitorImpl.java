...
public class ConnectorConnectionPoolMonitorImpl extends MonitoringStatsImplBase
// implements ConnectorConnectionPoolMonitor
{
		public
	ConnectorConnectionPoolMonitorImpl(Delegate delegate) 
	{
		super( ConnectorConnectionPoolMonitor.J2EE_TYPE, delegate );
	}
	
		protected Class
	getStatsInterface()
	{
		return( ConnectorConnectionPoolStats.class );
	}  
	
		public ConnectorConnectionPoolStats
	getConnectorConnectionPoolStats()
	{
		return (ConnectorConnectionPoolStats)getStats();
	}  
