...
public class JDBCConnectionPoolMonitorImpl
	extends MonitoringStatsImplBase
	// implements JDBCConnectionPoolMonitor
{
	public JDBCConnectionPoolMonitorImpl(Delegate delegate) 
	{
		super( XTypes.JDBC_CONNECTION_POOL_MONITOR, delegate );
	}
	
		protected Class
	getStatsInterface()
	{
		return( AltJDBCConnectionPoolStats.class );
	} 
	
	/**
		Deprecated.
	 */
		public AltJDBCConnectionPoolStats
	getJDBCConnectionPoolStats()
	{
		return getAltJDBCConnectionPoolStats();
	}
	
		public AltJDBCConnectionPoolStats
	getAltJDBCConnectionPoolStats()
	{
		return( (AltJDBCConnectionPoolStats)getStats() );
	}
