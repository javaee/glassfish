...
public final class ConnectorConnectionPoolConfigImpl
	extends AMXConfigImplBase
	implements ConfigFactoryCallback
	// implements ConnectorConnectionPoolConfig
{
		public
	ConnectorConnectionPoolConfigImpl( final Delegate delegate )
	{
		super( delegate );
	}
	...
	addCustomMappings( final AMXAttributeNameMapper mapper )
	{
		...
		mapper.matchName( "ConnectionValidationRequired", "IsConnectionValidationRequired");
	}
