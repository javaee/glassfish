...
// 		@return A proxy to the  CustomResource MBean.
// 	 */
// 	public CustomResource createCustomResourceConfig( String jndiName,
// 	                                            String resType,
// 	                                            String factoryClass,
...
// 		@param factoryClass
// 		@param optional optional Attributes (may be null )
// 		@return a JNDIResource
// 	*/
// 	public JNDIResource       createJNDIResourceConfig(
//                                     String    jndiName,
...
// 		@param jndiName
// 		@param optional optional Attributes (may be null )
// 		@return A proxy to the PersistenceManagerFactoryResource MBean that
...
// 		@param poolName
// 		@param optional optional Attributes (may be null )
// 		@return	A proxy to the JDBCResource MBean that manages the newly
// 		created jdbc-resource.
// 	*/
// 	public JDBCResource	createJDBCResourceConfig( String jndiName,
//                                 String poolName,
//                                 Map<String,String> optional );
//         
// 	/**     
...
//         "databasePassword",
//         "reserved"})
// 	public JDBCConnectionPool	createJDBCConnectionPoolConfig(
//                             String name,
...
// 	*/
//     
// 	public JDBCConnectionPool       createJDBCConnectionPoolConfig(  String name,
...
// 	*/
// 	public ConnectorResource createConnectorResourceConfig( String   jndiName,
//                            String   poolName,
//                            Map<String,String> optional );
// 	
//         
...
// 	@param optional
// 	@return A proxy to the ConnectorConnectionPool MBean
// 	that manages the newly created connector-connection-pool element.
// 	@see ConnectorConnectionPoolConfigKeys
// 	*/
// 	public ConnectorConnectionPool createConnectorConnectionPoolConfig( String	name,
...
// 		@param optional optional Attributes (may be null )
// 		@return			A proxy to the AdminObjectResource MBean.
// 	 */
// 	public AdminObjectResource	createAdminObjectResourceConfig( String jndiName,
//                                String resType,
//                                String resAdapter,
//                                Map<String,String> optional );
// 	
...
// 		</ul>
// 	 */
// 	public ResourceAdapter	createResourceAdapterConfig( String resourceAdapterName, Map<String,String> optional );
//     
...
// 		@param from
// 		@param optional
// 		@return A  MailResource.
// 		@see MailResourceConfigKeys
// 	*/
// 	public MailResource	createMailResourceConfig(
//                         String          jndiName,
// 	                    String          host,
// 	                    String          user,
// 	                    String          from,
