...
// 		@see org.glassfish.admin.amx.intf.config.EJBContainerAvailabilityConfigKeys
// 	 */
...
// 		@see org.glassfish.admin.amx.intf.config.WebContainerAvailabilityConfigKeys
// 	 */
...
// 	void removeWebContainerAvailability();
	 ...
	 */
	EJBContainerAvailabilityConfig		getEJBContainerAvailability();

	/**
		Get the WebContainerAvailabilityConfig MBean.
	 */
	WebContainerAvailabilityConfig		getWebContainerAvailability();
	...
	* @since AppServer 9.0
	...
	public JMSAvailabilityConfig    getJMSAvailability();
