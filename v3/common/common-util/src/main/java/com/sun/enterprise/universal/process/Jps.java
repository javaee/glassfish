...
/*
 * JPS class: http://www.docjar.com/docs/api/sun/tools/jps/Jps.html
 Sample output
 *
 C:\dev\jdk>jps -lm
728 org/netbeans/Main --branding nb
2080 com.sun.enterprise.admin.cli.ASWatchdog start-domain domain1
1504 com.sun.enterprise.glassfish.bootstrap.ASMain -domainname domain1 -instancename server -watchdog true -verbose false -de
se -domaindir C:/glassfish/domains/domain1
2892 sun.tools.jps.Jps -lm
 *
 */
