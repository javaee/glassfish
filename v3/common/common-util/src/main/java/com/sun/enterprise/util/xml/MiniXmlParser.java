...
package com.sun.enterprise.util.xml;
...
/**
 * A fairly simple but very specific stax XML Parser. Give it the location of 
 * domain.xml and the name of the server instance and it will return JVM options.
