...
public interface Virtualization extends ConfigBeanProxy {
     ...
     */
    @Element()
    @Create(value="add-template", resolver = VirtResolver.class, decorator = Template.TemplateAddDecorator.class, i18n = @I18n("org.glassfish.vmcluster.add-template"))
    @Listing(value = "list-templates", resolver = VirtResolver.class, i18n = @I18n("org.glassfish.vmcluster.list-templates"))
    @Delete(value="remove-template", resolver = TypeAndNameResolver.class, i18n = @I18n("org.glassfish.vmcluster.remove-template"))
