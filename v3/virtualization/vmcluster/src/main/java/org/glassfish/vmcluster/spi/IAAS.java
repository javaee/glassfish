...
public interface IAAS extends Iterable<Group> {
     ...
     */
    VMResponse allocate(Template template, VMOrder order) throws VirtException;
     ...
     * @throws VirtException when the virtual machine creation failed.
     */
    VMResponse allocate(AllocationStrategy strategy, Template template, VMOrder order) throws VirtException;
}
