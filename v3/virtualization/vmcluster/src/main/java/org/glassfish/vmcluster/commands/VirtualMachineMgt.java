...
/**
 * super class for all commands related to virtual machines management
 */
abstract class VirtualMachineMgt extends MachineMgt {
    ...
    void doWork(Machine machine) throws VirtException {
        ...
        VirtualMachine vm = machine.byName(vmName);
        if (vm==null) {
            report.failure(Logger.getAnonymousLogger(), "Don't know about machine " + vmName);
            return;
        }
        doWork(vm);
    }
