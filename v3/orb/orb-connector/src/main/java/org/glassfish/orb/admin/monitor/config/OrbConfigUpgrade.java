 ...
 * holder.
 */
package org.glassfish.orb.admin.monitor.config;
 ...
 */
@Service
public class OrbConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = MonitoringItem.LEVEL_OFF;
    private String name = MonitoringItem.ORB;
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        MonitoringItem newItem = param.createChild(
                            org.glassfish.orb.admin.monitor.config.OrbMI.class);
