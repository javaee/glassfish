...
package org.glassfish.webbeans.jsf;
    ...
    public WebBeansApplication(Application application) {
        ...
        if (beanManager != null) {
            application.addELContextListener(Util.<ELContextListener>newInstance(
                "org.jboss.webbeans.el.WebBeansELContextListener"));
