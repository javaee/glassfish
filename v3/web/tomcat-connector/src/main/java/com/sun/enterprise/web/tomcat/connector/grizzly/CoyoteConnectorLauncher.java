 ...
 * holder.
 */
package com.sun.enterprise.web.tomcat.connector.grizzly;
...
*/
    ...
    static class MXPoolListener implements ThreadPool.ThreadPoolListener {
        MXPoolListener( CoyoteConnectorLauncher proto, ThreadPool control  ) {
        ...
        public void threadEnd(ThreadPool tp, Thread t) {
            ...
            ObjectName oname=(ObjectName)tpData[CoyoteConnectorLauncher.THREAD_DATA_OBJECT_NAME];
            if( oname==null ) return;
            Registry.getRegistry().unregisterComponent(oname);
            CoyoteProcessor processor = 
                (CoyoteProcessor) tpData[CoyoteConnectorLauncher.THREAD_DATA_PROCESSOR];
    ...
    static class Http11ConnectionHandler implements TcpConnectionHandler {
        CoyoteConnectorLauncher proto;
        static int count=0;
        RequestGroupInfo global=new RequestGroupInfo();

        Http11ConnectionHandler( CoyoteConnectorLauncher proto  ) {
            this.proto=proto;
        }
        ...
        public Object[] init() {
            ...
            CoyoteProcessor  processor = 
                new CoyoteProcessor(proto.maxHttpHeaderSize);
            ...
            thData[CoyoteConnectorLauncher.THREAD_DATA_PROCESSOR]=processor;
        ...
        public void processConnection(TcpConnection connection,
				      Object thData[]) {
            Socket socket=null;
            CoyoteProcessor  processor=null;
            try {
                processor=(CoyoteProcessor)thData[CoyoteConnectorLauncher.THREAD_DATA_PROCESSOR];
