...
public class BaseModelMBean implements ModelMBean, MBeanRegistration {
    ...
    public BaseModelMBean(ModelMBeanInfo info)
        ...
        if (log.isLoggable(Level.FINE))
            log.fine("ModelMBeanInfo constructor");
    }
        ...
        throws MBeanException, RuntimeOperationsException
    {
        try {
            ...
            log.log(Level.SEVERE, "Error creating mbean ", ex);
        }
    }
        ...
        throws MBeanException, ReflectionException 
    {
        ...
        try {
            ...
            Throwable t = e.getTargetException();
            log.log(Level.SEVERE,"Exception invoking method " + name , t );
            if (t == null)
                t = e;
            if (t instanceof RuntimeException)
                throw new RuntimeOperationsException
            ...
            log.log(Level.SEVERE,"Exception invoking method " + name , e );
            throw new MBeanException
                (e, "Exception invoking method " + name);
        }
    ...
    {
        if (log.isLoggable(Level.FINE))
            log.fine("Setting attribute " + this + " " + attribute );
        if( (resource instanceof DynamicMBean) && 
             ! ( resource instanceof BaseModelMBean )) {
            try {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Error sending notification " + name, ex );
        }
        ...
        if( m==null ) {
            ...
            if( m== null && resource != null ) {
                try {
                    ...
                    if (log.isLoggable(Level.FINE))
                        log.fine("Method not found in resource " +resource);
                    exception = e;
                }
            }
            if( exception != null )
        ...
        MBeanException, RuntimeOperationsException
    {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Can't set model mbean ", t );
        }
    }
    ...
    public void addAttributeChangeNotificationListener
        ...
        if (log.isLoggable(Level.FINE))
            log.fine("addAttributeNotificationListener " + listener);
    ...
    public void sendAttributeChangeNotification
        ...
        if (log.isLoggable(Level.FINE))
            log.fine("AttributeChangeNotification " + notification );
    ...
    public void addNotificationListener(NotificationListener listener,
        ...
        if (log.isLoggable(Level.FINE))
            log.fine("addNotificationListener " + listener);
        if (generalBroadcaster == null)
    ...
    protected void initModelInfo( String type ) {
        try {
            ...
            log.log(Level.SEVERE, "TCL: " + Thread.currentThread().getContextClassLoader(),
                    ex);
        }
    }
    ...
    protected void createResource() {
        try {
            ...
            try {
                ...
                log.log(Level.SEVERE, "Error creating class " + t);
            }
        } catch( Throwable ex) {
            log.log(Level.SEVERE, "TCL: " + Thread.currentThread().getContextClassLoader(),
                    ex);
    ...
    {
        if (log.isLoggable(Level.FINE))
            log.fine("preRegister " + resource + " " + name );
        oname=name;
