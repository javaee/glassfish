 ...
 * holder.
 */
package org.glassfish.web.admin.monitor.config;
 ...
 */
@Service
public class WebContainerConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = ContainerMonitoring.LEVEL_OFF;
    private String name = ContainerMonitoring.WEB_CONTAINER;
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        ContainerMonitoring newItem = param.createChild(
                            org.glassfish.web.admin.monitor.config.WebContainerMI.class);
