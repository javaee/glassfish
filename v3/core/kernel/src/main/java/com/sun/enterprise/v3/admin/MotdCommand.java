...
@I18n("motd")
public class MotdCommand implements AdminCommand {
    @Inject
    ...
    public void execute(AdminCommandContext context) {
        ...
        report.setMessage("MOTD!!!"); 
    }
    final private static LocalStringManagerImpl localStrings = new LocalStringManagerImpl(MotdCommand.class);
}
