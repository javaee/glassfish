...
/*V3:Commented import com.sun.ejb.Container;
...
/*TODO:V3 commented, and added local copy of PipeConstants, uncomment this
 * once V3 workspace has this class and then remove the local copy in the
 * current package.
...
public class PipeHelper extends ConfigHelper {
    ...
    public void authorize(Packet request) throws Exception {
        ...
        /*V3:Commented : TODO fix this later
	...
	if (isEjbEndpoint) {
		...
		inv.setWebServiceMethod(null);
            ...
            // authorization for Serlvet WebService ?
        }
	...
	return (wSE == null ? "unknown" : wSE.getEjbComponentImpl().getName());
     ...
     public String getRealm(Map map) {
        String realmName = null;
        WebServiceEndpoint wSE = (WebServiceEndpoint)
                map.get(PipeConstants.SERVICE_ENDPOINT);
        if (wSE != null) {
