 ...
 */
@Service
public class JdbcConnectionPoolConfigUpgrade implements ConfigurationUpgrade, PostConstruct {

    @Inject
    MonitoringService ms;

    private String level = ContainerMonitoring.LEVEL_OFF;
    private String name = ContainerMonitoring.JDBC_CONNECTION_POOL;
    ...
    public void postConstruct() {
        try {
            ...
            if (mmls != null) {
                level = mmls.getJdbcConnectionPool();
            }
                ...
                ConfigSupport.apply(new SingleConfigCode<MonitoringService>() {
                    ...
                    throws PropertyVetoException, TransactionFailure {
                        ContainerMonitoring newItem = param.createChild(
                            org.glassfish.jdbc.admin.monitor.config.JdbcConnectionPoolMI.class);
