 ...
 *
 */
public class ProxiableInterfaceModule implements TestModule {
    ...
    public void configure(DynamicConfiguration config) {
        config.bind(BuilderHelper.createDescriptorFromClass(ProxiableSingletonContext.class));
        
        config.bind(BuilderHelper.link(PlanetFactory.class.getName()).
                to(Planet.class.getName()).
