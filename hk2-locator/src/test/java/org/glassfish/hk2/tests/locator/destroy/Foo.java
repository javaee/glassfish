 ...
 * annotation version of the postConstruct
 * 
 * @author jwells
 *
 */
public class Foo implements PreDestroy {
    @Inject
    ...
    @PostConstruct
    public void alternatePostConstruct() {
        if (bar == null) throw new AssertionError("bar is null in " + this);
