 ...
 * that would fix it will ALSO not be resolvable.  We will then fix the JIT resolver and then
 * we should be able to get this service too.
 * 
 * @author jwells
 *
 */
@Singleton
public class DoubleTroubleService {
    @Inject
