 ...
 *
 */
public class MethodOnlyInjectedService {
    private final SimpleService injectedViaConstructor;
    private SimpleService injectedViaMethod;
    
    public MethodOnlyInjectedService() {
        injectedViaConstructor = null;
    }
    
    
    public MethodOnlyInjectedService(@MethodParameterInjectionPoint SimpleService ss) {
        injectedViaConstructor = ss;
    }
    
    public void setViaMethod(@MethodParameterInjectionPoint SimpleService ss) {
