...
public class UnitedStates {
    ...
    @Inject
    private void setUSMethodTracker(TrackerService methodTracker) {
        this.methodTracker = methodTracker;
    }
    
    public TrackerService getUSFieldTracker() {
        return fieldTracker;
    }
    
    public TrackerService getUSMethodTracker() {
    ...
    public TrackerService getUSOverridenButPrivateMethodTracker() {
        return overriddenButPrivate;
    }
    
    public TrackerService getUSOverridenPublicMethodTracker() {
