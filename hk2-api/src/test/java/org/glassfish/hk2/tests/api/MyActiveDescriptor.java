 ...
 * 
 * @author jwells
 * @param <T> They type of this descriptor
 */
public class MyActiveDescriptor<T> extends AbstractActiveDescriptor<T> {

    /**
     * For serialization
     */
    private static final long serialVersionUID = -5002947020251179636L;
