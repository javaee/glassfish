...
public class JVMMemoryAlertConfig
    ...
    public String getType() {
        return "jvm_memory";  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public String getSchedule() {
        return "10s";  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    @Override
    public void setAlertActions(AlertActions alertActions) {
        //To change body of implemented methods use File | Settings | File Templates.
    }
