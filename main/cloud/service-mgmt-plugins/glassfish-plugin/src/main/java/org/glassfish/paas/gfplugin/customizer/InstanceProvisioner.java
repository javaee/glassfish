...
/**
 * Provisions the GlassFish instances.
 *
...
public class InstanceProvisioner implements GlassFishPluginConstants {
    ...
    public void provision(GlassFishProvisionedService das, ProvisionedService... instances) {
        ...
        if (NATIVE_VIRTUALIZATION.equalsIgnoreCase(virtType)) {
            localInstanceProvisioner.provision(das, instances);
        } else {
            remoteInstanceProvisioner.provision(das, instances);
        }
    }
