...
public final class GlassFishConfigBean extends ConfigBean {
    ...
    public <T extends ConfigBeanProxy> T createProxy(Class<T> proxyType) {
        TranslatedConfigView.setHabitat((BaseServiceLocator) serviceLocator);
        if (defaultView==null) {
    ...
    public void initializationCompleted() {
        ...
        for (ConfigBeanListener listener : serviceLocator.<ConfigBeanListener>getAllServices(ConfigBeanListener.class)) {
