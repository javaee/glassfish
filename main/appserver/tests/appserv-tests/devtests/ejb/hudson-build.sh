...
# download specific GF build
echo using build  http://gf-hudson.us.oracle.com/hudson/job/gf-trunk-build-continuous/${1}/artifact/bundles/glassfish.zip
wget --no-proxy http://gf-hudson.us.oracle.com/hudson/job/gf-trunk-build-continuous/${1}/artifact/bundles/glassfish.zip
