 ...
 * <code>InflowContext</code>s associated with a <code>Work</code>
 * instance. This interface may be implemented by a <code>InflowContext</code>
 * instance to receive notifications from the <code>WorkManager</code> when
 * the <code>InflowContext</code> is set as the execution context of the
 ...
 * <code>InflowContextProvider</code>, the <code>WorkManager</code> must
 * make the relevant lifecycle notifications if an <code>InflowContext</code>
 ...
 * <code>WorkListener</code> and <code>InflowContext</code> setup related
 * notifications to this interface.
 * <p>
 * 
 * The possible error conditions that might occur during associating an
 * <code>InflowContext</code> with a <code>Work</code> instance is captured
 * in {@link InflowContextErrorCodes}.
 * <p>
 * 
 * @since 1.6
...
public interface InflowContextLifecycleListener {
    ...
    /**
     * Invoked when the <code>InflowContext</code> instance was successfully
    ...
    /**
     * Invoked when the <code>InflowContext</code> instance was set as the
     * execution context for the <code>Work</code> instance it was associated
     * with.
     * 
     * @param errorCode
     *            One of the error-codes defined in or subclasses of
     *            {@link InflowContextErrorCodes InflowContextErrorCodes}
     * @since 1.6
     * @see InflowContextErrorCodes
     */
