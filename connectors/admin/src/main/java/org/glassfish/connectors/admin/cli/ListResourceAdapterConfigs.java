    ...
    public void execute(AdminCommandContext context) {
        ...
        try {
            ...
            for (ResourceAdapterConfig r : resources) {
                list.add(r.getResourceAdapterName());
            }
            if (list.isEmpty()) {
            ...
            report.setMessage(localStrings.getLocalString("list.resource.adapter.config.fail",
                    "Unable to list resource adapter configs") + " " + e.getLocalizedMessage());
