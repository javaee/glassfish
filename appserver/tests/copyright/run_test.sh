...
copyright_run(){
  ...
  echo $WORKSPACE
	...
	mvn -e -s $MAVEN_SETTINGS -Dmaven.repo.local=$MAVEN_REPO --quiet -Dcopyright.normalize=true org.glassfish.copyright:glassfish-copyright-maven-plugin:copyright | tee $WORKSPACE/copyright-files-temp-open.txt
