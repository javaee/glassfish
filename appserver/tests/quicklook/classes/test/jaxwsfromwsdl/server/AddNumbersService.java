 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "http://example.org", wsdlLocation = "file:/space/gf/github/glassfish/yamini-glassfish/glassfish/appserver/tests/quicklook/wsit/JaxwsFromWsdl/etc/AddNumbers.wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADDNUMBERSSERVICE_QNAME = new QName("http://example.org", "AddNumbersService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/space/gf/github/glassfish/yamini-glassfish/glassfish/appserver/tests/quicklook/wsit/JaxwsFromWsdl/etc/AddNumbers.wsdl");
    ...
    public AddNumbersPortType getAddNumbersPort() {
        return super.getPort(new QName("http://example.org", "AddNumbersPort"), AddNumbersPortType.class);
    }
    ...
    public AddNumbersPortType getAddNumbersPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org", "AddNumbersPort"), AddNumbersPortType.class, features);
    }
