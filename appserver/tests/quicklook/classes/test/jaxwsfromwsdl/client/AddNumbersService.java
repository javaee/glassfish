 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "http://example.org", wsdlLocation = "http://localhost:8080/JaxwsFromWsdl/addnumbers?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/JaxwsFromWsdl/addnumbers?wsdl");
