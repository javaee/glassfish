...
list_test_ids(){
  echo connector_all connector_group_1 connector_group_2 connector_group_3 connector_group_4 connector_group_5 connector_group_6 connector_group_7 connector_group_8 connector_group_9
}
...
test_run(){
  ...
  time ant clean-all $TARGET report | tee $TEST_RUN_LOG
  antStatus=$?
