...
public class TypeCheckerTest {
    ...
    private Dao<Order> order = new Dao<Order>();
    private Dao<User> user = new Dao<User>();
    private Dao<?> wildCard;
    private Dao<? extends Persistent> wPersistent = new Dao<Persistent>();
    ...
    private void getTypes() throws NoSuchFieldException {
        ...
        field = clazz.getDeclaredField("userType");
    ...
    public void testClassToPT() {
        Assert.assertTrue(TypeChecker.isRawTypeSafe(userType, daoType));
        Assert.assertTrue(TypeChecker.isRawTypeSafe(orderType, daoType));
