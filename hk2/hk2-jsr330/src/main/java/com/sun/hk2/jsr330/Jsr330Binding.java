...
public interface Jsr330Binding {
  ...
  /**
   * The optional collection of contract names (interface or
   * class) to advertise the service under.
   */
  Collection<String> getContractClassNames();
  
  /**
   * The optional collection of qualifiers for this service
   * implementation.
   */
  Collection<Class<? extends Annotation>> getServiceQualifiers();

  /**
   * the optional collection of names to assign the service
   * implementation.
   */
  Collection<Named> getServiceNames();

  /**
   * The optional Scope.  The default in null == {@link PerLookup}.
   */
