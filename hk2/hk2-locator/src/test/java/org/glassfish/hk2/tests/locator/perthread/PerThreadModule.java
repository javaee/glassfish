 ...
 *
 */
public class PerThreadModule implements TestModule {
    ...
    public void configure(DynamicConfiguration config) {
        config.bind(BuilderHelper.link(ClothingStore.class.getName()).
                                  in(PerLookup.class.getName()).
                                  build());
        
        config.bind(BuilderHelper.link(Pants.class.getName()).
