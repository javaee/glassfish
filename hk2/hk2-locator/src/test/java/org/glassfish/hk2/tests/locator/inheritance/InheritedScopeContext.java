 ...
 */
@Singleton
public class InheritedScopeContext implements Context<InheritedScope> {
    private final List<Object> seen = new LinkedList<Object>();
    
    /* package */ List<Object> getSeen() {
        return seen;
    }
