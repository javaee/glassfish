 ...
 */
@Singleton
public class Listener implements RunLevelListener {
    ...
    public void onCancelled(RunLevelFuture controller, int levelAchieved) {
        System.out.println("JRW(10) onCancelled " + levelAchieved);
    ...
    public void onError(RunLevelFuture currentJob, Throwable error) {
        System.out.println("JRW(20) onError " + error);
    ...
    public void onProgress(RunLevelFuture currentJob, int levelAchieved) {
        System.out.println("JRW(30) onProgress " + levelAchieved);
