...
public class DefaultRunLevelService implements RunLevelService<Void>,
        Enableable, RunLevelState<Void>, InhabitantListener, HabitatListener,
    ...
    public DefaultRunLevelService(SimpleServiceLocator habitat, boolean async, String name,
            Class<?> targetScope, HashMap<Integer, Recorder> recorders) {
        ...
        this.targetScope = (null == targetScope) ? RunLevelDefaultScope.class
                : targetScope;
        this.recorders = (null == recorders) ? new LinkedHashMap<Integer, Recorder>()
                : recorders;
    ...
    protected synchronized Collection<RunLevelListener> getListeners() {
        ...
        if (null == listener) {
            Collection<Inhabitant<RunLevelListener>> inhabs = 
    ...
    protected synchronized InhabitantSorter getInhabitantSorter() {
        ...
        Collection<Inhabitant<InhabitantSorter>> inhabs = 
            habitat.getInhabitantsByContract(InhabitantSorter.class.getName());
        Collection<InhabitantSorter> sorters = narrow(inhabs);
    ...
    protected synchronized InhabitantActivator getInhabitantActivator() {
        ...
        Collection<Inhabitant<InhabitantActivator>> inhabs = 
            habitat.getInhabitantsByContract(InhabitantActivator.class.getName());
        Collection<InhabitantActivator> activators = narrow(inhabs);
    ...
    private abstract class Worker implements Runnable {
        ...
        private void activateRunLevel() {
            ...
            Collection<Inhabitant<RunLevel>> runLevelInhabitants = habitat
