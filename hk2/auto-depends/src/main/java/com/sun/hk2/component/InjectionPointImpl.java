...
/**
 * Default InjectionPoint implementation, using thread state data as
 * necessary.
 * 
 * @author Jeff Trent
 */
/*public*/ final class InjectionPointImpl implements InjectionPoint {
  ...
  public InjectionPointImpl(Object component, AnnotatedElement member, Class<?> type, Inject inject, Inhabitant<?> i) {
