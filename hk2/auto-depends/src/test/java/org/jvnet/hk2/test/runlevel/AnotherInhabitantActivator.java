...
@Service(metadata = RunLevel.META_SCOPE_TAG + "=whatever")
public class AnotherInhabitantActivator implements InhabitantActivator {

    public static boolean called;
    
    @Override
    public void activate(Inhabitant<?> inhabitant) {
        AnotherInhabitantActivator.called = true;
    }
