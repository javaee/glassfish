 ...
 */
public class NonEmptyConstructorContractAFactory implements Factory<ContractA> {

    private final ContractB b;

    public NonEmptyConstructorContractAFactory(@Inject ContractB b) {
        this.b = b;
    }
