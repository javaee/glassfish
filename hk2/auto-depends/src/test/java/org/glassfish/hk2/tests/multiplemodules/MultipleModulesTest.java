 ...
 * No matter what declared order in the create method, it should always
 * configure First, then Second then Third module.
 */
public class MultipleModulesTest {
    ...
    public static MultipleModulesTest instance = new MultipleModulesTest();

    int instantiationOrder;
    int configurationOrder;

    public void reset() {
        instantiationOrder = 1;
        configurationOrder = 1;
    }

    public void assertInstantiationOrder(int order) {
        Assert.assertTrue(order==instantiationOrder);
        instantiationOrder++;
    }

    public void assertConfigurationOrder(int order) {
        Assert.assertTrue(order==configurationOrder);
        configurationOrder++;
    }
