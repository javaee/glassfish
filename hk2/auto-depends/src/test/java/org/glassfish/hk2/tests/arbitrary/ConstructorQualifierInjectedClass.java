 ...
 * holder.
 */
package org.glassfish.hk2.tests.arbitrary;
 ...
 */
public class ConstructorQualifierInjectedClass {
    final ContractB qb;
    final Factory<ContractB> qbf;

    public ConstructorQualifierInjectedClass(@Inject @SomeQualifier ContractB qb, @Inject @SomeQualifier Factory<ContractB> qbf) {
        this.qb = qb;
        this.qbf = qbf;
    }
