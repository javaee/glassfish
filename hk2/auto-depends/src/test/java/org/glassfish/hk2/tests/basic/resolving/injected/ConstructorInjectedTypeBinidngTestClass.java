...
public class ConstructorInjectedTypeBinidngTestClass {
    ...
    public ConstructorInjectedTypeBinidngTestClass(@Context ServiceC sc, @Context ClassX cx, @Context ContractB cb, @Context ContractA ca, @Context GenericContract<String> gc, @Context Factory<ServiceC> scp, @Context Factory<ClassX> cxp, @Context Factory<ContractB> cbp, @Context Factory<ContractA> cap, @Context Factory<GenericContract<String>> gcp) {
        this.sc = sc;
        this.cx = cx;
        this.cb = cb;
        this.ca = ca;
