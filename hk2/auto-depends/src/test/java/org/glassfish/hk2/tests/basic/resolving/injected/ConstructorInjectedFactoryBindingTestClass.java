...
public class ConstructorInjectedFactoryBindingTestClass {
    ...
    public ConstructorInjectedFactoryBindingTestClass(@Context FactoryProvidedContractA a, @Context FactoryProvidedContractB b, @Context
            @MarkerA FactoryProvidedContractC c_a, @Context
            @MarkerB FactoryProvidedContractC c_b, @Context FactoryProvidedContractC c_default, @Context Factory<FactoryProvidedContractA> pa, @Context Factory<FactoryProvidedContractB> pb, @Context
            @MarkerA Factory<FactoryProvidedContractC> pc_a, @Context
            @MarkerB Factory<FactoryProvidedContractC> pc_b, @Context Factory<FactoryProvidedContractC> pc_default) {
        this.a = a;
        this.b = b;
        this.c_a = c_a;
        this.c_b = c_b;
