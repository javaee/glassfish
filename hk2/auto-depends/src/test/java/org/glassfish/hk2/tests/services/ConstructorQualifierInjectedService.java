 ...
 */
public class ConstructorQualifierInjectedService {
    final ContractB qb;
    final Factory<ContractB> qbf;

    public ConstructorQualifierInjectedService(@Inject @SomeQualifier ContractB qb, @Inject @SomeQualifier Factory<ContractB> qbf) {
        this.qb = qb;
        this.qbf = qbf;
    }
