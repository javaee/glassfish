...
public class ConstructorCreator<T> extends AbstractCreatorImpl<T> {
    ...
    public ConstructorCreator(Class<? extends T> type, ServiceLocator habitat, Map<String, List<String>> metadata) {
    ...
    public void initialize(final T t, final Inhabitant onBehalfOf) throws ComponentException {
        ...
        //TODO: [Check] if (habitat.isContextualFactoriesPresent()) {
        if (false) {
            ...
            public void run() {
              if (System.getSecurityManager() != null) {
                AccessController.doPrivileged(new PrivilegedAction() {
                    ...
                    public Object run() {
                        inject(serviceLocator, t, onBehalfOf);
                        return null;
                    }
                });
              } else {
