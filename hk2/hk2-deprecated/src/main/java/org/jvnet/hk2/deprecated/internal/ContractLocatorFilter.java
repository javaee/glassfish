...
public class ContractLocatorFilter implements IndexedFilter {
    ...
    /* package */ ContractLocatorFilter(String contractName,
            String name,
            Scope scope,
        ...
        for (Class<? extends Annotation> annoClass : qualifiers) {
    ...
    public boolean matches(Descriptor d) {
        Set<String> dQualifiers = d.getQualifiers();
        
        return dQualifiers.containsAll(qualifiers);
    }
