 ...
 * @author Jeff Trent
 */
/*public*/ class ConfigInjectInjectionResolver extends InjectInjectionResolver {

  private final InjectionResolverQuery txnContextResolver;
  private final InjectInjectionResolver delegate;
  
  /*public*/ ConfigInjectInjectionResolver(InjectionResolverQuery txnContextResolver, InjectInjectionResolver delegate) {
    super(null);
  ...
  public <V> V getValue(Object component,
    ...
    if (null != txnContextResolver) {
      V v = txnContextResolver.getValue(component, onBehalfOf, annotated, genericType, type);
      if (null != v) {
        return v;
      }
    }
    
    return delegate.getValue(component, onBehalfOf, annotated, genericType, type);
  }
