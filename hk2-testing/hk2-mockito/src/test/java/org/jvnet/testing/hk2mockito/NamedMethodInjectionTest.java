...
import org.jvnet.testing.hk2mockito.fixture.named.NamedMethodInjectionGreetingService;
 ...
 */
@HK2
public class NamedMethodInjectionTest {

    @SUT
    @Inject
    NamedMethodInjectionGreetingService sut;
    @SC
    @Named("test")
    @Inject
