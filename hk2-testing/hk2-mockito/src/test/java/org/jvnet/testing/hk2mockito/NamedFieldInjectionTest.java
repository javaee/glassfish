...
import org.jvnet.testing.hk2mockito.fixture.named.NamedFieldInjectionGreetingService;
 ...
 */
@HK2
public class NamedFieldInjectionTest {

    @SUT
    @Inject
    NamedFieldInjectionGreetingService sut;
    @SC
    @Named("test")
    @Inject
