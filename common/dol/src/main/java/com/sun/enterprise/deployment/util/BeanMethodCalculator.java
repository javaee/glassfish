...
public class BeanMethodCalculator {
    ...
    public static Vector getMethodsFor(EjbDescriptor ejbDescriptor, ClassLoader classLoader) 
     ...
     */
    public static Collection getTransactionalMethodsFor(EjbDescriptor ejbDescriptor, ClassLoader loader)
        throws ClassNotFoundException, NoSuchMethodException
    {
     ...
     private static Collection getTransactionMethodsFor(ClassLoader loader, String interfaceName, Collection disallowedMethods) 
        throws ClassNotFoundException
     {
     ...
     private final static String entityBeanHomeMethodsDisallowed[] = { 
         "getEJBMetaData", "getHomeHandle" 
     };
     private final static String entityBeanRemoteMethodsDisallowed[] = {    
         "getEJBHome", "getHandle", "getPrimaryKey", "isIdentical"
     }; 
     private final static String entityBeanLocalHomeMethodsDisallowed[] = {};
     private final static String entityBeanLocalInterfaceMethodsDisallowed[] = {
        "getEJBLocalHome", "getPrimaryKey", "isIdentical"
     };
     
     private final static String sessionBeanMethodsDisallowed[] = {
         "*"
     };
     
     private final static String sessionLocalBeanMethodsDisallowed[] = {
         "*"
     };
