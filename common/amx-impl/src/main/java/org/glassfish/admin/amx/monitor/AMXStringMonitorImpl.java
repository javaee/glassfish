	...
	// implements AMXStringMonitor
{
	...
	{
        super( new StringMonitor(), AMXStringMonitor.J2EE_TYPE, AMXStringMonitor.J2EE_TYPE, ObjectNames.getInstance().getDomainRootObjectName(), AMXStringMonitor.class, null );
	}
}
