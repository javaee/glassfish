 ...
 */
public final class LoggingImpl extends AMXNonConfigImplBase
	 //implements /*Logging,*/ LoggingImplHook
{
    ...
    {
        super( Logging.J2EE_TYPE, Logging.J2EE_TYPE, ObjectNames.getInstance().getDomainRootObjectName(), Logging.class, null );
