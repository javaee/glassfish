...
public final class AMXGaugeMonitorImpl extends JMXMonitorBase
	// implements AMXGaugeMonitor
{
	/**
	 */
	AMXGaugeMonitorImpl()
	{
        super( new GaugeMonitor(), AMXGaugeMonitor.J2EE_TYPE, AMXGaugeMonitor.J2EE_TYPE, ObjectNames.getInstance().getDomainRootObjectName(), AMXGaugeMonitor.class, null );
	}
}
