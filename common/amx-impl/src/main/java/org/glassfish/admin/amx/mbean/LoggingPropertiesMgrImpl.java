...
public final class LoggingPropertiesMgrImpl extends AMXNonConfigImplBase implements LoggingPropertiesMgr
{
    private final Map<String,String> mProps = new HashMap<String,String>();
        ...
        public
    LoggingPropertiesMgrImpl( final ObjectName containerObjectName )
    {
        super( LoggingPropertiesMgr.J2EE_TYPE, LoggingPropertiesMgr.J2EE_TYPE, containerObjectName, LoggingPropertiesMgr.class, null);
