 ...
 */
public final class SystemInfoImpl extends AMXNonConfigImplBase
	implements SystemInfo
{
	...
	{
        super( SystemInfo.J2EE_TYPE, SystemInfo.J2EE_TYPE, ObjectNames.getInstance().getDomainRootObjectName(), SystemInfo.class, null );
