...
/**
 */
public interface ProtocolChainInstanceHandlerConfig extends PropertiesAccess, NamedConfigElement, DefaultValues, ConfigCreator, ConfigRemover {
    public String getClassname();
    public void setClassname(String classname);
    
    public ProtocolChainConfig getProtocolChainConfig();
}
