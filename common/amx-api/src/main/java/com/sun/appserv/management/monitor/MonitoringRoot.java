...
/** The j2eeType as returned by {@link com.sun.appserv.management.base.AMX#getJ2EEType}. */
	public static final String	J2EE_TYPE	= MONITORING_ROOT;
    
    
    /**
    	@return Map of ServerRootMonitor, keyed by server name.
	 */
    public Map<String,ServerRootMonitor>	getServerRootMonitorMap();

    /**
     *        @return Map of LoadBalancerServerMonitor, keyed by load-balancer name.
    public Map<String, LoadBalancerMonitor>	getLoadBalancerMonitorMap();
     */
}
