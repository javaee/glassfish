 ...
 */
public interface ConnectionManagerStats extends Stats
{
    /**
	    @return total number of connections to the ORB.   
	 */
	public BoundedRangeStatistic getTotalConnections();
	
    
    /** 
	    @return	total number of idle connections to the ORB    
	 */
	public CountStatistic 		getConnectionsInUse();
	
    /**
	    @return		total number of in-use connections to the ORB
	 */
