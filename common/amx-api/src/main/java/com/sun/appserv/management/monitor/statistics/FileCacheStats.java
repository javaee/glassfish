...
/**
	@see com.sun.appserv.management.monitor.FileCacheMonitor
 */
public interface FileCacheStats extends Stats
{
	...
	/**
        @return the number of current cache entries. 
                 A single cache entry represents a single URI 
	 */
	public CountStatistic getCountEntries();
	
	/**
	    @return the maximum entries in the <code>fileCache</code>
	 */
	public CountStatistic getMaxEntries();
	
	/**
	    @return maximum number of current open cache entries
	 */
	public CountStatistic getMaxOpenEntries();
	
	/**
	    @return number of current open cache entries
	 */
	public CountStatistic getCountOpenEntries();
	
	
	/**
	    @return number of hits on cached file info
	 */
	public CountStatistic getCountInfoHits();
	
	/**
	    @return number of misses on cached file info
	 */
	public CountStatistic getCountInfoMisses();
	
	/**
	    @return number of cache lookup misses
	 */
	public CountStatistic getCountMisses();
	
	/**
	    @return Number of cache lookup hits
	 */
	...
	/**
	    @return is the FileCache enabled.
	 */
