 ...
 * Monitor for Web Service Endpoint
 * 
 * @since AppServer 9.0
 */
public interface WebServiceEndpointMonitor extends MonitoringStats
{
     ...
     */
    public static final String	J2EE_TYPE= XTypes.WEBSERVICE_ENDPOINT_MONITOR;

    /**
     * Returns the aggregate statistics for this web service operation.
     *
     * @return web service operation aggregate stats
     */
    public WebServiceEndpointAggregateStats getWebServiceEndpointAggregateStats();
