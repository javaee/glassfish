...
/**
	...
	@see StatelessSessionBeanMonitor
	@see StatefulSessionBeanMonitor
	@see EntityBeanMonitor
	@see MessageDrivenBeanMonitor
 */
public interface BeanMonitor extends Container, MonitoringStats
{
    /**
		@return the associated bean pool monitor object 
	 */
	public BeanPoolMonitor		getBeanPoolMonitor( );
	
	/**
		@return the associated bean cache monitor object
	 */
	public BeanCacheMonitor		getBeanCacheMonitor( );
        
	/**
		@return Map of BeanMethodMonitorMgr keyed by name (beanName), one per
		bean in this EJBModule
	 */
	public Map<String,BeanMethodMonitor>	getBeanMethodMonitorMap( );
	...
	/**
		...
		<ul>
		<li>{@link StatelessSessionBeanStats}</li>
		<li>{@link StatefulSessionBeanStats}</li>
		<li>{@link EntityBeanStats}</li>
		<li>{@link MessageDrivenBeanStats}</li>
		</ul>
	 */
